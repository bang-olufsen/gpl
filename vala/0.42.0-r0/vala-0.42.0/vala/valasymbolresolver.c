                                        ...
                                        ValaStruct* st)
{
	...
	if (_tmp4_ != NULL) {
		...
		if (_tmp8_ != NULL) {
			...
			if (vala_typesymbol_is_subtype_of ((ValaTypeSymbol*) _tmp9_, (ValaTypeSymbol*) st)) {
				...
				_tmp12_ = _tmp11_;
				_tmp13_ = vala_symbol_get_full_name ((ValaSymbol*) st);
				_tmp14_ = _tmp13_;
				_tmp15_ = base_type;
				_tmp16_ = vala_symbol_get_full_name ((ValaSymbol*) _tmp15_);
				_tmp17_ = _tmp16_;
				_tmp18_ = g_strdup_printf ("Base struct cycle (`%s' and `%s')", _tmp14_, _tmp17_);
				_tmp19_ = _tmp18_;
				vala_report_error (_tmp12_, _tmp19_);
				_g_free0 (_tmp19_);
				_g_free0 (_tmp17_);
				_g_free0 (_tmp14_);
	...
	_tmp20_ = self->priv->current_scope;
	_tmp21_ = vala_scope_get_parent_scope (_tmp20_);
	_tmp22_ = _tmp21_;
                                          ...
                                          ValaStruct* base_struct)
{
	...
	if (_tmp1_ != NULL) {
		...
		_tmp3_ = vala_symbol_get_scope ((ValaSymbol*) st);
		_tmp4_ = _tmp3_;
		if (_tmp2_ == _tmp4_) {
			ValaStructValueType* _tmp5_;
			_tmp5_ = vala_struct_value_type_new (st);
			result = (ValaDataType*) _tmp5_;
			return result;
		}
		_tmp6_ = self->priv->current_scope;
		_tmp7_ = _vala_scope_ref0 (_tmp6_);
		old_scope = _tmp7_;
		_tmp8_ = vala_symbol_get_scope ((ValaSymbol*) st);
		_tmp9_ = _tmp8_;
		_tmp10_ = _vala_scope_ref0 (_tmp9_);
		_vala_scope_unref0 (self->priv->current_scope);
		self->priv->current_scope = _tmp10_;
		_tmp11_ = vala_struct_get_base_type (st);
		_tmp12_ = _tmp11_;
	...
	_tmp15_ = vala_struct_get_base_struct (base_struct);
	_tmp16_ = _tmp15_;
	if (_tmp16_ != NULL) {
		ValaStruct* _tmp17_;
		ValaStruct* _tmp18_;
		ValaDataType* _tmp19_;
		_tmp17_ = vala_struct_get_base_struct (base_struct);
		_tmp18_ = _tmp17_;
		_tmp19_ = vala_symbol_resolver_get_type_for_struct (self, st, _tmp18_);
		result = _tmp19_;
		return result;
	}
	_tmp20_ = vala_code_node_get_attribute ((ValaCodeNode*) base_struct, "BooleanType");
	if (_tmp20_ != NULL) {
		ValaBooleanType* _tmp21_;
		_tmp21_ = vala_boolean_type_new (st);
		result = (ValaDataType*) _tmp21_;
		return result;
	} else {
		ValaAttribute* _tmp22_;
		_tmp22_ = vala_code_node_get_attribute ((ValaCodeNode*) base_struct, "IntegerType");
		if (_tmp22_ != NULL) {
			ValaIntegerType* _tmp23_;
			_tmp23_ = vala_integer_type_new (st, NULL, NULL);
			result = (ValaDataType*) _tmp23_;
			return result;
		} else {
			ValaAttribute* _tmp24_;
			_tmp24_ = vala_code_node_get_attribute ((ValaCodeNode*) base_struct, "FloatingType");
			if (_tmp24_ != NULL) {
				ValaFloatingType* _tmp25_;
				_tmp25_ = vala_floating_type_new (st);
				result = (ValaDataType*) _tmp25_;
				return result;
			} else {
				ValaStructValueType* _tmp26_;
				_tmp26_ = vala_struct_value_type_new (st);

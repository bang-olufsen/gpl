                                      ...
                                      ValaGirParserNode* node)
{
	...
	if (_tmp56_) {
		...
		}
		{
			...
			_tmp141_ = vala_callable_get_parameters ((ValaCallable*) _tmp140_);
			_param_list = _tmp141_;
			_tmp142_ = _param_list;
			_tmp143_ = vala_collection_get_size ((ValaCollection*) _tmp142_);
			_tmp144_ = _tmp143_;
			_param_size = _tmp144_;
			_param_index = -1;
			while (TRUE) {
				gint _tmp145_;
				gint _tmp146_;
				...
				if (_tmp153_ == VALA_PARAMETER_DIRECTION_OUT) {
					...
					_tmp154_ = param;
					_tmp155_ = vala_parameter_copy (_tmp154_);
					async_param = _tmp155_;
					_tmp156_ = method;
					_tmp157_ = vala_symbol_get_scope ((ValaSymbol*) _tmp156_);
					_tmp158_ = _tmp157_;
					_tmp159_ = param;
					_tmp160_ = vala_symbol_get_name ((ValaSymbol*) _tmp159_);
					_tmp161_ = _tmp160_;
					_tmp162_ = vala_scope_lookup (_tmp158_, _tmp161_);
					_tmp163_ = _tmp162_;
					...
					if (_tmp164_) {
						...
						_tmp166_ = async_param;
						_tmp167_ = vala_symbol_get_name ((ValaSymbol*) _tmp166_);
						_tmp168_ = _tmp167_;
						_tmp169_ = g_strconcat (_tmp168_, "_out", NULL);
						_tmp170_ = _tmp169_;
						vala_symbol_set_name ((ValaSymbol*) _tmp166_, _tmp170_);
						_g_free0 (_tmp170_);
					}
					_tmp171_ = method;
					_tmp172_ = async_param;
					vala_callable_add_parameter ((ValaCallable*) _tmp171_, _tmp172_);
		...
		}
		{
			...
			gint _tmp177_;
			gint _error_type_index = 0;
			_tmp173_ = finish_method;
			_tmp174_ = vala_code_node_get_error_types ((ValaCodeNode*) _tmp173_);
			...
			while (TRUE) {
				...
				_error_type_index = _tmp178_ + 1;
				_tmp179_ = _error_type_index;
				_tmp180_ = _error_type_size;
				if (!(_tmp179_ < _tmp180_)) {
					break;
				}
				_tmp181_ = _error_type_list;
				_tmp182_ = _error_type_index;
				_tmp183_ = vala_list_get (_tmp181_, _tmp182_);
				error_type = (ValaDataType*) _tmp183_;
				_tmp184_ = method;
				_tmp185_ = error_type;
				_tmp186_ = vala_data_type_copy (_tmp185_);
				_tmp187_ = _tmp186_;
				vala_code_node_add_error_type ((ValaCodeNode*) _tmp184_, _tmp187_);
		...
		_tmp188_->processed = TRUE;
		_tmp189_ = finish_method_node;

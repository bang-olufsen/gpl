                                                ...
                                                const gchar* source_code)
{
	...
	ValadocHighlighterCodeScanner* _tmp194_;
	ValadocContentRun* _tmp195_;
	...
	_tmp194_ = valadoc_highlighter_code_scanner_new (source_code, enable_string_templates, enabel_verbatim_string, enable_preprocessor_define, enable_preprocessor_include, enable_keyword_escape, _tmp193_);
	scanner = _tmp194_;
	_tmp195_ = valadoc_highlighter_highlighter_highlight_code (self, (ValadocHighlighterScanner*) scanner);
	result = _tmp195_;

	...
	if (valadoc_ctype_resolver_is_capitalized_and_underscored (self, name)) {
		...
		if (g_strcmp0 (_tmp7_, "TYPE") == 0) {
			...
			if (_tmp16_) {
				...
				_tmp23_[0] = _tmp26_;
				_tmp27_ = _tmp23_[0];
				_tmp28_ = self->priv->types;
				_tmp29_ = _segments;
				_tmp29__length1 = _segments_length1;
				_tmp30_ = valadoc_ctype_resolver_convert_array_to_camelcase (self, _tmp29_, _tmp29__length1);
				_tmp31_ = _tmp30_;
				_tmp32_ = vala_map_get (_tmp28_, _tmp31_);
				_tmp33_ = (ValadocApiTypeSymbol*) _tmp32_;
				_g_free0 (_tmp31_);
				result = _tmp33_;
                                             ...
                                             ValadocApiInterface* item)
{
	...
	self = (ValadocCTypeResolver*) base;
	g_return_if_fail (item != NULL);
	_tmp0_ = valadoc_api_interface_get_cname (item);
	_tmp1_ = _tmp0_;
                                        ...
                                        ValadocApiEnum* item)
{
	...
	self = (ValadocCTypeResolver*) base;
	g_return_if_fail (item != NULL);
	_tmp0_ = valadoc_api_enum_get_cname (item);
	_tmp1_ = _tmp0_;
	valadoc_ctype_resolver_register_symbol (self, _tmp1_, (ValadocApiNode*) item);
	_g_free0 (_tmp1_);
	valadoc_api_node_accept_all_children ((ValadocApiNode*) item, (ValadocApiVisitor*) self, FALSE);

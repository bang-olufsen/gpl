...
valadoc_api_property_real_build_signature (ValadocApiItem* base)
{
	...
	_tmp21_ = self->priv->_setter;
	if (_tmp21_ != NULL) {
		ValadocApiPropertyAccessor* _tmp22_;
		gboolean _tmp23_;
		_tmp22_ = self->priv->_setter;
	...
	_tmp29_ = self->priv->_getter;
	if (_tmp29_ != NULL) {
		ValadocApiPropertyAccessor* _tmp30_;
		gboolean _tmp31_;
		_tmp30_ = self->priv->_getter;

                                                    ...
                                                    const gchar* headline)
{
	...
	_tmp14_ = _tmp13_;
	_tmp14__length1 = 2;
	valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) _tmp10_, "div", _tmp14_, 2);
	...
	_tmp22_ = _tmp21_;
	_tmp22__length1 = 4;
	_tmp23_ = valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) _tmp15_, "div", _tmp22_, 4);
	...
	_tmp27_ = nodes;
	_tmp28_ = vala_collection_get_size (_tmp27_);
	_tmp29_ = _tmp28_;
	_tmp26_[0] = _tmp29_;
	_tmp30_ = _tmp26_[0];
	_tmp31_ = list_sizes;
	...
	_tmp46_ = _tmp43_[0];
	_tmp47_ = self->writer;
	_tmp48_ = g_strdup ("class");
	_tmp49_ = g_strdup (VALADOC_HTML_BASIC_DOCLET_css_box_content);
	_tmp50_ = g_strdup ("id");
	_tmp51_ = html_id;
	...
	_tmp54_ = _tmp53_;
	_tmp54__length1 = 4;
	valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) _tmp47_, "div", _tmp54_, 4);
	...
	iter = _tmp56_;
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				ValadocHtmlMarkupWriter* _tmp102_;
				if (!_tmp57_) {
					gint _tmp58_;
					_tmp58_ = i;
					i = _tmp58_ + 1;
				...
				_tmp59_ = i;
				_tmp60_ = list_sizes;
				_tmp60__length1 = list_sizes_length1;
				if (!(_tmp59_ < _tmp60__length1)) {
					break;
				}
				_tmp61_ = self->writer;
				_tmp62_ = g_strdup ("class");
				_tmp63_ = g_strdup (VALADOC_HTML_BASIC_DOCLET_css_box_column);
				_tmp64_ = g_new0 (gchar*, 2 + 1);
				_tmp64_[0] = _tmp62_;
				_tmp64_[1] = _tmp63_;
				_tmp65_ = _tmp64_;
				_tmp65__length1 = 2;
				valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) _tmp61_, "div", _tmp65_, 2);
				_tmp65_ = (_vala_array_free (_tmp65_, _tmp65__length1, (GDestroyNotify) g_free), NULL);
				_tmp66_ = self->writer;
				_tmp67_ = g_strdup ("class");
				_tmp68_ = g_strdup (VALADOC_HTML_BASIC_DOCLET_css_inline_navigation);
				_tmp69_ = g_new0 (gchar*, 2 + 1);
				_tmp69_[0] = _tmp67_;
				_tmp69_[1] = _tmp68_;
				_tmp70_ = _tmp69_;
				_tmp70__length1 = 2;
				valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) _tmp66_, "ul", _tmp70_, 2);
				_tmp70_ = (_vala_array_free (_tmp70_, _tmp70__length1, (GDestroyNotify) g_free), NULL);
				{
					...
					p = 0;
					{
						...
						while (TRUE) {
							...
							gchar* _tmp82_;
							ValadocHtmlCssClassResolver* _tmp83_;
							...
							_tmp74_ = p;
							_tmp75_ = list_sizes;
							_tmp75__length1 = list_sizes_length1;
							_tmp76_ = i;
							_tmp77_ = _tmp75_[_tmp76_];
							if (_tmp74_ < _tmp77_) {
								ValaIterator* _tmp78_;
								_tmp78_ = iter;
								_tmp73_ = vala_iterator_next (_tmp78_);
							} else {
								_tmp73_ = FALSE;
							}
							if (!_tmp73_) {
							...
							_tmp79_ = iter;
							_tmp80_ = vala_iterator_get (_tmp79_);
							node = (ValadocApiNode*) _tmp80_;
							_tmp81_ = self->writer;
							_tmp82_ = g_strdup ("class");
							_tmp83_ = self->cssresolver;
							_tmp84_ = node;
							_tmp85_ = valadoc_html_css_class_resolver_resolve (_tmp83_, _tmp84_);
							_tmp86_ = g_new0 (gchar*, 2 + 1);
							_tmp86_[0] = _tmp82_;
							_tmp86_[1] = _tmp85_;
							_tmp87_ = _tmp86_;
							_tmp87__length1 = 2;
							valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) _tmp81_, "li", _tmp87_, 2);
							_tmp87_ = (_vala_array_free (_tmp87_, _tmp87__length1, (GDestroyNotify) g_free), NULL);
							_tmp88_ = node;
							_tmp89_ = valadoc_html_basic_doclet_get_link (self, _tmp88_, container);
							link = _tmp89_;
							_tmp90_ = link;
							if (_tmp90_ == NULL) {
								...
								_tmp91_ = self->writer;
								_tmp92_ = node;
								_tmp93_ = valadoc_api_node_get_name (_tmp92_);
								_tmp94_ = _tmp93_;
								valadoc_markup_writer_text ((ValadocMarkupWriter*) _tmp91_, _tmp94_);
							} else {
								...
								_tmp96_ = link;
								_tmp97_ = node;
								_tmp98_ = valadoc_api_node_get_name (_tmp97_);
								_tmp99_ = _tmp98_;
								valadoc_html_markup_writer_link (_tmp95_, _tmp96_, _tmp99_, NULL);
							}
							_tmp100_ = self->writer;
							valadoc_markup_writer_end_tag ((ValadocMarkupWriter*) _tmp100_, "li");
							_g_free0 (link);
							_g_object_unref0 (node);
						}
					}
				...
				valadoc_markup_writer_end_tag ((ValadocMarkupWriter*) _tmp101_, "ul");
				_tmp102_ = self->writer;
				valadoc_markup_writer_end_tag ((ValadocMarkupWriter*) _tmp102_, "div");
			}
		}
	}
	_tmp103_ = self->writer;
	valadoc_markup_writer_end_tag ((ValadocMarkupWriter*) _tmp103_, "div");
	_tmp104_ = self->writer;
	valadoc_markup_writer_end_tag ((ValadocMarkupWriter*) _tmp104_, "div");
                                          ...
                                          ValadocApiNode* container)
{
	...
	if (_tmp3_ > 0) {
		...
		_tmp10_ = valadoc_markup_writer_text (_tmp9_, type_string);
		_tmp11_ = valadoc_markup_writer_text (_tmp10_, ":");
		valadoc_markup_writer_end_tag (_tmp11_, "h3");
		_tmp8_ = (_vala_array_free (_tmp8_, _tmp8__length1, (GDestroyNotify) g_free), NULL);
		_tmp12_ = self->writer;
		_tmp13_ = g_strdup ("class");
		_tmp14_ = g_strdup (VALADOC_HTML_BASIC_DOCLET_css_inline_navigation);
		_tmp15_ = g_new0 (gchar*, 2 + 1);
		_tmp15_[0] = _tmp13_;
		_tmp15_[1] = _tmp14_;
		_tmp16_ = _tmp15_;
		_tmp16__length1 = 2;
		valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) _tmp12_, "ul", _tmp16_, 2);
		_tmp16_ = (_vala_array_free (_tmp16_, _tmp16__length1, (GDestroyNotify) g_free), NULL);
		{
			ValaList* _child_list = NULL;
			ValaList* _tmp17_;
			...
			while (TRUE) {
				...
				_tmp34_ = _tmp33_;
				_tmp34__length1 = 2;
				valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) _tmp28_, "li", _tmp34_, 2);
				...
				if (valadoc_html_basic_doclet_is_internal_node (self, _tmp35_)) {
					...
					ValadocApiNode* _tmp61_;
					_tmp37_ = child;
					if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp37_, VALADOC_API_TYPE_SYMBOL)) {
					...
					if (_tmp36_) {
						...
						_tmp45_ = _tmp44_;
						_tmp45__length1 = 2;
						valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) _tmp41_, "span", _tmp45_, 2);
					...
					_tmp68_ = _tmp67_;
					_tmp68__length1 = 2;
					valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) _tmp64_, "span", _tmp68_, 2);
					_tmp68_ = (_vala_array_free (_tmp68_, _tmp68__length1, (GDestroyNotify) g_free), NULL);
					_tmp70_ = child;
					if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp70_, VALADOC_API_TYPE_SYMBOL)) {
					...
					if (_tmp69_) {
						...
						_tmp78_ = _tmp77_;
						_tmp78__length1 = 2;
						valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) _tmp74_, "span", _tmp78_, 2);
					...
					_tmp87_ = _tmp86_;
					_tmp87__length1 = 2;
					valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) _tmp83_, "div", _tmp87_, 2);
					_tmp87_ = (_vala_array_free (_tmp87_, _tmp87__length1, (GDestroyNotify) g_free), NULL);
					_tmp88_ = child;

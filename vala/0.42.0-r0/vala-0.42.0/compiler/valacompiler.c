...
vala_compiler_run (ValaCompiler* self)
{
	...
	ValaGenieParser* _tmp249_;
	ValaGenieParser* _tmp250_;
	ValaCodeContext* _tmp251_;
	ValaGirParser* gir_parser = NULL;
	ValaGirParser* _tmp252_;
	ValaGirParser* _tmp253_;
	...
	if (_tmp160_ == VALA_PROFILE_POSIX) {
		...
		if (_tmp165_ == VALA_PROFILE_GOBJECT) {
			...
			if (_tmp167_ != NULL) {
				...
				_tmp166_ = sscanf (_tmp168_, "%d.%d", &glib_major, &glib_minor) != 2;
			} else {
				_tmp166_ = FALSE;
			}
			if (_tmp166_) {
			...
			_tmp170_ = glib_major;
			vala_code_context_set_target_glib_major (_tmp169_, _tmp170_);
			_tmp171_ = self->priv->context;
			_tmp172_ = glib_minor;
			vala_code_context_set_target_glib_minor (_tmp171_, _tmp172_);
			_tmp173_ = self->priv->context;
			_tmp174_ = vala_code_context_get_target_glib_major (_tmp173_);
			_tmp175_ = _tmp174_;
			if (_tmp175_ != 2) {
			...
			}
			{
				...
				i = 16;
				{
					...
					while (TRUE) {
						...
						_tmp181_ = i;
						_tmp182_ = g_strdup_printf ("GLIB_2_%d", _tmp181_);
						_tmp183_ = _tmp182_;
						vala_code_context_add_define (_tmp180_, _tmp183_);
						_g_free0 (_tmp183_);
					}
				}
			}
			_tmp184_ = vala_compiler_nostdpkg;
			if (!_tmp184_) {
				ValaCodeContext* _tmp185_;
				ValaCodeContext* _tmp186_;
				_tmp185_ = self->priv->context;
				vala_code_context_add_external_package (_tmp185_, "glib-2.0");
				_tmp186_ = self->priv->context;
				vala_code_context_add_external_package (_tmp186_, "gobject-2.0");
			}
		}
	}
	_tmp187_ = vala_compiler_packages;
	_tmp187__length1 = _vala_array_length (vala_compiler_packages);
	if (_tmp187_ != NULL) {
		gchar** _tmp188_;
		gint _tmp188__length1;
		_tmp188_ = vala_compiler_packages;
		_tmp188__length1 = _vala_array_length (vala_compiler_packages);
		{
			gchar** package_collection = NULL;
			gint package_collection_length1 = 0;
			gint _package_collection_size_ = 0;
			gint package_it = 0;
			package_collection = _tmp188_;
			package_collection_length1 = _tmp188__length1;
			for (package_it = 0; package_it < _tmp188__length1; package_it = package_it + 1) {
				gchar* _tmp189_;
				gchar* package = NULL;
				_tmp189_ = g_strdup (package_collection[package_it]);
				package = _tmp189_;
				{
					...
					_tmp191_ = package;
					vala_code_context_add_external_package (_tmp190_, _tmp191_);
					_g_free0 (package);
				}
			}
		}
	...
	_tmp192_ = vala_compiler_fast_vapis;
	_tmp192__length1 = _vala_array_length (vala_compiler_fast_vapis);
	if (_tmp192_ != NULL) {
		gchar** _tmp193_;
		gint _tmp193__length1;
		ValaCodeContext* _tmp202_;
		_tmp193_ = vala_compiler_fast_vapis;
		_tmp193__length1 = _vala_array_length (vala_compiler_fast_vapis);
		{
			gchar** vapi_collection = NULL;
			gint vapi_collection_length1 = 0;
			gint _vapi_collection_size_ = 0;
			gint vapi_it = 0;
			vapi_collection = _tmp193_;
			vapi_collection_length1 = _tmp193__length1;
			for (vapi_it = 0; vapi_it < _tmp193__length1; vapi_it = vapi_it + 1) {
				gchar* _tmp194_;
				gchar* vapi = NULL;
				_tmp194_ = g_strdup (vapi_collection[vapi_it]);
				vapi = _tmp194_;
				{
					gchar* rpath = NULL;
					...
					ValaSourceFile* _tmp201_;
					_tmp195_ = vapi;
					_tmp196_ = vala_code_context_realpath (_tmp195_);
					rpath = _tmp196_;
					_tmp197_ = self->priv->context;
					_tmp198_ = rpath;
					_tmp199_ = vala_source_file_new (_tmp197_, VALA_SOURCE_FILE_TYPE_FAST, _tmp198_, NULL, FALSE);
					source_file = _tmp199_;
					_tmp200_ = self->priv->context;
					_tmp201_ = source_file;
					vala_code_context_add_source_file (_tmp200_, _tmp201_);
		...
		vala_code_context_set_use_fast_vapi (_tmp202_, TRUE);
	}
	_tmp203_ = self->priv->context;
	_tmp204_ = vala_compiler_gresources;
	_tmp204__length1 = _vala_array_length (vala_compiler_gresources);
	vala_code_context_set_gresources (_tmp203_, _tmp204_, _tmp204__length1);
	_tmp205_ = self->priv->context;
	_tmp206_ = vala_compiler_gresources_directories;
	_tmp206__length1 = _vala_array_length (vala_compiler_gresources_directories);
	vala_code_context_set_gresources_directories (_tmp205_, _tmp206_, _tmp206__length1);
	...
	if (vala_report_get_errors (_tmp210_) > 0) {
		...
		gboolean _tmp212_;
		_tmp212_ = vala_compiler_fatal_warnings;
		if (_tmp212_) {
			...
			_tmp215_ = _tmp214_;
			_tmp211_ = vala_report_get_warnings (_tmp215_) > 0;
		} else {
			_tmp211_ = FALSE;
		}
		_tmp207_ = _tmp211_;
	...
	_tmp217_ = vala_code_context_get_profile (_tmp216_);
	_tmp218_ = _tmp217_;
	if (_tmp218_ == VALA_PROFILE_GOBJECT) {
		ValaCodeContext* _tmp219_;
		ValaGDBusServerModule* _tmp220_;
		ValaGDBusServerModule* _tmp221_;
		_tmp219_ = self->priv->context;
		_tmp220_ = vala_gd_bus_server_module_new ();
		_tmp221_ = _tmp220_;
		vala_code_context_set_codegen (_tmp219_, (ValaCodeGenerator*) _tmp221_);
		_vala_code_visitor_unref0 (_tmp221_);
	} else {
		ValaCodeContext* _tmp222_;
		ValaCCodeDelegateModule* _tmp223_;
		ValaCCodeDelegateModule* _tmp224_;
		_tmp222_ = self->priv->context;
		_tmp223_ = vala_ccode_delegate_module_new ();
		_tmp224_ = _tmp223_;
	...
	has_c_files = FALSE;
	has_h_files = FALSE;
	_tmp225_ = vala_compiler_sources;
	_tmp225__length1 = _vala_array_length (vala_compiler_sources);
	{
		gchar** source_collection = NULL;
		gint source_collection_length1 = 0;
		gint _source_collection_size_ = 0;
		gint source_it = 0;
		source_collection = _tmp225_;
		source_collection_length1 = _tmp225__length1;
		for (source_it = 0; source_it < _tmp225__length1; source_it = source_it + 1) {
			gchar* _tmp226_;
			gchar* source = NULL;
			_tmp226_ = g_strdup (source_collection[source_it]);
			source = _tmp226_;
			{
				...
				_tmp228_ = source;
				_tmp229_ = vala_compiler_run_output;
				if (vala_code_context_add_source_filename (_tmp227_, _tmp228_, _tmp229_, TRUE)) {
					const gchar* _tmp230_;
					_tmp230_ = source;
					if (g_str_has_suffix (_tmp230_, ".c")) {
						has_c_files = TRUE;
					} else {
						const gchar* _tmp231_;
						_tmp231_ = source;
						if (g_str_has_suffix (_tmp231_, ".h")) {
							has_h_files = TRUE;
						}
					}
				}
	...
	_tmp233_ = vala_compiler_ccode_only;
	if (_tmp233_) {
		gboolean _tmp234_ = FALSE;
		gboolean _tmp235_;
		_tmp235_ = has_c_files;
		if (_tmp235_) {
			_tmp234_ = TRUE;
		} else {
			gboolean _tmp236_;
			_tmp236_ = has_h_files;
			_tmp234_ = _tmp236_;
		}
		_tmp232_ = _tmp234_;
	} else {
	...
	_tmp240_ = _tmp239_;
	if (vala_report_get_errors (_tmp240_) > 0) {
		_tmp237_ = TRUE;
	} else {
		gboolean _tmp241_ = FALSE;
		gboolean _tmp242_;
		_tmp242_ = vala_compiler_fatal_warnings;
		if (_tmp242_) {
			...
			_tmp245_ = _tmp244_;
			_tmp241_ = vala_report_get_warnings (_tmp245_) > 0;
		} else {
			_tmp241_ = FALSE;
		}
		_tmp237_ = _tmp241_;
	...
	_tmp246_ = vala_parser_new ();
	parser = _tmp246_;
	_tmp247_ = parser;
	_tmp248_ = self->priv->context;
	vala_parser_parse (_tmp247_, _tmp248_);
	_tmp249_ = vala_genie_parser_new ();
	genie_parser = _tmp249_;
	_tmp250_ = genie_parser;
	_tmp251_ = self->priv->context;
	vala_genie_parser_parse (_tmp250_, _tmp251_);
	_tmp252_ = vala_gir_parser_new ();
	gir_parser = _tmp252_;
	_tmp253_ = gir_parser;
	_tmp254_ = self->priv->context;
	vala_gir_parser_parse (_tmp253_, _tmp254_);
	_tmp256_ = self->priv->context;
	_tmp257_ = vala_code_context_get_report (_tmp256_);
	_tmp258_ = _tmp257_;
	if (vala_report_get_errors (_tmp258_) > 0) {
		_tmp255_ = TRUE;
	} else {
		gboolean _tmp259_ = FALSE;
		gboolean _tmp260_;
		_tmp260_ = vala_compiler_fatal_warnings;
		if (_tmp260_) {
			...
			_tmp263_ = _tmp262_;
			_tmp259_ = vala_report_get_warnings (_tmp263_) > 0;
		} else {
			_tmp259_ = FALSE;
		}
		_tmp255_ = _tmp259_;
	...
	vala_code_context_check (_tmp269_);
	_tmp271_ = self->priv->context;
	_tmp272_ = vala_code_context_get_report (_tmp271_);
	_tmp273_ = _tmp272_;
	if (vala_report_get_errors (_tmp273_) > 0) {
		_tmp270_ = TRUE;
	} else {
		...
		if (_tmp275_) {
			...
			_tmp278_ = _tmp277_;
			_tmp274_ = vala_report_get_warnings (_tmp278_) > 0;
		} else {
			_tmp274_ = FALSE;
		}
		_tmp270_ = _tmp274_;
	...
	_tmp281_ = vala_compiler_ccode_only;
	if (!_tmp281_) {
		gboolean _tmp282_;
		_tmp282_ = vala_compiler_compile_only;
		_tmp280_ = !_tmp282_;
	} else {
		_tmp280_ = FALSE;
	}
	if (_tmp280_) {
		...
		_tmp283_ = vala_compiler_library;
	...
	if (_tmp279_) {
		...
		gboolean _tmp285_;
		_tmp285_ = has_c_files;
		if (!_tmp285_) {
			ValaCodeContext* _tmp286_;
			ValaMethod* _tmp287_;
			ValaMethod* _tmp288_;
			_tmp286_ = self->priv->context;
			_tmp287_ = vala_code_context_get_entry_point (_tmp286_);
			_tmp288_ = _tmp287_;
			_tmp284_ = _tmp288_ == NULL;
		} else {
			_tmp284_ = FALSE;
		}
		if (_tmp284_) {
	...
	if (_tmp289_ != NULL) {
		...
		_tmp290_ = vala_code_writer_new (VALA_CODE_WRITER_TYPE_DUMP);
		code_writer = _tmp290_;
		_tmp291_ = code_writer;
		_tmp292_ = self->priv->context;
		_tmp293_ = vala_compiler_dump_tree;
		vala_code_writer_write_file (_tmp291_, _tmp292_, _tmp293_);
		_vala_code_visitor_unref0 (code_writer);
	}
	_tmp295_ = self->priv->context;
	_tmp296_ = vala_code_context_get_report (_tmp295_);
	_tmp297_ = _tmp296_;
	if (vala_report_get_errors (_tmp297_) > 0) {
		_tmp294_ = TRUE;
	} else {
		...
		if (_tmp299_) {
			...
			_tmp302_ = _tmp301_;
			_tmp298_ = vala_report_get_warnings (_tmp302_) > 0;
		} else {
			_tmp298_ = FALSE;
		}
		_tmp294_ = _tmp298_;
	...
	_tmp304_ = vala_code_context_get_codegen (_tmp303_);
	_tmp305_ = _tmp304_;
	_tmp306_ = self->priv->context;
	vala_code_generator_emit (_tmp305_, _tmp306_);
	_tmp308_ = self->priv->context;
	_tmp309_ = vala_code_context_get_report (_tmp308_);
	_tmp310_ = _tmp309_;
	if (vala_report_get_errors (_tmp310_) > 0) {
		_tmp307_ = TRUE;
	} else {
		...
		if (_tmp312_) {
			...
			_tmp315_ = _tmp314_;
			_tmp311_ = vala_report_get_warnings (_tmp315_) > 0;
		} else {
			_tmp311_ = FALSE;
		}
		_tmp307_ = _tmp311_;
	...
	_tmp317_ = vala_compiler_vapi_filename;
	if (_tmp317_ == NULL) {
		const gchar* _tmp318_;
		_tmp318_ = vala_compiler_library;
		_tmp316_ = _tmp318_ != NULL;
	} else {
		_tmp316_ = FALSE;
	}
	if (_tmp316_) {
		...
		_tmp320_ = g_strdup_printf ("%s.vapi", _tmp319_);
		_g_free0 (vala_compiler_vapi_filename);
		vala_compiler_vapi_filename = _tmp320_;
	}
	...
	if (_tmp321_ != NULL) {
		...
		if (_tmp322_ != NULL) {
			...
			if (_tmp325_ == VALA_PROFILE_GOBJECT) {
				...
				gir_base = _tmp327_;
				_tmp328_ = gir_base;
				_tmp329_ = strlen (_tmp328_);
				_tmp330_ = _tmp329_;
				gir_len = (glong) _tmp330_;
				_tmp331_ = gir_base;
				last_hyphen = string_last_index_of_char (_tmp331_, (gunichar) '-', 0);
				...
				if (_tmp333_ == -1) {
					...
					_tmp334_ = gir_base;
					_tmp332_ = !g_str_has_suffix (_tmp334_, ".gir");
				}
				if (_tmp332_) {
					...
					if (_tmp349_) {
						...
						_tmp348_ = !g_ascii_isdigit (string_get (_tmp352_, (glong) 0));
					}
					if (_tmp348_) {
						_tmp347_ = TRUE;
					} else {
						...
						_tmp347_ = string_contains (_tmp353_, "?");
					}
					if (_tmp347_) {
						...
						_tmp357_ = vala_gir_writer_new ();
						gir_writer = _tmp357_;
						_tmp358_ = g_strdup (".");
						gir_directory = _tmp358_;
						_tmp359_ = vala_compiler_directory;
						if (_tmp359_ != NULL) {
							...
							_tmp361_ = vala_code_context_get_directory (_tmp360_);
							_tmp362_ = _tmp361_;
							_tmp363_ = g_strdup (_tmp362_);
							_g_free0 (gir_directory);
							gir_directory = _tmp363_;
						}
						_tmp364_ = gir_writer;
						_tmp365_ = self->priv->context;
						_tmp366_ = gir_directory;
						_tmp367_ = vala_compiler_gir;
						_tmp368_ = gir_namespace;
						_tmp369_ = gir_version;
						_tmp370_ = vala_compiler_library;
						_tmp371_ = vala_compiler_shared_library;
						vala_gir_writer_write_file (_tmp364_, _tmp365_, _tmp366_, _tmp367_, _tmp368_, _tmp369_, _tmp370_, _tmp371_);
						_g_free0 (gir_directory);
	...
	if (_tmp373_ != NULL) {
		ValaCodeWriter* interface_writer = NULL;
		ValaCodeWriter* _tmp374_;
		gboolean _tmp375_ = FALSE;
		const gchar* _tmp376_;
		ValaCodeWriter* _tmp383_;
		ValaCodeContext* _tmp384_;
		const gchar* _tmp385_;
		_tmp374_ = vala_code_writer_new (VALA_CODE_WRITER_TYPE_EXTERNAL);
		interface_writer = _tmp374_;
		_tmp376_ = vala_compiler_directory;
		if (_tmp376_ != NULL) {
			const gchar* _tmp377_;
			_tmp377_ = vala_compiler_vapi_filename;
			_tmp375_ = !g_path_is_absolute (_tmp377_);
		} else {
			_tmp375_ = FALSE;
		}
		if (_tmp375_) {
...
"ternal-header");
		...
		_tmp390_ = vala_code_writer_new (VALA_CODE_WRITER_TYPE_INTERNAL);
		interface_writer = _tmp390_;
		_tmp391_ = self->priv->context;
		_tmp392_ = vala_code_context_get_includedir (_tmp391_);
		_tmp393_ = _tmp392_;
		if (_tmp393_ != NULL) {
			...
			_tmp398_ = g_path_get_basename (_tmp397_);
			_tmp399_ = _tmp398_;
			_tmp400_ = g_build_path ("/", _tmp396_, _tmp399_, NULL);
			_tmp401_ = _tmp400_;
			_g_free0 (_tmp399_);
			prefixed_header_filename = _tmp401_;
			_tmp402_ = self->priv->context;
			_tmp403_ = vala_code_context_get_includedir (_tmp402_);
			_tmp404_ = _tmp403_;
			_tmp405_ = vala_compiler_internal_header_filename;
			_tmp406_ = g_path_get_basename (_tmp405_);
			_tmp407_ = _tmp406_;
			_tmp408_ = g_build_path ("/", _tmp404_, _tmp407_, NULL);
			_tmp409_ = _tmp408_;
			_g_free0 (_tmp407_);
			prefixed_internal_header_filename = _tmp409_;
			_tmp410_ = interface_writer;
			_tmp411_ = prefixed_header_filename;
			_tmp412_ = prefixed_internal_header_filename;
			vala_code_writer_set_cheader_override (_tmp410_, _tmp411_, _tmp412_);
			...
			_tmp414_ = vala_compiler_header_filename;
			_tmp415_ = vala_compiler_internal_header_filename;
			vala_code_writer_set_cheader_override (_tmp413_, _tmp414_, _tmp415_);
		}
		_tmp416_ = vala_compiler_internal_vapi_filename;
		_tmp417_ = g_strdup (_tmp416_);
		vapi_filename = _tmp417_;
		_tmp419_ = vala_compiler_directory;
		if (_tmp419_ != NULL) {
			const gchar* _tmp420_;
			_tmp420_ = vapi_filename;
			_tmp418_ = !g_path_is_absolute (_tmp420_);
		} else {
			_tmp418_ = FALSE;
		}
		if (_tmp418_) {
			...
			gchar* _tmp425_;
			_tmp421_ = self->priv->context;
			_tmp422_ = vala_code_context_get_directory (_tmp421_);
			_tmp423_ = _tmp422_;
			_tmp424_ = vapi_filename;
			_tmp425_ = g_strdup_printf ("%s%c%s", _tmp423_, (gint) G_DIR_SEPARATOR, _tmp424_);
			_g_free0 (vapi_filename);
			vapi_filename = _tmp425_;
		}
		_tmp426_ = interface_writer;
		_tmp427_ = self->priv->context;
		_tmp428_ = vapi_filename;
		vala_code_writer_write_file (_tmp426_, _tmp427_, _tmp428_);
		_g_free0 (vala_compiler_internal_vapi_filename);
		vala_compiler_internal_vapi_filename = NULL;
		_g_free0 (vapi_filename);
		_vala_code_visitor_unref0 (interface_writer);
	}
	_tmp429_ = vala_compiler_dependencies;
	if (_tmp429_ != NULL) {
		ValaCodeContext* _tmp430_;
		const gchar* _tmp431_;
		_tmp430_ = self->priv->context;
		_tmp431_ = vala_compiler_dependencies;
		vala_code_context_write_dependencies (_tmp430_, _tmp431_);
	}
	_tmp433_ = self->priv->context;
	_tmp434_ = vala_code_context_get_report (_tmp433_);
	_tmp435_ = _tmp434_;
	if (vala_report_get_errors (_tmp435_) > 0) {
		_tmp432_ = TRUE;
	} else {
		gboolean _tmp436_ = FALSE;
		gboolean _tmp437_;
		_tmp437_ = vala_compiler_fatal_warnings;
		if (_tmp437_) {
			ValaCodeContext* _tmp438_;
			ValaReport* _tmp439_;
			ValaReport* _tmp440_;
			_tmp438_ = self->priv->context;
			_tmp439_ = vala_code_context_get_report (_tmp438_);
			_tmp440_ = _tmp439_;
			_tmp436_ = vala_report_get_warnings (_tmp440_) > 0;
		} else {
			_tmp436_ = FALSE;
		}
		_tmp432_ = _tmp436_;
	...
	_tmp441_ = vala_compiler_ccode_only;
	if (!_tmp441_) {
		ValaCCodeCompiler* ccompiler = NULL;
		ValaCCodeCompiler* _tmp442_;
		gboolean _tmp443_ = FALSE;
		const gchar* _tmp444_;
		gchar** _tmp448_;
		gint _tmp448__length1;
		_tmp442_ = vala_ccode_compiler_new ();
		ccompiler = _tmp442_;
		_tmp444_ = vala_compiler_cc_command;
		if (_tmp444_ == NULL) {
			const gchar* _tmp445_;
			_tmp445_ = g_getenv ("CC");
			_tmp443_ = _tmp445_ != NULL;
		} else {
			_tmp443_ = FALSE;
		}
		if (_tmp443_) {

...
struct _GVfsDBusDaemonIface
{
  ...
  gboolean (*handle_list_monitor_implementations) (
    GVfsDBusDaemon *object,
    GDBusMethodInvocation *invocation);
...
void gvfs_dbus_daemon_complete_list_monitor_implementations (
    GVfsDBusDaemon *object,
    GDBusMethodInvocation *invocation,
    GVariant *monitors);
...
void gvfs_dbus_daemon_call_list_monitor_implementations (
    GVfsDBusDaemon *proxy,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
    gpointer user_data);

gboolean gvfs_dbus_daemon_call_list_monitor_implementations_finish (
    GVfsDBusDaemon *proxy,
    GVariant **out_monitors,
    GAsyncResult *res,
    GError **error);

gboolean gvfs_dbus_daemon_call_list_monitor_implementations_sync (
    GVfsDBusDaemon *proxy,
    GVariant **out_monitors,
    GCancellable *cancellable,
    GError **error);

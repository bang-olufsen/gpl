/* rygel-http-byte-seek_http-get.c generated by valac 0.24.0.112-bbf5, the Vala compiler
	...
	if (_tmp5_) {
		...
		if (_tmp8_) {
			...
			if (_tmp19_ != NULL) {
				...
				_tmp22_ = _tmp21_->size;
				_tmp17_ = _tmp22_ > ((glong) 0);
			} else {
				_tmp17_ = FALSE;
			}
			_tmp7_ = _tmp17_;

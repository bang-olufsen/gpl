/* rygel-logical-expression.c generated by valac 0.24.0.112-bbf5, the Vala compiler
...
static gboolean rygel_logical_expression_real_satisfied_by (RygelSearchExpression* base, RygelMediaObject* media_object) {
	...
	switch ((RygelLogicalOperator) ((gintptr) _tmp0_)) {
		...
		case RYGEL_LOGICAL_OPERATOR_OR:
		{
			...
			_tmp9_ = ((RygelSearchExpression*) self)->operand1;
			_tmp10_ = media_object;
			_tmp11_ = rygel_search_expression_satisfied_by ((RygelSearchExpression*) _tmp9_, _tmp10_);
			if (_tmp11_) {
				_tmp8_ = TRUE;
			} else {
				...
				_tmp12_ = ((RygelSearchExpression*) self)->operand2;
				_tmp13_ = media_object;
				_tmp14_ = rygel_search_expression_satisfied_by ((RygelSearchExpression*) _tmp12_, _tmp13_);
				_tmp8_ = _tmp14_;
			}
			result = _tmp8_;
			return result;

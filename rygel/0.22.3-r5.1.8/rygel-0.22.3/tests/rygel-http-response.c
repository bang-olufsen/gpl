/* rygel-http-response.c generated by valac 0.24.0.112-bbf5, the Vala compiler
...
static void __lambda7_ (RygelHTTPResponse* self);
void rygel_http_response_end (RygelHTTPResponse* self, gboolean aborted, guint status);
static void ___lambda7__rygel_data_source_done (RygelDataSource* _sender, gpointer self);
static void __lambda8_ (RygelHTTPResponse* self, GError* _error_);
GQuark rygel_data_source_error_quark (void);
static void ___lambda8__rygel_data_source_error (RygelDataSource* _sender, GError* _error_, gpointer self);
...
static gboolean ___lambda9_ (RygelHTTPResponse* self);
...
static void ___lambda7__rygel_data_source_done (RygelDataSource* _sender, gpointer self) {
	__lambda7_ ((RygelHTTPResponse*) self);
}
...
static void ___lambda8__rygel_data_source_error (RygelDataSource* _sender, GError* _error_, gpointer self) {
	__lambda8_ ((RygelHTTPResponse*) self, _error_);
}
...
RygelHTTPResponse* rygel_http_response_construct (GType object_type, RygelHTTPGet* request, RygelHTTPGetHandler* request_handler, RygelDataSource* src, GError** error) {
	...
	g_signal_connect_object (_tmp17_, "done", (GCallback) ___lambda7__rygel_data_source_done, self, 0);
	_tmp18_ = self->priv->src;
	g_signal_connect_object (_tmp18_, "error", (GCallback) ___lambda8__rygel_data_source_error, self, 0);
...
static gboolean ____lambda9__gsource_func (gpointer self) {
	gboolean result;
	result = ___lambda9_ ((RygelHTTPResponse*) self);
	return result;
}
...
static gboolean rygel_http_response_real_run_co (RygelHttpResponseRunData* _data_) {
	...
	__catch4_g_error:
	{
		...
		g_idle_add_full (G_PRIORITY_DEFAULT_IDLE, ____lambda9__gsource_func, g_object_ref (_data_->self), g_object_unref);

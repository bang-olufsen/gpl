/* rygel-user-config.c generated by valac 0.24.0.112-bbf5, the Vala compiler
...
static gchar** rygel_user_config_real_get_interfaces (RygelConfiguration* base, GError** error) {
	...
	interfaces = _tmp6_;
	interfaces_length1 = _tmp6__length1;
	...
	if (_tmp7_ != NULL) {
		...
		_tmp8_ = interfaces;
		_tmp8__length1 = interfaces_length1;
...
static gint rygel_user_config_real_get_port (RygelConfiguration* base, GError** error) {
	...
	GError * _inner_error_ = NULL;
	self = (RygelUserConfig*) base;
	_tmp1_ = rygel_configuration_get_int ((RygelConfiguration*) self, RYGEL_USER_CONFIG_GENERAL_SECTION, RYGEL_USER_CONFIG_PORT_KEY, (gint) 0U, (gint) G_MAXUINT16, &_inner_error_);
	_tmp0_ = _tmp1_;
	if (G_UNLIKELY (_inner_error_ != NULL)) {
		g_propagate_error (error, _inner_error_);
		return 0;
...
static void rygel_user_config_initialize (RygelUserConfig* self, const gchar* local_path, const gchar* system_path, GError** error) {
	...
	self->sys_key_file_monitor = _tmp10_;
	_tmp11_ = self->sys_key_file_monitor;
	g_signal_connect_object (_tmp11_, "changed", (GCallback) _rygel_user_config_on_system_config_changed_g_file_monitor_changed, self, 0);
	{
		GKeyFile* _tmp12_ = NULL;
		const gchar* _tmp13_ = NULL;
		const gchar* _tmp14_ = NULL;
		_tmp12_ = self->key_file;
		_tmp13_ = local_path;
		g_key_file_load_from_file (_tmp12_, _tmp13_, G_KEY_FILE_KEEP_COMMENTS | G_KEY_FILE_KEEP_TRANSLATIONS, &_inner_error_);
		if (G_UNLIKELY (_inner_error_ != NULL)) {
			goto __catch0_g_error;
		}
		_tmp14_ = local_path;
		g_debug ("rygel-user-config.vala:249: Loaded user configuration from file '%s'", _tmp14_);
	}
	goto __finally0;
	__catch0_g_error:
	{
		...
		_inner_error_ = NULL;
		_tmp15_ = _ ("Failed to load user configuration from file '%s': %s");
		_tmp16_ = local_path;
		_tmp17_ = _error_;
	...
	key_g_file = _tmp21_;
	_tmp23_ = key_g_file;
	_tmp24_ = g_file_monitor_file (_tmp23_, G_FILE_MONITOR_NONE, NULL, &_inner_error_);
	_tmp22_ = _tmp24_;
	if (G_UNLIKELY (_inner_error_ != NULL)) {
		g_propagate_error (error, _inner_error_);
	...
	self->key_file_monitor = _tmp25_;
	_tmp26_ = self->key_file_monitor;
	g_signal_connect_object (_tmp26_, "changed", (GCallback) _rygel_user_config_on_local_config_changed_g_file_monitor_changed, self, 0);
...
static gchar* rygel_user_config_get_string_from_keyfiles (const gchar* section, const gchar* key, GKeyFile* key_file, GKeyFile* sys_key_file, GError** error) {
	...
	__catch1_g_key_file_error:
	{
		...
		_inner_error_ = NULL;
		_tmp7_ = _error_;
		if (g_error_matches (_tmp7_, G_KEY_FILE_ERROR, G_KEY_FILE_ERROR_KEY_NOT_FOUND)) {
			_tmp6_ = TRUE;
		} else {
			GError* _tmp8_ = NULL;
			_tmp8_ = _error_;
			_tmp6_ = g_error_matches (_tmp8_, G_KEY_FILE_ERROR, G_KEY_FILE_ERROR_GROUP_NOT_FOUND);
		}
		if (_tmp6_) {
			gchar* _tmp9_ = NULL;
...
static GeeArrayList* rygel_user_config_get_string_list_from_keyfiles (const gchar* section, const gchar* key, GKeyFile* key_file, GKeyFile* sys_key_file, GError** error) {
	...
	str_list = _tmp0_;
	{
		...
		strings = (_vala_array_free (strings, strings_length1, (GDestroyNotify) g_free), NULL);
		strings = _tmp7_;
		strings_length1 = _tmp7__length1;
	...
	__catch2_g_key_file_error:
	{
		...
		_inner_error_ = NULL;
		_tmp9_ = _error_;
		if (g_error_matches (_tmp9_, G_KEY_FILE_ERROR, G_KEY_FILE_ERROR_KEY_NOT_FOUND)) {
			_tmp8_ = TRUE;
		} else {
			GError* _tmp10_ = NULL;
			_tmp10_ = _error_;
			_tmp8_ = g_error_matches (_tmp10_, G_KEY_FILE_ERROR, G_KEY_FILE_ERROR_GROUP_NOT_FOUND);
		}
		if (_tmp8_) {
			gchar** _tmp11_ = NULL;
			GKeyFile* _tmp12_ = NULL;
			...
			strings = (_vala_array_free (strings, strings_length1, (GDestroyNotify) g_free), NULL);
			strings = _tmp17_;
			strings_length1 = _tmp17__length1;
			_strings_size_ = strings_length1;
	...
	_tmp20__length1 = strings_length1;
	{
		...
		gint str_it = 0;
		str_collection = _tmp20_;
		str_collection_length1 = _tmp20__length1;
		for (str_it = 0; str_it < _tmp20__length1; str_it = str_it + 1) {
			gchar* _tmp21_ = NULL;
			gchar* str = NULL;
			_tmp21_ = g_strdup (str_collection[str_it]);
			str = _tmp21_;
			{
...
static gint rygel_user_config_get_int_from_keyfiles (const gchar* section, const gchar* key, gint min, gint max, GKeyFile* key_file, GKeyFile* sys_key_file, GError** error) {
	...
	if (_tmp15_) {
		...
		const gchar* _tmp21_ = NULL;
		GError* _tmp22_ = NULL;
		_tmp20_ = _ ("Value of '%s' out of range");
		_tmp21_ = key;
		_tmp22_ = g_error_new (RYGEL_CONFIGURATION_ERROR, RYGEL_CONFIGURATION_ERROR_VALUE_OUT_OF_RANGE, _tmp20_, _tmp21_);
		_inner_error_ = _tmp22_;
		g_propagate_error (error, _inner_error_);
		return 0;
	}
...
static GeeArrayList* rygel_user_config_get_int_list_from_keyfiles (const gchar* section, const gchar* key, GKeyFile* key_file, GKeyFile* sys_key_file, GError** error) {
	...
	_tmp20_ = ints;
	_tmp20__length1 = ints_length1;
	{
		gint* num_collection = NULL;
		gint num_collection_length1 = 0;
		gint _num_collection_size_ = 0;
		gint num_it = 0;
		num_collection = _tmp20_;
		num_collection_length1 = _tmp20__length1;
		for (num_it = 0; num_it < _tmp20__length1; num_it = num_it + 1) {
			gint num = 0;
			num = num_collection[num_it];
			{
				...
				_tmp21_ = int_list;
				_tmp22_ = num;
				gee_abstract_collection_add ((GeeAbstractCollection*) _tmp21_, (gpointer) ((gintptr) _tmp22_));
			}
		}
	}
	result = int_list;
...
static GeeHashSet* rygel_user_config_get_keys (const gchar* section, GKeyFile* key_file, GKeyFile* sys_key_file) {
		...
		_tmp1__length1 = 0;
		{
			...
			for (key_it = 0; key_it < _tmp6__length1; key_it = key_it + 1) {
				...
				key = _tmp7_;
				{
					...
					_tmp8_ = key;
					gee_abstract_collection_add ((GeeAbstractCollection*) keys, _tmp8_);
					_g_free0 (key);
				}
			}
	...
	}
	{
		...
		_tmp14_ = _tmp9_;
		_tmp14__length1 = _tmp9__length1;
		_tmp9_ = NULL;
		_tmp9__length1 = 0;
		{
			gchar** key_collection = NULL;
			...
			for (key_it = 0; key_it < _tmp14__length1; key_it = key_it + 1) {
				...
				key = _tmp15_;
				{
					const gchar* _tmp16_ = NULL;
					_tmp16_ = key;
					gee_abstract_collection_add ((GeeAbstractCollection*) keys, _tmp16_);
					_g_free0 (key);
				}
			}
			key_collection = (_vala_array_free (key_collection, key_collection_length1, (GDestroyNotify) g_free), NULL);
	...
	g_return_val_if_fail (new_sys_key_file != NULL, FALSE);
	{
		...
		switch (_tmp0_) {
			...
			case RYGEL_ENTRY_TYPE_INT:
			{
				...
				_tmp29_ = rygel_user_config_get_int_from_keyfiles (_tmp25_, _tmp26_, G_MININT, G_MAXINT, _tmp27_, _tmp28_, &_inner_error_);
				old_value = _tmp29_;
				if (G_UNLIKELY (_inner_error_ != NULL)) {
					goto __catch9_g_error;
				}
				_tmp30_ = section;
				_tmp31_ = key;
				_tmp32_ = new_key_file;
				_tmp33_ = new_sys_key_file;
				_tmp34_ = rygel_user_config_get_int_from_keyfiles (_tmp30_, _tmp31_, G_MININT, G_MAXINT, _tmp32_, _tmp33_, &_inner_error_);
				new_value = _tmp34_;
				if (G_UNLIKELY (_inner_error_ != NULL)) {
					goto __catch9_g_error;
				}
...
static void rygel_user_config_compare_and_notify (RygelUserConfig* self, GKeyFile* key_file, GKeyFile* sys_key_file) {
	...
	self->sys_key_file = _tmp13_;
	{
		...
		while (TRUE) {
			...
			config_keys = _tmp32_;
			_tmp33_ = new_sections;
			_tmp34_ = section;
			_tmp35_ = gee_abstract_collection_remove ((GeeAbstractCollection*) _tmp33_, _tmp34_);
			if (_tmp35_) {
				...
				_tmp36_ = section;
				_tmp37_ = key_file;
				_tmp38_ = sys_key_file;
				_tmp39_ = rygel_user_config_get_keys (_tmp36_, _tmp37_, _tmp38_);
				new_keys = _tmp39_;
				{
					...
					while (TRUE) {
						...
						_tmp46_ = new_keys;
						_tmp47_ = key;
						_tmp48_ = gee_abstract_collection_remove ((GeeAbstractCollection*) _tmp46_, _tmp47_);
						if (_tmp48_) {
							...
							_tmp49_ = section;
							_tmp50_ = key;
							_tmp51_ = old_key_file;
							_tmp52_ = old_sys_key_file;
							_tmp53_ = key_file;
							_tmp54_ = sys_key_file;
							_tmp55_ = config_keys;
							rygel_user_config_emit_conditionally (self, _tmp49_, _tmp50_, _tmp51_, _tmp52_, _tmp53_, _tmp54_, _tmp55_);
						} else {
							...
							_tmp57_ = key;
							_tmp58_ = config_keys;
							rygel_user_config_emit_unconditionally (self, _tmp56_, _tmp57_, _tmp58_);
						}
						_g_free0 (key);
					}
				...
				}
				{
					...
					_tmp59_ = new_keys;
					_tmp60_ = gee_abstract_collection_iterator ((GeeAbstractCollection*) _tmp59_);
					_key_it = _tmp60_;
					while (TRUE) {
						...
						_tmp66_ = key;
						_tmp67_ = config_keys;
						rygel_user_config_emit_unconditionally (self, _tmp65_, _tmp66_, _tmp67_);
						_g_free0 (key);
					}
					_g_object_unref0 (_key_it);
				}
			...
			} else {
				{
					...
					_tmp68_ = old_keys;
					_tmp69_ = gee_abstract_collection_iterator ((GeeAbstractCollection*) _tmp68_);
					_key_it = _tmp69_;
					while (TRUE) {
						...
						_tmp75_ = key;
						_tmp76_ = config_keys;
						rygel_user_config_emit_unconditionally (self, _tmp74_, _tmp75_, _tmp76_);
						_g_free0 (key);
					}
					_g_object_unref0 (_key_it);
				}
	...
	}
	{
		...
		while (TRUE) {
			...
			section = (gchar*) _tmp82_;
			_tmp83_ = section;
			_tmp84_ = sys_key_file;
			_tmp85_ = key_file;
			_tmp86_ = rygel_user_config_get_keys (_tmp83_, _tmp84_, _tmp85_);
			keys = _tmp86_;
			_tmp88_ = rygel_user_config_config_keys;
			_tmp89_ = section;
			_tmp90_ = gee_abstract_map_has_key ((GeeAbstractMap*) _tmp88_, _tmp89_);
			if (_tmp90_) {
				GeeHashMap* _tmp91_ = NULL;
				const gchar* _tmp92_ = NULL;
				gpointer _tmp93_ = NULL;
				_tmp91_ = rygel_user_config_config_keys;
				_tmp92_ = section;
				_tmp93_ = gee_abstract_map_get ((GeeAbstractMap*) _tmp91_, _tmp92_);
				_g_object_unref0 (_tmp87_);
				_tmp87_ = (GeeHashMap*) _tmp93_;
			} else {
				GeeHashMap* _tmp94_ = NULL;
				_tmp94_ = gee_hash_map_new (G_TYPE_STRING, (GBoxedCopyFunc) g_strdup, g_free, RYGEL_USER_CONFIG_TYPE_CONFIG_PAIR, (GBoxedCopyFunc) rygel_user_config_config_pair_ref, rygel_user_config_config_pair_unref, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
				_g_object_unref0 (_tmp87_);
				_tmp87_ = _tmp94_;
			}
			_tmp95_ = _g_object_ref0 (_tmp87_);
			config_keys = _tmp95_;
			{
				GeeIterator* _key_it = NULL;
				...
				while (TRUE) {
					...
					_tmp102_ = section;
					_tmp103_ = key;
					_tmp104_ = config_keys;
					rygel_user_config_emit_unconditionally (self, _tmp102_, _tmp103_, _tmp104_);
					_g_free0 (key);
				}
				_g_object_unref0 (_key_it);
			}

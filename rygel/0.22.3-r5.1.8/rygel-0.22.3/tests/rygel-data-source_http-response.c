/* rygel-data-source_http-response.c generated by valac 0.24.0.112-bbf5, the Vala compiler
 * generated from rygel-data-source_http-response.vala, do not modify */

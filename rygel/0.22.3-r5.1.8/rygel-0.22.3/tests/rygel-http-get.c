/* rygel-http-get.c generated by valac 0.24.0.112-bbf5, the Vala compiler
...
static void __lambda6_ (RygelHTTPGet* self, const gchar* name, const gchar* value);
static void ___lambda6__soup_message_headers_foreach_func (const gchar* name, const gchar* value, gpointer self);
...
static gboolean rygel_http_get_real_handle_co (RygelHttpGetHandleData* _data_) {
	...
	if (_data_->_tmp22_ != NULL) {
		...
		_data_->_tmp27_ = NULL;
		_data_->_tmp27_ = rygel_http_server_get_transcoder (_data_->_tmp23_, _data_->_tmp26_, &_data_->_inner_error_);
...
static gboolean rygel_http_get_real_find_item_co (RygelHttpGetFindItemData* _data_) {
	...
	if (_data_->_tmp40_) {
		_data_->_tmp45_ = NULL;
		_data_->_tmp45_ = ((RygelHTTPRequest*) _data_->self)->object;
		_data_->_tmp46_ = NULL;
		_data_->_tmp46_ = _rygel_media_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_data_->_tmp45_, RYGEL_TYPE_VIDEO_ITEM) ? ((RygelVideoItem*) _data_->_tmp45_) : NULL);
		_data_->video = _data_->_tmp46_;
		_data_->_tmp47_ = NULL;
		_data_->_tmp47_ = ((RygelHTTPRequest*) _data_->self)->uri;
		_data_->_tmp48_ = 0;
		_data_->_tmp48_ = rygel_http_item_uri_get_subtitle_index (_data_->_tmp47_);
		_data_->_tmp49_ = 0;
		...
		if (_data_->_tmp49_ < _data_->_tmp53_) {
			_data_->_tmp54_ = NULL;
			...
			_data_->_tmp59_ = NULL;
			_data_->_tmp59_ = gee_abstract_list_get ((GeeAbstractList*) _data_->_tmp55_, _data_->_tmp58_);
			_rygel_subtitle_unref0 (_data_->self->subtitle);
			_data_->self->subtitle = (RygelSubtitle*) _data_->_tmp59_;
		...
		_data_->_tmp60_ = NULL;
		_data_->_tmp60_ = ((RygelHTTPRequest*) _data_->self)->object;
		_data_->_tmp61_ = NULL;
		_data_->_tmp61_ = _data_->_tmp60_->id;
		_data_->_tmp62_ = NULL;
		_data_->_tmp62_ = g_error_new (RYGEL_HTTP_REQUEST_ERROR, RYGEL_HTTP_REQUEST_ERROR_NOT_FOUND, "No subtitles available for item '%s", _data_->_tmp61_);
...
static void ___lambda6__soup_message_headers_foreach_func (const gchar* name, const gchar* value, gpointer self) {
	__lambda6_ ((RygelHTTPGet*) self, name, value);
}
...
static gboolean rygel_http_get_handle_item_request_co (RygelHttpGetHandleItemRequestData* _data_) {
	...
	rygel_http_get_handler_add_response_headers (_data_->_tmp30_, _data_->self);
	_data_->_tmp31_ = NULL;
	...
	soup_message_headers_foreach (_data_->_tmp48_, ___lambda6__soup_message_headers_foreach_func, _data_->self);
	_data_->_tmp49_ = NULL;
	...
	_data_->_tmp57_ = NULL;
	_data_->_tmp57_ = rygel_http_get_handler_render_body (_data_->_tmp56_, _data_->self);
...
static void rygel_http_get_ensure_correct_mode (RygelHTTPGet* self, GError** error) {
	...
	if (!_tmp31_) {
		...
		_tmp34_ = _tmp33_->id;
		_tmp35_ = g_error_new (RYGEL_HTTP_REQUEST_ERROR, RYGEL_HTTP_REQUEST_ERROR_UNACCEPTABLE, "%s mode not supported for '%s'", _tmp32_, _tmp34_);

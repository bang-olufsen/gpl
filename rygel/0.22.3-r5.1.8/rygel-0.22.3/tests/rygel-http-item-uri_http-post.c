/* rygel-http-item-uri_http-post.c generated by valac 0.24.0.112-bbf5, the Vala compiler
...
RygelHTTPItemURI* rygel_http_item_uri_construct_from_string (GType object_type, const gchar* uri, RygelHTTPServer* http_server, GError** error) {
	...
	}
	{
		...
		i = 1;
		{
			...
			while (TRUE) {
				...
				} else if (_tmp41_ == ((0 != _tmp40_label1) ? _tmp40_label1 : (_tmp40_label1 = g_quark_from_static_string ("tr")))) {
					switch (0) {
						default:
						{
							gchar** _tmp55_ = NULL;
							...
							_tmp58_ = soup_uri_decode (_tmp57_);
							_tmp59_ = _tmp58_;
							rygel_http_item_uri_set_transcode_target (self, _tmp59_);
							_g_free0 (_tmp59_);
							break;
						}
					}
				} else if (_tmp41_ == ((0 != _tmp40_label2) ? _tmp40_label2 : (_tmp40_label2 = g_quark_from_static_string ("th")))) {
					switch (0) {
						default:
						{
							gchar** _tmp60_ = NULL;
							...
							rygel_http_item_uri_set_thumbnail_index (self, _tmp63_);
							break;
						}
					}
				} else if (_tmp41_ == ((0 != _tmp40_label3) ? _tmp40_label3 : (_tmp40_label3 = g_quark_from_static_string ("sub")))) {
					switch (0) {
						default:
						{
							gchar** _tmp64_ = NULL;
							...
							rygel_http_item_uri_set_subtitle_index (self, _tmp67_);
							break;
						}
					}
				} else if (_tmp41_ == ((0 != _tmp40_label4) ? _tmp40_label4 : (_tmp40_label4 = g_quark_from_static_string ("pl")))) {
					switch (0) {
						default:
						{
							gchar** _tmp68_ = NULL;
							...
							_tmp69_ = i;
							_tmp70_ = _tmp68_[_tmp69_ + 1];
							_tmp71_ = soup_uri_decode (_tmp70_);
							_tmp72_ = _tmp71_;
							rygel_http_item_uri_set_playlist_format (self, _tmp72_);
							_g_free0 (_tmp72_);
							break;
						}
					}
	...
	_tmp73_ = self->priv->_item_id;
	if (_tmp73_ == NULL) {
		const gchar* _tmp74_ = NULL;
		GError* _tmp75_ = NULL;
		_tmp74_ = _ ("Not found");
		_tmp75_ = g_error_new_literal (RYGEL_HTTP_REQUEST_ERROR, RYGEL_HTTP_REQUEST_ERROR_NOT_FOUND, _tmp74_);

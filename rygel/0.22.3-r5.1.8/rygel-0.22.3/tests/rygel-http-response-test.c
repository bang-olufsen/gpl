/* rygel-http-response-test.c generated by valac 0.24.0.112-bbf5, the Vala compiler
...
static void __lambda4_ (Block1Data* _data1_, SoupMessage* msg, SoupBuffer* chunk);
static void ___lambda4__soup_message_got_chunk (SoupMessage* _sender, SoupBuffer* chunk, gpointer self);
...
static gboolean __lambda6_ (RygelTestDataSource* self);
...
gint rygel_http_response_test_main (gchar** args, int args_length1) {
	...
	GError * _inner_error_ = NULL;
	{
		...
		RygelHTTPResponseTest* _tmp5_ = NULL;
		...
		test = _tmp4_;
		_tmp5_ = test;
		rygel_http_response_test_run (_tmp5_, &_inner_error_);
		if (G_UNLIKELY (_inner_error_ != NULL)) {
	...
	__catch0_g_error:
	{
		...
		g_critical ("rygel-http-response-test.vala:61: %s", _tmp9_);
		result = -1;
		_g_error_free0 (_error_);
		return result;
	}
...
RygelHTTPResponseTest* rygel_http_response_test_construct (GType object_type, GCancellable* cancellable, GError** error) {
	...
	_tmp7_ = self->server;
	_tmp8_ = rygel_http_server_get_uri (_tmp7_);
	_tmp9_ = _tmp8_;
	_tmp10_ = _tmp9_;
	_tmp11_ = cancellable;
	_tmp12_ = rygel_http_client_new (_tmp6_, _tmp10_, (gsize) RYGEL_HTTP_RESPONSE_TEST_MAX_BYTES, _tmp11_ != NULL);
	_g_object_unref0 (self->client);
	self->client = _tmp12_;
	_g_free0 (_tmp10_);
	_tmp13_ = g_main_loop_new (NULL, FALSE);
	_g_main_loop_unref0 (self->priv->main_loop);
	self->priv->main_loop = _tmp13_;
	_g_object_unref0 (_tmp2_);
	return self;
}
...
static gboolean _rygel_http_response_test_on_timeout_gsource_func (gpointer self) {
	gboolean result;
	result = rygel_http_response_test_on_timeout ((RygelHTTPResponseTest*) self);
	return result;
}


static void _rygel_http_response_test_on_message_received_rygel_http_server_message_received (RygelHTTPServer* _sender, SoupMessage* message, gpointer self) {
	rygel_http_response_test_on_message_received ((RygelHTTPResponseTest*) self, _sender, message);
}


static void _rygel_http_response_test_on_message_aborted_rygel_http_server_message_aborted (RygelHTTPServer* _sender, SoupMessage* message, gpointer self) {
	rygel_http_response_test_on_message_aborted ((RygelHTTPResponseTest*) self, _sender, message);
}


static void _rygel_http_response_test_on_client_completed_rygel_state_machine_completed (RygelStateMachine* _sender, gpointer self) {
	rygel_http_response_test_on_client_completed ((RygelHTTPResponseTest*) self, _sender);
}
...
static RygelHTTPResponse* rygel_http_response_test_create_response (RygelHTTPResponseTest* self, SoupMessage* msg, GError** error) {
	...
	RygelHTTPResponse* _tmp28_ = NULL;
	GError * _inner_error_ = NULL;
...
static void _rygel_http_response_test_on_response_completed_rygel_state_machine_completed (RygelStateMachine* _sender, gpointer self) {
	rygel_http_response_test_on_response_completed ((RygelHTTPResponseTest*) self, _sender);
}
...
RygelHTTPServer* rygel_http_server_construct (GType object_type, GError** error) {
	...
	_tmp15_ = gupnp_context_get_server (_tmp14_);
	_tmp16_ = _tmp15_;
	g_signal_connect_object (_tmp16_, "request-aborted", (GCallback) _rygel_http_server_on_request_aborted_soup_server_request_aborted, self, 0);
	return self;
}
...
static void _rygel_http_client_on_cancelled_g_cancellable_cancelled (GCancellable* _sender, gpointer self) {
	rygel_http_client_on_cancelled ((RygelHTTPClient*) self, _sender);
}
...
static void __lambda5_ (Block1Data* _data1_, SoupSession* session, SoupMessage* msg) {
	...
	_vala_assert (_tmp0_, "cancellable != null || bytes_received == this.total_bytes");
...
static gboolean rygel_http_client_real_run_co (RygelHttpClientRunData* _data_) {
	...
	g_signal_connect_data (_data_->_tmp0_, "got-chunk", (GCallback) ___lambda4__soup_message_got_chunk, block1_data_ref (_data_->_data1_), (GClosureNotify) block1_data_unref, 0);
	_data_->_tmp1_ = NULL;
	...
	soup_session_queue_message (_data_->_tmp3_, _data_->_tmp5_, ___lambda5__soup_session_callback, block1_data_ref (_data_->_data1_));
	_data_->_state_ = 1;
	return FALSE;
	_state_1:
	;
...
static gboolean ___lambda6__gsource_func (gpointer self) {
	gboolean result;
	result = __lambda6_ ((RygelTestDataSource*) self);
	return result;
}

/* rygel-searchable-container-test.c generated by valac 0.24.0.112-bbf5, the Vala compiler
	...
	_data_->_result_ = _data_->_tmp0_;
	{
		_data_->i = 0;
		{
			...
			while (TRUE) {
				...
				_data_->_tmp5_ = NULL;
				_data_->_tmp5_ = media_object_new ();
				_data_->_tmp6_ = NULL;
				_data_->_tmp6_ = _data_->_tmp5_;
				gee_abstract_collection_add ((GeeAbstractCollection*) _data_->_tmp4_, _data_->_tmp6_);
...
static gboolean test_container_test_search_no_limit_co (TestContainerTestSearchNoLimitData* _data_) {
		...
		_data_->i = 1;
		{
			...
			while (TRUE) {
				...
				}
				{
					...
					_data_->_tmp14_ = 0U;
					_data_->_state_ = 3;
					rygel_searchable_container_search ((RygelSearchableContainer*) _data_->self, NULL, (guint) _data_->_tmp13_, (guint) 0, "", NULL, test_container_test_search_no_limit_ready, _data_);
					return FALSE;
					_state_3:
					_data_->_tmp15_ = NULL;
					_data_->_tmp15_ = rygel_searchable_container_search_finish ((RygelSearchableContainer*) _data_->self, _data_->_res_, &_data_->_tmp14_, &_data_->_inner_error_);
					_data_->total_matches = _data_->_tmp14_;
					_data_->_vala2__result_ = _data_->_tmp15_;
					if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
						goto __catch2_g_error;
					}
					_data_->_tmp16_ = 0U;
					_data_->_tmp16_ = _data_->total_matches;
					_vala_assert (_data_->_tmp16_ == ((guint) 10), "total_matches == 10");
					_data_->_tmp17_ = NULL;
					_data_->_tmp17_ = _data_->_vala2__result_;
					_data_->_tmp18_ = 0;
					...
					_vala_assert (_data_->_tmp19_ == (10 - _data_->_tmp20_), "result.size == 10 - i");
	...
	_data_->_tmp21_ = NULL;
	_data_->_tmp21_ = _data_->self->loop;
		...
		_data_->i = 1;
		{
			...
			while (TRUE) {
				...
				}
				{
					...
					_data_->_tmp14_ = 0U;
					_data_->_state_ = 3;
					rygel_searchable_container_search ((RygelSearchableContainer*) _data_->self, NULL, (guint) _data_->_tmp13_, (guint) 3, "", NULL, test_container_test_search_with_limit_ready, _data_);
					return FALSE;
					_state_3:
					_data_->_tmp15_ = NULL;
					_data_->_tmp15_ = rygel_searchable_container_search_finish ((RygelSearchableContainer*) _data_->self, _data_->_res_, &_data_->_tmp14_, &_data_->_inner_error_);
					...
					_data_->_tmp16_ = 0U;
					_data_->_tmp16_ = _data_->total_matches;
					_vala_assert (_data_->_tmp16_ == ((guint) 0), "total_matches == 0");
					_data_->_tmp17_ = NULL;
					_data_->_tmp17_ = _data_->_vala2__result_;
					_data_->_tmp18_ = 0;
					_data_->_tmp18_ = gee_abstract_collection_get_size ((GeeCollection*) _data_->_tmp17_);
					...
					_data_->_tmp20_ = _data_->i;
					_data_->_tmp21_ = 0;
					_data_->_tmp21_ = MIN (10 - _data_->_tmp20_, 3);
					_vala_assert (_data_->_tmp19_ == _data_->_tmp21_, "result.size == int.min (10 - i, 3)");
					_g_object_unref0 (_data_->_vala2__result_);
				}
				goto __finally5;
				__catch5_g_error:
...
static gboolean test_container_real_search_co (TestContainerSearchData* _data_) {
	...
	if (_data_->_tmp0_ == NULL) {
		_data_->_tmp2_ = NULL;
		_data_->_tmp2_ = ((MediaContainer*) _data_->self)->sort_criteria;
	...
	_data_->_tmp8_ = 0U;
	_data_->_state_ = 1;
	rygel_searchable_container_simple_search ((RygelSearchableContainer*) _data_->self, _data_->_tmp4_, _data_->_tmp5_, _data_->_tmp6_, _data_->_tmp0_, _data_->_tmp7_, test_container_search_ready, _data_);
	return FALSE;
	_state_1:
	_data_->_tmp9_ = NULL;

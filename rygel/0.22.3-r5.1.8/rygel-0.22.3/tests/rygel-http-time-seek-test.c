/* rygel-http-time-seek-test.c generated by valac 0.24.0.112-bbf5, the Vala compiler
...
static GType rygel_http_time_seek_test_test_type_get_type (void) G_GNUC_CONST G_GNUC_UNUSED;
...
static void rygel_http_get_add_headers (RygelHTTPGet* self, gint64 start, gint64 stop) {
	...
	_tmp13_ = _tmp12_;
	_tmp14_ = g_strconcat (_tmp13_, stop_str, NULL);
	_tmp15_ = _tmp14_;
	_g_free0 (_tmp13_);
	_g_free0 (_tmp11_);
	_g_free0 (_tmp9_);
	...
	soup_message_headers_append (_tmp17_, "TimeSeekRange.dlna.org", range);
	_g_free0 (range);
	_g_free0 (stop_str);
	_g_free0 (_tmp1_);
}

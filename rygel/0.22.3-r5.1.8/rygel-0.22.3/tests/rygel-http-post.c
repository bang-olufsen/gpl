/* rygel-http-post.c generated by valac 0.24.0.112-bbf5, the Vala compiler
...
static gboolean ____lambda6_ (Block6Data* _data6_);
static gboolean _____lambda6__gsource_func (gpointer self);
static void ____lambda7_ (Block6Data* _data6_);
...
static gboolean rygel_http_post_handle_real_co (RygelHttpPostHandleRealData* _data_) {
	...
	_data_->_tmp29_ = NULL;
	_data_->_tmp29_ = _data_->self->priv->dotfile;
	_data_->_tmp30_ = NULL;
	_data_->_tmp30_ = rygel_state_machine_get_cancellable ((RygelStateMachine*) _data_->self);
	_data_->_tmp31_ = NULL;
	_data_->_tmp31_ = _data_->_tmp30_;
	_data_->_state_ = 2;
	g_file_replace_async (_data_->_tmp29_, NULL, FALSE, G_FILE_CREATE_REPLACE_DESTINATION, G_PRIORITY_LOW, _data_->_tmp31_, rygel_http_post_handle_real_ready, _data_);
	return FALSE;
	_state_2:
	_data_->_tmp32_ = NULL;
	...
	_data_->self->priv->stream = (GOutputStream*) _data_->_tmp33_;
	_data_->_tmp34_ = NULL;
	_data_->_tmp34_ = ((RygelHTTPRequest*) _data_->self)->msg;
	g_signal_connect_object (_data_->_tmp34_, "got-chunk", (GCallback) _rygel_http_post_on_got_chunk_soup_message_got_chunk, _data_->self, 0);
	_data_->_tmp35_ = NULL;
	_data_->_tmp35_ = ((RygelHTTPRequest*) _data_->self)->msg;
	g_signal_connect_object (_data_->_tmp35_, "got-body", (GCallback) _rygel_http_post_on_got_body_soup_message_got_body, _data_->self, 0);
	_data_->_tmp36_ = NULL;
	_data_->_tmp36_ = ((RygelHTTPRequest*) _data_->self)->server;
	_data_->_tmp37_ = NULL;
	_data_->_tmp37_ = ((RygelHTTPRequest*) _data_->self)->msg;
	soup_server_unpause_message (_data_->_tmp36_, _data_->_tmp37_);
...
static gboolean rygel_http_post_wait_for_item_co (RygelHttpPostWaitForItemData* _data_) {
	...
	while (TRUE) {
		...
		}
		{
			...
			_data_->_tmp5_ = NULL;
			_data_->_tmp12_ = NULL;
			_data_->_tmp12_ = G_TYPE_CHECK_INSTANCE_TYPE (_data_->_tmp11_, RYGEL_TYPE_MEDIA_ITEM) ? ((RygelMediaItem*) _data_->_tmp11_) : NULL;
		...
		if (_data_->_tmp16_) {
			...
			_data_->_tmp18_ = 0U;
			_data_->_tmp18_ = g_timeout_add_seconds_full (G_PRIORITY_DEFAULT, _data_->_tmp17_, _____lambda6__gsource_func, block6_data_ref (_data_->_data6_), block6_data_unref);
			_data_->_data6_->source_id = _data_->_tmp18_;
			_data_->_tmp19_ = NULL;
			_data_->_tmp19_ = _data_->_data5_->container;
			_data_->_tmp20_ = 0UL;
			_data_->_tmp20_ = g_signal_connect_data (_data_->_tmp19_, "container-updated", (GCallback) _____lambda7__rygel_media_container_container_updated, block6_data_ref (_data_->_data6_), (GClosureNotify) block6_data_unref, 0);

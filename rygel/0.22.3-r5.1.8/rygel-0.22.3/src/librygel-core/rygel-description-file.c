/* rygel-description-file.c generated by valac 0.24.0, the Vala compiler
...
void rygel_description_file_set_dlna_caps (RygelDescriptionFile* self, RygelPluginCapabilities capabilities) {
	...
	if (_tmp27_) {
		...
		_tmp31_ = g_strdup ("create-child-container");
		_vala_array_add10 (&flags, &flags_length1, &_flags_size_, _tmp31_);
	}
	_tmp32_ = capabilities;
	if ((_tmp32_ & RYGEL_PLUGIN_CAPABILITIES_DIAGNOSTICS) == RYGEL_PLUGIN_CAPABILITIES_DIAGNOSTICS) {
		gchar** _tmp33_ = NULL;
		gint _tmp33__length1 = 0;
		gchar* _tmp34_ = NULL;
		_tmp33_ = flags;
		_tmp33__length1 = flags_length1;
		_tmp34_ = g_strdup ("+DIAGE+");
		_vala_array_add11 (&flags, &flags_length1, &_flags_size_, _tmp34_);
	}
	_tmp35_ = flags;
	...
	if (_tmp35__length1 > 0) {
		...
		content = _tmp37_;
		_tmp38_ = content;
		rygel_description_file_set_device_element (self, "X_DLNACAP", _tmp38_, "dlna");
		_g_free0 (content);
	} else {
...
void rygel_description_file_modify_service_type (RygelDescriptionFile* self, const gchar* old_type, const gchar* new_type) {
	...
	xpath = _tmp4_;
	_tmp5_ = xmlXPathEvalExpression ((xmlChar*) xpath, context);
	xpath_object = _tmp5_;
	...
	_tmp11_ = new_type;
	xmlNodeSetContent (_tmp10_, (xmlChar*) _tmp11_);

/* rygel-object-creator.c generated by valac 0.24.0, the Vala compiler
...
static void __lambda7_ (RygelObjectCreator* self, GUPnPDIDLLiteObject* didl_object);
static void ___lambda7__gupnp_didl_lite_parser_object_available (GUPnPDIDLLiteParser* _sender, GUPnPDIDLLiteObject* object, gpointer self);
...
static void ____lambda8_ (Block9Data* _data9_, RygelMediaContainer* container);
GType rygel_object_event_type_get_type (void) G_GNUC_CONST;
static void _____lambda8__rygel_media_container_container_updated (RygelMediaContainer* _sender, RygelMediaContainer* container, RygelMediaObject* object, RygelObjectEventType event_type, gboolean sub_tree_update, gpointer self);
static gboolean ____lambda9_ (Block9Data* _data9_);
	...
	_state_0:
	{
		...
		if (g_strcmp0 (_data_->_tmp39_, RYGEL_MEDIA_CONTAINER_ANY) == 0) {
			...
			if (G_TYPE_CHECK_INSTANCE_TYPE (_data_->_tmp41_, RYGEL_TYPE_MEDIA_ITEM)) {
				...
				_data_->_tmp43_ = rygel_media_item_get_place_holder (G_TYPE_CHECK_INSTANCE_TYPE (_data_->_tmp42_, RYGEL_TYPE_MEDIA_ITEM) ? ((RygelMediaItem*) _data_->_tmp42_) : NULL);
...
static void ___lambda7__gupnp_didl_lite_parser_object_available (GUPnPDIDLLiteParser* _sender, GUPnPDIDLLiteObject* object, gpointer self) {
	__lambda7_ ((RygelObjectCreator*) self, object);
}
...
static void rygel_object_creator_parse_didl (RygelObjectCreator* self, GError** error) {
	...
	g_signal_connect_object (_tmp0_, "object-available", (GCallback) ___lambda7__gupnp_didl_lite_parser_object_available, self, 0);
	{
...
static gboolean rygel_object_creator_create_object_from_didl_co (RygelObjectCreatorCreateObjectFromDidlData* _data_) {
	...
	if (_data_->_tmp17_ == 0) {
		...
		if (G_TYPE_CHECK_INSTANCE_TYPE (_data_->_tmp26_, RYGEL_TYPE_MEDIA_ITEM)) {
			...
			rygel_media_item_set_place_holder (G_TYPE_CHECK_INSTANCE_TYPE (_data_->_tmp27_, RYGEL_TYPE_MEDIA_ITEM) ? ((RygelMediaItem*) _data_->_tmp27_) : NULL, TRUE);
		}
		_g_free0 (_data_->uri);
	} else {
		_data_->_tmp28_ = NULL;
		...
		if (G_TYPE_CHECK_INSTANCE_TYPE (_data_->_tmp28_, RYGEL_TYPE_MEDIA_ITEM)) {
			...
			rygel_media_item_set_place_holder (G_TYPE_CHECK_INSTANCE_TYPE (_data_->_tmp35_, RYGEL_TYPE_MEDIA_ITEM) ? ((RygelMediaItem*) _data_->_tmp35_) : NULL, !_data_->_tmp37_);
...
static void rygel_object_creator_extract_item_parameters (RygelObjectCreator* self, GError** error) {
	...
	if (_tmp4_) {
		...
		GUPnPDIDLLiteResource* _tmp49_ = NULL;
		glong _tmp50_ = 0L;
		glong _tmp51_ = 0L;
		_tmp8_ = resources;
		...
		if (_tmp16_ != NULL) {
			...
			if (_tmp19_ != NULL) {
				...
				_tmp34_ = _tmp33_;
				rygel_media_item_set_dlna_profile (_tmp31_, _tmp34_);
			}
			_tmp35_ = info;
			_tmp36_ = gupnp_protocol_info_get_mime_type (_tmp35_);
			_tmp37_ = _tmp36_;
			if (_tmp37_ != NULL) {
				...
				_tmp38_ = item;
				_tmp39_ = info;
				_tmp40_ = gupnp_protocol_info_get_mime_type (_tmp39_);
				_tmp41_ = _tmp40_;
				rygel_media_item_set_mime_type (_tmp38_, _tmp41_);
			}
		}
		sanitized_uri = NULL;
		_tmp42_ = resource;
		...
		if (_tmp51_ >= ((glong) 0)) {
			...
			_tmp55_ = _tmp54_;
			rygel_media_item_set_size (_tmp52_, (gint64) _tmp55_);
		}
		_g_free0 (sanitized_uri);
		_g_object_unref0 (info);
		_g_object_unref0 (resource);
	...
	_tmp56_ = item;
	_tmp57_ = rygel_media_item_get_mime_type (_tmp56_);
	_tmp58_ = _tmp57_;
	if (_tmp58_ == NULL) {
		...
		gchar* _tmp61_ = NULL;
		_tmp59_ = item;
		_tmp60_ = rygel_object_creator_get_generic_mime_type (self);
		_tmp61_ = _tmp60_;
		rygel_media_item_set_mime_type (_tmp59_, _tmp61_);
		_g_free0 (_tmp61_);
	}
	_tmp62_ = item;
	_tmp63_ = rygel_media_item_get_size (_tmp62_);
	_tmp64_ = _tmp63_;
	if (_tmp64_ < ((gint64) 0)) {
		RygelMediaItem* _tmp65_ = NULL;
		_tmp65_ = item;
		rygel_media_item_set_size (_tmp65_, (gint64) 0);
	}
	__g_list_free__g_object_unref0_0 (resources);
	_g_object_unref0 (item);
}
...
"ct '%s' in it: %s");
		...
		if (_data_->_tmp25_ == NULL) {
			...
			_data_->_tmp27_ = 0UL;
			_data_->_tmp27_ = g_signal_connect_data ((RygelMediaContainer*) _data_->_tmp26_, "container-updated", (GCallback) _____lambda8__rygel_media_container_container_updated, block9_data_ref (_data_->_data9_), (GClosureNotify) block9_data_unref, 0);
			_data_->id = _data_->_tmp27_;
			_data_->_data9_->timeout = (guint) 0;
			_data_->_tmp28_ = 0U;
			_data_->_tmp28_ = g_timeout_add_seconds_full (G_PRIORITY_DEFAULT, (guint) 5, _____lambda9__gsource_func, block9_data_ref (_data_->_data9_), block9_data_unref);

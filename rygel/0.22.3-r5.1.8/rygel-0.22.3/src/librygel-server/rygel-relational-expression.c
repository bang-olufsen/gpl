/* rygel-relational-expression.c generated by valac 0.24.0, the Vala compiler
	...
	if (_tmp3_ == ((0 != _tmp2_label0) ? _tmp2_label0 : (_tmp2_label0 = g_quark_from_static_string ("@id")))) {
			...
			default:
			{
				...
				if (((GUPnPSearchCriteriaOp) ((gintptr) _tmp26_)) == GUPNP_SEARCH_CRITERIA_OP_EXISTS) {
					...
					if (g_strcmp0 ((const gchar*) _tmp27_, "true") == 0) {
						...
						if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp32_, RYGEL_TYPE_TRACKABLE_CONTAINER)) {
							_tmp31_ = TRUE;
						} else {
							RygelMediaObject* _tmp33_ = NULL;
							_tmp33_ = media_object;
							_tmp31_ = G_TYPE_CHECK_INSTANCE_TYPE (_tmp33_, RYGEL_TYPE_TRACKABLE_ITEM);
						}
						result = !_tmp31_;
						return result;
					}
					...
					_tmp35_ = rygel_media_object_get_object_update_id (_tmp34_);
					_tmp36_ = _tmp35_;
					_tmp37_ = rygel_relational_expression_compare_uint (self, _tmp36_);
					result = _tmp37_;
					return result;
				}
			}
		...
		switch (0) {
			default:
			{
				...
				if (!G_TYPE_CHECK_INSTANCE_TYPE (_tmp38_, RYGEL_TYPE_MEDIA_CONTAINER)) {
					result = FALSE;
					return result;
				}
				_tmp39_ = ((RygelSearchExpression*) self)->op;
				if (((GUPnPSearchCriteriaOp) ((gintptr) _tmp39_)) == GUPNP_SEARCH_CRITERIA_OP_EXISTS) {
					gconstpointer _tmp40_ = NULL;
					_tmp40_ = ((RygelSearchExpression*) self)->operand2;
					if (g_strcmp0 ((const gchar*) _tmp40_, "true") == 0) {
						...
						result = !G_TYPE_CHECK_INSTANCE_TYPE (_tmp42_, RYGEL_TYPE_TRACKABLE_CONTAINER);
						return result;
					}
				} else {
					...
					RygelMediaContainer* _tmp45_ = NULL;
					guint32 _tmp46_ = 0U;
					gboolean _tmp47_ = FALSE;
					_tmp43_ = media_object;
					_tmp44_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp43_, RYGEL_TYPE_MEDIA_CONTAINER) ? ((RygelMediaContainer*) _tmp43_) : NULL);
					container = _tmp44_;
					_tmp45_ = container;
					_tmp46_ = _tmp45_->update_id;
					_tmp47_ = rygel_relational_expression_compare_uint (self, (guint) _tmp46_);
					result = _tmp47_;
		...
		switch (0) {
			default:
			{
				...
				if (!G_TYPE_CHECK_INSTANCE_TYPE (_tmp48_, RYGEL_TYPE_WRITABLE_CONTAINER)) {
					result = FALSE;
					return result;
				}
				_tmp49_ = media_object;
				_tmp50_ = rygel_relational_expression_compare_create_class (self, G_TYPE_CHECK_INSTANCE_TYPE (_tmp49_, RYGEL_TYPE_WRITABLE_CONTAINER) ? ((RygelWritableContainer*) _tmp49_) : NULL);
				result = _tmp50_;
				return result;
			}
		}
		...
		switch (0) {
			default:
			{
				...
				if (!G_TYPE_CHECK_INSTANCE_TYPE (_tmp51_, RYGEL_TYPE_PHOTO_ITEM)) {
					result = FALSE;
					return result;
				}
				_tmp52_ = media_object;
				_tmp53_ = rygel_media_item_get_creator ((RygelMediaItem*) (G_TYPE_CHECK_INSTANCE_TYPE (_tmp52_, RYGEL_TYPE_PHOTO_ITEM) ? ((RygelPhotoItem*) _tmp52_) : NULL));
				_tmp54_ = _tmp53_;
		...
		switch (0) {
			default:
			{
				...
				_tmp58_ = rygel_music_item_get_artist (G_TYPE_CHECK_INSTANCE_TYPE (_tmp57_, RYGEL_TYPE_MUSIC_ITEM) ? ((RygelMusicItem*) _tmp57_) : NULL);
				_tmp59_ = _tmp58_;
				_tmp60_ = rygel_relational_expression_compare_string (self, _tmp59_);
				result = _tmp60_;
				return result;
			}
		}
		...
		switch (0) {
			default:
			{
				...
				if (!G_TYPE_CHECK_INSTANCE_TYPE (_tmp61_, RYGEL_TYPE_MUSIC_ITEM)) {
					result = FALSE;
					return result;
				}
				_tmp62_ = media_object;
				_tmp63_ = rygel_music_item_get_album (G_TYPE_CHECK_INSTANCE_TYPE (_tmp62_, RYGEL_TYPE_MUSIC_ITEM) ? ((RygelMusicItem*) _tmp62_) : NULL);
				_tmp64_ = _tmp63_;
				_tmp65_ = rygel_relational_expression_compare_string (self, _tmp64_);
				result = _tmp65_;
				return result;
			}
		}
		...
		switch (0) {
			default:
			{
				RygelMediaObject* _tmp66_ = NULL;
				RygelMediaContainer* container = NULL;
				RygelMediaObject* _tmp67_ = NULL;
				RygelMediaContainer* _tmp68_ = NULL;
				RygelMediaContainer* _tmp69_ = NULL;
				gint _tmp70_ = 0;
				gint _tmp71_ = 0;
				gboolean _tmp72_ = FALSE;
				_tmp66_ = media_object;
				if (!G_TYPE_CHECK_INSTANCE_TYPE (_tmp66_, RYGEL_TYPE_MEDIA_CONTAINER)) {
					result = FALSE;
					return result;
				}
				_tmp67_ = media_object;
				_tmp68_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp67_, RYGEL_TYPE_MEDIA_CONTAINER) ? ((RygelMediaContainer*) _tmp67_) : NULL);
				container = _tmp68_;
				_tmp69_ = container;
				_tmp70_ = rygel_media_container_get_child_count (_tmp69_);
				_tmp71_ = _tmp70_;
				_tmp72_ = rygel_relational_expression_compare_int (self, _tmp71_);
				result = _tmp72_;
				_g_object_unref0 (container);
				return result;
			}

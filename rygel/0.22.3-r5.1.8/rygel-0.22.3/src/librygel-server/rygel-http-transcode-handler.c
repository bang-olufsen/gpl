/* rygel-http-transcode-handler.c generated by valac 0.24.0, the Vala compiler
...
static RygelHTTPResponse* rygel_http_transcode_handler_real_render_body (RygelHTTPGetHandler* base, RygelHTTPGet* request, GError** error) {
	...
	}
	{
		...
		RygelHTTPResponse* _tmp19_ = NULL;
		RygelHTTPGet* _tmp20_ = NULL;
		RygelDataSource* _tmp21_ = NULL;
		RygelHTTPResponse* _tmp22_ = NULL;
		RygelHTTPResponse* _tmp23_ = NULL;
		...
		_tmp20_ = request;
		_tmp21_ = src;
		_tmp22_ = rygel_http_response_new (_tmp20_, (RygelHTTPGetHandler*) self, _tmp21_, &_inner_error_);
		_tmp19_ = _tmp22_;
		if (_inner_error_ != NULL) {
	...
	__catch48_g_error:
	{
		...
		_tmp26_ = g_error_new_literal (RYGEL_HTTP_REQUEST_ERROR, RYGEL_HTTP_REQUEST_ERROR_NOT_FOUND, _tmp25_);

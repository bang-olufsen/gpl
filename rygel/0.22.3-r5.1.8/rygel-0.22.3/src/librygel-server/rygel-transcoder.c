/* rygel-transcoder.c generated by valac 0.24.0, the Vala compiler
...
static GUPnPDIDLLiteResource* rygel_transcoder_real_add_resource (RygelTranscoder* self, GUPnPDIDLLiteItem* didl_item, RygelMediaItem* item, RygelTranscodeManager* manager, GError** error) {
	...
	gchar* protocol = NULL;
	RygelTranscodeManager* _tmp10_ = NULL;
	gchar* _tmp11_ = NULL;
	gchar* uri = NULL;
	RygelTranscodeManager* _tmp12_ = NULL;
	...
	_tmp10_ = manager;
	_tmp11_ = rygel_transcode_manager_get_protocol (_tmp10_);
	protocol = _tmp11_;
	_tmp12_ = manager;
	_tmp13_ = item;
	_tmp14_ = self->priv->_dlna_profile;
	_tmp15_ = rygel_transcode_manager_create_uri_for_item (_tmp12_, _tmp13_, -1, -1, _tmp14_, NULL);
	uri = _tmp15_;
	_tmp16_ = item;
	_tmp17_ = didl_item;
	_tmp18_ = uri;
	_tmp19_ = protocol;
	_tmp20_ = rygel_media_object_add_resource ((RygelMediaObject*) _tmp16_, (GUPnPDIDLLiteObject*) _tmp17_, _tmp18_, _tmp19_, NULL, &_inner_error_);
	res = _tmp20_;
	...
	_tmp21_ = res;
	gupnp_didl_lite_resource_set_size (_tmp21_, (glong) (-1));
	_tmp22_ = res;
	_tmp23_ = gupnp_didl_lite_resource_get_protocol_info (_tmp22_);
	_tmp24_ = _tmp23_;
	_tmp25_ = _g_object_ref0 (_tmp24_);
	protocol_info = _tmp25_;
	_tmp26_ = protocol_info;
	_tmp27_ = self->priv->_mime_type;
	gupnp_protocol_info_set_mime_type (_tmp26_, _tmp27_);
	_tmp28_ = protocol_info;
	_tmp29_ = self->priv->_dlna_profile;
	gupnp_protocol_info_set_dlna_profile (_tmp28_, _tmp29_);
	_tmp30_ = protocol_info;
	gupnp_protocol_info_set_dlna_conversion (_tmp30_, GUPNP_DLNA_CONVERSION_TRANSCODED);
	_tmp31_ = protocol_info;
	gupnp_protocol_info_set_dlna_flags (_tmp31_, ((GUPNP_DLNA_FLAGS_STREAMING_TRANSFER_MODE | GUPNP_DLNA_FLAGS_BACKGROUND_TRANSFER_MODE) | GUPNP_DLNA_FLAGS_CONNECTION_STALL) | GUPNP_DLNA_FLAGS_DLNA_V15);
	_tmp33_ = item;
	if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp33_, RYGEL_TYPE_AUDIO_ITEM)) {
		RygelMediaItem* _tmp34_ = NULL;
		glong _tmp35_ = 0L;
		glong _tmp36_ = 0L;
		_tmp34_ = item;
		_tmp35_ = rygel_audio_item_get_duration (G_TYPE_CHECK_INSTANCE_TYPE (_tmp34_, RYGEL_TYPE_AUDIO_ITEM) ? ((RygelAudioItem*) _tmp34_) : NULL);
		_tmp36_ = _tmp35_;
		_tmp32_ = _tmp36_ > ((glong) 0);
	} else {
		_tmp32_ = FALSE;
	}
	if (_tmp32_) {
		...
		GUPnPProtocolInfo* _tmp38_ = NULL;

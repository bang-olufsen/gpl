/* rygel-http-byte-seek.c generated by valac 0.24.0, the Vala compiler
	...
	if (_tmp5_) {
		...
		if (_tmp8_) {
			...
			if (_tmp20_ != NULL) {
				...
				_tmp23_ = ((RygelIconInfo*) _tmp22_)->size;
		...
		if (_tmp7_) {
			...
			if (_tmp26_ != NULL) {
				...
				gint64 _tmp29_ = 0LL;
				_tmp27_ = request;
				_tmp28_ = _tmp27_->subtitle;
				_tmp29_ = _tmp28_->size;
				_tmp24_ = _tmp29_ > ((gint64) 0);
			} else {
				_tmp24_ = FALSE;
			}
			_tmp6_ = _tmp24_;

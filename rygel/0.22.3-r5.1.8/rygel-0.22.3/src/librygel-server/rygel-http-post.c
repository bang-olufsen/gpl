/* rygel-http-post.c generated by valac 0.24.0, the Vala compiler
...
static gboolean ____lambda18_ (Block7Data* _data7_);
static gboolean _____lambda18__gsource_func (gpointer self);
static void ____lambda19_ (Block7Data* _data7_);
GType rygel_object_event_type_get_type (void) G_GNUC_CONST;
static void _____lambda19__rygel_media_container_container_updated (RygelMediaContainer* _sender, RygelMediaContainer* container, RygelMediaObject* object, RygelObjectEventType event_type, gboolean sub_tree_update, gpointer self);
...
static gboolean rygel_http_post_handle_real_co (RygelHttpPostHandleRealData* _data_) {
	...
	if (_data_->_tmp16_ == NULL) {
		...
		_data_->_tmp18_ = NULL;
		_data_->_tmp18_ = ((RygelHTTPRequest*) _data_->self)->object;
		_data_->_tmp19_ = NULL;
		_data_->_tmp19_ = rygel_media_object_get_id (_data_->_tmp18_);
		_data_->_tmp20_ = NULL;
		_data_->_tmp20_ = _data_->_tmp19_;
		_data_->_tmp21_ = NULL;
		_data_->_tmp21_ = g_error_new (RYGEL_HTTP_REQUEST_ERROR, RYGEL_HTTP_REQUEST_ERROR_BAD_REQUEST, _data_->_tmp17_, _data_->_tmp20_);
	...
	_data_->_tmp23_ = NULL;
	_data_->_tmp23_ = g_file_get_parent (_data_->_tmp22_);
	_data_->_tmp24_ = NULL;
	_data_->_tmp24_ = _data_->_tmp23_;
	_data_->_tmp25_ = NULL;
	_data_->_tmp25_ = _data_->self->priv->file;
	_data_->_tmp26_ = NULL;
	_data_->_tmp26_ = g_file_get_basename (_data_->_tmp25_);
	_data_->_tmp27_ = NULL;
	_data_->_tmp27_ = _data_->_tmp26_;
	_data_->_tmp28_ = NULL;
	_data_->_tmp28_ = g_strconcat (".", _data_->_tmp27_, NULL);
	_data_->_tmp29_ = NULL;
	_data_->_tmp29_ = _data_->_tmp28_;
	_data_->_tmp30_ = NULL;
	_data_->_tmp30_ = g_file_get_child (_data_->_tmp24_, _data_->_tmp29_);
	_g_object_unref0 (_data_->self->priv->dotfile);
	_data_->self->priv->dotfile = _data_->_tmp30_;
	_g_free0 (_data_->_tmp29_);
	_g_free0 (_data_->_tmp27_);
	_g_object_unref0 (_data_->_tmp24_);
	_data_->_tmp32_ = NULL;
	_data_->_tmp32_ = _data_->self->priv->dotfile;
	_data_->_tmp33_ = NULL;
	_data_->_tmp33_ = rygel_state_machine_get_cancellable ((RygelStateMachine*) _data_->self);
	_data_->_tmp34_ = NULL;
	_data_->_tmp34_ = _data_->_tmp33_;
	_data_->_state_ = 2;
	g_file_replace_async (_data_->_tmp32_, NULL, FALSE, G_FILE_CREATE_REPLACE_DESTINATION, G_PRIORITY_LOW, _data_->_tmp34_, rygel_http_post_handle_real_ready, _data_);
	return FALSE;
	_state_2:
	_data_->_tmp35_ = NULL;
	_data_->_tmp35_ = g_file_replace_finish (_data_->_tmp32_, _data_->_res_, &_data_->_inner_error_);
	...
	_data_->self->priv->stream = (GOutputStream*) _data_->_tmp36_;
	_data_->_tmp37_ = NULL;
	_data_->_tmp37_ = ((RygelHTTPRequest*) _data_->self)->msg;
	g_signal_connect_object (_data_->_tmp37_, "got-chunk", (GCallback) _rygel_http_post_on_got_chunk_soup_message_got_chunk, _data_->self, 0);
	_data_->_tmp38_ = NULL;
	_data_->_tmp38_ = ((RygelHTTPRequest*) _data_->self)->msg;
	g_signal_connect_object (_data_->_tmp38_, "got-body", (GCallback) _rygel_http_post_on_got_body_soup_message_got_body, _data_->self, 0);
	_data_->_tmp39_ = NULL;
	_data_->_tmp39_ = ((RygelHTTPRequest*) _data_->self)->server;
	_data_->_tmp40_ = NULL;
	_data_->_tmp40_ = ((RygelHTTPRequest*) _data_->self)->msg;
	soup_server_unpause_message (_data_->_tmp39_, _data_->_tmp40_);
...
static gboolean rygel_http_post_wait_for_item_co (RygelHttpPostWaitForItemData* _data_) {
	...
	while (TRUE) {
		...
		{
			_data_->_tmp7_ = NULL;
			_data_->_tmp7_ = _data_->_data6_->container;
			_data_->_tmp8_ = NULL;
			...
			_data_->_tmp6_ = NULL;
			_data_->_tmp13_ = NULL;
			_data_->_tmp13_ = G_TYPE_CHECK_INSTANCE_TYPE (_data_->_tmp12_, RYGEL_TYPE_MEDIA_ITEM) ? ((RygelMediaItem*) _data_->_tmp12_) : NULL;
		...
		if (_data_->_tmp18_) {
			...
			_data_->_tmp20_ = 0U;
			_data_->_tmp20_ = g_timeout_add_seconds_full (G_PRIORITY_DEFAULT, _data_->_tmp19_, _____lambda18__gsource_func, block7_data_ref (_data_->_data7_), block7_data_unref);
			_data_->_data7_->source_id = _data_->_tmp20_;
			_data_->_tmp21_ = NULL;
			_data_->_tmp21_ = _data_->_data6_->container;
			_data_->_tmp22_ = 0UL;
			_data_->_tmp22_ = g_signal_connect_data (_data_->_tmp21_, "container-updated", (GCallback) _____lambda19__rygel_media_container_container_updated, block7_data_ref (_data_->_data7_), (GClosureNotify) block7_data_unref, 0);

/* rygel-media-item.c generated by valac 0.24.0, the Vala compiler
...
static GUPnPDIDLLiteObject* rygel_media_item_real_serialize (RygelMediaObject* base, RygelSerializer* serializer, RygelHTTPServer* http_server, GError** error) {
	...
	if (_tmp34_) {
		...
		GUPnPDIDLLiteContributor* _tmp38_ = NULL;
		GUPnPDIDLLiteContributor* _tmp39_ = NULL;
		const gchar* _tmp40_ = NULL;
		_tmp37_ = didl_item;
		_tmp38_ = gupnp_didl_lite_object_add_creator ((GUPnPDIDLLiteObject*) _tmp37_);
		creator = _tmp38_;
		_tmp39_ = creator;
		_tmp40_ = self->priv->_creator;
		gupnp_didl_lite_contributor_set_name (_tmp39_, _tmp40_);
		_g_object_unref0 (creator);
	}
	_tmp41_ = self->priv->_description;
	if (_tmp41_ != NULL) {
		GUPnPDIDLLiteItem* _tmp42_ = NULL;
		const gchar* _tmp43_ = NULL;
		_tmp42_ = didl_item;
		_tmp43_ = self->priv->_description;
		gupnp_didl_lite_object_set_description ((GUPnPDIDLLiteObject*) _tmp42_, _tmp43_);
	}
	if (G_TYPE_CHECK_INSTANCE_TYPE (self, RYGEL_TYPE_TRACKABLE_ITEM)) {
		GUPnPDIDLLiteItem* _tmp44_ = NULL;
		guint _tmp45_ = 0U;
		guint _tmp46_ = 0U;
		_tmp44_ = didl_item;
		_tmp45_ = rygel_media_object_get_object_update_id ((RygelMediaObject*) self);
		_tmp46_ = _tmp45_;
		gupnp_didl_lite_object_set_update_id ((GUPnPDIDLLiteObject*) _tmp44_, _tmp46_);
	}
	_tmp47_ = http_server;
	_tmp48_ = didl_item;
	rygel_media_item_add_proxy_resources (self, _tmp47_, _tmp48_, &_inner_error_);
	if (_inner_error_ != NULL) {
		g_propagate_error (error, _inner_error_);
		_g_object_unref0 (didl_item);
		return NULL;
	}
	_tmp49_ = self->priv->_place_holder;
	if (!_tmp49_) {
		gchar* host_ip = NULL;
		RygelHTTPServer* _tmp50_ = NULL;
		GUPnPContext* _tmp51_ = NULL;
		const gchar* _tmp52_ = NULL;
		const gchar* _tmp53_ = NULL;
		gchar* _tmp54_ = NULL;
		gboolean internal_allowed = FALSE;
		gboolean _tmp55_ = FALSE;
		RygelHTTPServer* _tmp56_ = NULL;
		GUPnPContext* _tmp57_ = NULL;
		const gchar* _tmp58_ = NULL;
		const gchar* _tmp59_ = NULL;
		GUPnPDIDLLiteItem* _tmp61_ = NULL;
		gboolean _tmp62_ = FALSE;
		GUPnPDIDLLiteItem* _tmp63_ = NULL;
		GList* _tmp64_ = NULL;
		_tmp50_ = http_server;
		_tmp51_ = _tmp50_->context;
		_tmp52_ = gssdp_client_get_host_ip ((GSSDPClient*) _tmp51_);
		_tmp53_ = _tmp52_;
		_tmp54_ = g_strdup (_tmp53_);
		host_ip = _tmp54_;
		_tmp56_ = http_server;
		_tmp57_ = _tmp56_->context;
		_tmp58_ = gssdp_client_get_interface ((GSSDPClient*) _tmp57_);
		_tmp59_ = _tmp58_;
		if (g_strcmp0 (_tmp59_, "lo") == 0) {
			_tmp55_ = TRUE;
		} else {
			const gchar* _tmp60_ = NULL;
			_tmp60_ = host_ip;
			_tmp55_ = g_strcmp0 (_tmp60_, "127.0.0.1") == 0;
		}
		internal_allowed = _tmp55_;
		_tmp61_ = didl_item;
		_tmp62_ = internal_allowed;
		rygel_media_item_add_resources (self, _tmp61_, _tmp62_, &_inner_error_);
		if (_inner_error_ != NULL) {
			g_propagate_error (error, _inner_error_);
			_g_free0 (host_ip);
			_g_object_unref0 (didl_item);
		...
		_tmp63_ = didl_item;
		_tmp64_ = gupnp_didl_lite_object_get_resources ((GUPnPDIDLLiteObject*) _tmp63_);
		{
			GList* res_collection = NULL;
			GList* res_it = NULL;
			res_collection = _tmp64_;
			for (res_it = res_collection; res_it != NULL; res_it = res_it->next) {
				GUPnPDIDLLiteResource* _tmp65_ = NULL;
				GUPnPDIDLLiteResource* res = NULL;
				_tmp65_ = _g_object_ref0 ((GUPnPDIDLLiteResource*) res_it->data);
				res = _tmp65_;
				{
					gchar* _tmp66_ = NULL;
					GRegex* _tmp67_ = NULL;
					GUPnPDIDLLiteResource* _tmp68_ = NULL;
					const gchar* _tmp69_ = NULL;
					const gchar* _tmp70_ = NULL;
					const gchar* _tmp71_ = NULL;
					gchar* _tmp72_ = NULL;
					GUPnPDIDLLiteResource* _tmp73_ = NULL;
					_tmp67_ = rygel_media_item_address_regex;
					_tmp68_ = res;
					_tmp69_ = gupnp_didl_lite_resource_get_uri (_tmp68_);
					_tmp70_ = _tmp69_;
					_tmp71_ = host_ip;
					_tmp72_ = g_regex_replace_literal (_tmp67_, _tmp70_, (gssize) (-1), 0, _tmp71_, 0, &_inner_error_);
					_tmp66_ = _tmp72_;
					if (_inner_error_ != NULL) {
						g_propagate_error (error, _inner_error_);
					...
					_tmp73_ = res;
					gupnp_didl_lite_resource_set_uri (_tmp73_, _tmp66_);
					_g_free0 (_tmp66_);
					_g_object_unref0 (res);
				}
			}
...
static void rygel_media_item_real_add_resources (RygelMediaItem* self, GUPnPDIDLLiteItem* didl_item, gboolean allow_internal, GError** error) {
	...
	g_return_if_fail (didl_item != NULL);
	{
		...
		while (TRUE) {
			...
			if (_tmp13_) {
				GUPnPDIDLLiteItem* _tmp16_ = NULL;
				const gchar* _tmp17_ = NULL;
				...
				_tmp17_ = uri;
				_tmp18_ = protocol;
				_tmp19_ = rygel_media_object_add_resource ((RygelMediaObject*) self, (GUPnPDIDLLiteObject*) _tmp16_, _tmp17_, _tmp18_, NULL, &_inner_error_);
				_tmp20_ = _tmp19_;

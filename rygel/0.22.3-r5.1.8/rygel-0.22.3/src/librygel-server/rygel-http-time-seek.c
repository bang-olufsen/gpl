/* rygel-http-time-seek.c generated by valac 0.24.0, the Vala compiler
...
RygelHTTPTimeSeek* rygel_http_time_seek_construct (GType object_type, RygelHTTPGet* request, GError** error) {
	...
	if (_tmp10_ != NULL) {
		...
		if (_tmp21_) {
			...
			_tmp27_ = _tmp26_[1];
			_tmp20_ = _tmp27_ == NULL;
		}
		if (_tmp20_) {
			const gchar* _tmp28_ = NULL;
			const gchar* _tmp29_ = NULL;
			GError* _tmp30_ = NULL;
			_tmp28_ = _ ("Invalid Range '%s'");
			_tmp29_ = range;
			_tmp30_ = g_error_new (RYGEL_HTTP_SEEK_ERROR, RYGEL_HTTP_SEEK_ERROR_INVALID_RANGE, _tmp28_, _tmp29_);
		...
		_tmp31_ = range_tokens;
		_tmp31__length1 = range_tokens_length1;
		{
			...
			range_token_collection = _tmp31_;
			range_token_collection_length1 = _tmp31__length1;
			for (range_token_it = 0; range_token_it < _tmp31__length1; range_token_it = range_token_it + 1) {
				gchar* _tmp32_ = NULL;
				gchar* range_token = NULL;
				_tmp32_ = g_strdup (range_token_collection[range_token_it]);
				range_token = _tmp32_;
				{
					...
					_tmp34_ = range_token;
					_tmp35_ = string_index_of (_tmp34_, ":", 0);
					if (_tmp35_ == (-1)) {
						const gchar* _tmp36_ = NULL;
						gboolean _tmp37_ = FALSE;
						_tmp36_ = range_token;
						_tmp37_ = rygel_http_time_seek_parse_seconds (_tmp36_, &parsed_value);
						if (!_tmp37_) {
						...
						_tmp41_ = range_token;
						_tmp42_ = rygel_http_time_seek_parse_time (_tmp41_, &parsed_value);
						if (!_tmp42_) {
							const gchar* _tmp43_ = NULL;
							const gchar* _tmp44_ = NULL;
							GError* _tmp45_ = NULL;
							_tmp43_ = _ ("Invalid Range '%s'");
							_tmp44_ = range;
							_tmp45_ = g_error_new (RYGEL_HTTP_SEEK_ERROR, RYGEL_HTTP_SEEK_ERROR_INVALID_RANGE, _tmp43_, _tmp44_);
		...
		if (_tmp49_ > _tmp50_) {
			...
			GError* _tmp53_ = NULL;
			_tmp51_ = _ ("Invalid Range '%s'");
			_tmp52_ = range;
			_tmp53_ = g_error_new (RYGEL_HTTP_SEEK_ERROR, RYGEL_HTTP_SEEK_ERROR_INVALID_RANGE, _tmp51_, _tmp52_);
	...
	_tmp54_ = request;
	_tmp55_ = ((RygelHTTPRequest*) _tmp54_)->msg;
	_tmp56_ = start;
	_tmp57_ = stop;
	_tmp58_ = duration;
	self = (RygelHTTPTimeSeek*) rygel_http_seek_construct (object_type, _tmp55_, _tmp56_, _tmp57_ - 1, (gint64) G_TIME_SPAN_MILLISECOND, _tmp58_, &_inner_error_);
		...
		if (_tmp7_) {
			...
			if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp16_, RYGEL_TYPE_HTTP_TRANSCODE_HANDLER)) {
				...
				if (_tmp18_) {
					...
					_tmp23_ = request;
					_tmp24_ = ((RygelHTTPRequest*) _tmp23_)->object;
					_tmp25_ = rygel_media_item_is_live_stream (G_TYPE_CHECK_INSTANCE_TYPE (_tmp24_, RYGEL_TYPE_MEDIA_ITEM) ? ((RygelMediaItem*) _tmp24_) : NULL);
					_tmp17_ = _tmp25_;
				} else {
					_tmp17_ = FALSE;
				}

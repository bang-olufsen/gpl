/* rygel-http-server.c generated by valac 0.24.0, the Vala compiler
...
static void __lambda11_ (RygelHTTPServer* self, const gchar* name, const gchar* value);
static void ___lambda11__soup_message_headers_foreach_func (const gchar* name, const gchar* value, gpointer self);
...
static void ___lambda11__soup_message_headers_foreach_func (const gchar* name, const gchar* value, gpointer self) {
	__lambda11_ ((RygelHTTPServer*) self, name, value);
}
...
static void rygel_http_server_server_handler (RygelHTTPServer* self, SoupServer* server, SoupMessage* msg, const gchar* server_path, GHashTable* query, SoupClientContext* soup_client) {
	...
	soup_message_headers_foreach (_tmp14_, ___lambda11__soup_message_headers_foreach_func, self);
	_tmp15_ = server;
	_tmp16_ = msg;
...
static void rygel_http_server_on_got_headers (RygelHTTPServer* self, SoupMessage* msg) {
	...
	if (_tmp0_) {
		...
		RygelHTTPPost* _tmp20_ = NULL;
		RygelHTTPPost* _tmp21_ = NULL;
		_tmp12_ = msg;
		_tmp13_ = soup_message_get_uri (_tmp12_);
		_tmp14_ = soup_uri_to_string (_tmp13_, FALSE);
		_tmp15_ = _tmp14_;
		g_debug ("rygel-http-server.vala:185: HTTP POST request for URI '%s'", _tmp15_);
		_g_free0 (_tmp15_);
		_tmp16_ = self->context;
		_tmp17_ = gupnp_context_get_server (_tmp16_);
		_tmp18_ = _tmp17_;
		_tmp19_ = msg;
		_tmp20_ = rygel_http_post_new (self, _tmp18_, _tmp19_);
		_tmp21_ = _tmp20_;
		rygel_http_server_queue_request (self, (RygelHTTPRequest*) _tmp21_);

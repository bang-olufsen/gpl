/* rygel-music-item.c generated by valac 0.24.0, the Vala compiler
...
static GUPnPDIDLLiteObject* rygel_music_item_real_serialize (RygelMediaObject* base, RygelSerializer* serializer, RygelHTTPServer* http_server, GError** error) {
	...
	GUPnPDIDLLiteObject* _tmp23_ = NULL;
	...
	if (_tmp3_) {
		...
		const gchar* _tmp9_ = NULL;
		_tmp6_ = didl_item;
		_tmp7_ = gupnp_didl_lite_object_add_artist (_tmp6_);
		contributor = _tmp7_;
		_tmp8_ = contributor;
		_tmp9_ = self->priv->_artist;
		gupnp_didl_lite_contributor_set_name (_tmp8_, _tmp9_);
		_g_object_unref0 (contributor);
	}
	_tmp10_ = self->priv->_track_number;
	if (_tmp10_ >= 0) {
		GUPnPDIDLLiteObject* _tmp11_ = NULL;
		gint _tmp12_ = 0;
		_tmp11_ = didl_item;
		_tmp12_ = self->priv->_track_number;
		gupnp_didl_lite_object_set_track_number (_tmp11_, _tmp12_);
	}
	_tmp14_ = self->priv->_album;
	if (_tmp14_ != NULL) {
	...
	if (_tmp13_) {
		...
		gupnp_didl_lite_object_set_album (_tmp16_, _tmp17_);
	}
	_tmp19_ = self->priv->_genre;
	if (_tmp19_ != NULL) {
		const gchar* _tmp20_ = NULL;
		_tmp20_ = self->priv->_genre;
	...
	if (_tmp18_) {
		...
		gupnp_didl_lite_object_set_genre (_tmp21_, _tmp22_);
	}
	_tmp23_ = didl_item;
	_tmp24_ = gupnp_didl_lite_object_get_album_art (_tmp23_);
	_tmp25_ = _tmp24_;
	if (_tmp25_ != NULL) {
		gchar* _tmp26_ = NULL;
		GRegex* _tmp27_ = NULL;
		GUPnPDIDLLiteObject* _tmp28_ = NULL;
		const gchar* _tmp29_ = NULL;
		const gchar* _tmp30_ = NULL;
		RygelHTTPServer* _tmp31_ = NULL;
		GUPnPContext* _tmp32_ = NULL;
		const gchar* _tmp33_ = NULL;
		const gchar* _tmp34_ = NULL;
		gchar* _tmp35_ = NULL;
		GUPnPDIDLLiteObject* _tmp36_ = NULL;
		_tmp27_ = rygel_media_item_address_regex;
		_tmp28_ = didl_item;
		_tmp29_ = gupnp_didl_lite_object_get_album_art (_tmp28_);
		_tmp30_ = _tmp29_;
		_tmp31_ = http_server;
		_tmp32_ = _tmp31_->context;
		_tmp33_ = gssdp_client_get_host_ip ((GSSDPClient*) _tmp32_);
		_tmp34_ = _tmp33_;
		_tmp35_ = g_regex_replace_literal (_tmp27_, _tmp30_, (gssize) (-1), 0, _tmp34_, 0, &_inner_error_);
		_tmp26_ = _tmp35_;
		if (_inner_error_ != NULL) {
			g_propagate_error (error, _inner_error_);
		...
		_tmp36_ = didl_item;
		gupnp_didl_lite_object_set_album_art (_tmp36_, _tmp26_);
		_g_free0 (_tmp26_);
	}
	result = didl_item;
	return result;

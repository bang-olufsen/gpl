/* rygel-panasonic-hacks.c generated by valac 0.24.0, the Vala compiler
	...
	}
	{
		...
		while (TRUE) {
			...
			thumbnail = (RygelThumbnail*) _tmp16_;
			{
				...
				((RygelIconInfo*) _tmp22_)->mime_type = _tmp23_;
				_tmp25_ = rygel_panasonic_hacks_dlna_regex;
				_tmp26_ = thumbnail;
				_tmp27_ = _tmp26_->dlna_profile;
				_tmp28_ = g_regex_replace_literal (_tmp25_, _tmp27_, (gssize) (-1), 0, "JPEG", 0, &_inner_error_);
				_tmp24_ = _tmp28_;
				if (_inner_error_ != NULL) {
					_g_free0 (_tmp17_);
					if (_inner_error_->domain == G_REGEX_ERROR) {
...
static void rygel_panasonic_hacks_class_init (RygelPanasonicHacksClass * klass) {
	...
	G_OBJECT_CLASS (klass)->finalize = rygel_panasonic_hacks_finalize;
	{
		...
		rygel_panasonic_hacks_mime_regex = _tmp2_;
		_tmp4_ = g_regex_new ("PNG", 0, 0, &_inner_error_);
		_tmp3_ = _tmp4_;
		if (_inner_error_ != NULL) {
		...
		rygel_panasonic_hacks_dlna_regex = _tmp5_;

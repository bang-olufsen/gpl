/* rygel-http-get.c generated by valac 0.24.0, the Vala compiler
...
struct _RygelHttpGetHandleData {
	...
	const gchar* _tmp38_;
	gboolean _tmp39_;
	RygelHTTPItemURI* _tmp40_;
	const gchar* _tmp41_;
	const gchar* _tmp42_;
	GCancellable* _tmp43_;
	GCancellable* _tmp44_;
	RygelHTTPPlaylistHandler* _tmp45_;
	RygelHTTPGetHandler* _tmp46_;
	GCancellable* _tmp47_;
	GCancellable* _tmp48_;
	RygelHTTPIdentityHandler* _tmp49_;
...
struct _RygelHttpGetFindItemData {
	...
	RygelHTTPItemURI* _tmp60_;
	gint _tmp61_;
	gint _tmp62_;
	gpointer _tmp63_;
	RygelMediaObject* _tmp64_;
	const gchar* _tmp65_;
	const gchar* _tmp66_;
	GError* _tmp67_;
	GError * _inner_error_;
...
struct _RygelHttpGetHandleItemRequestData {
	...
	RygelHTTPTimeSeek* _tmp16_;
	RygelHTTPTimeSeek* _tmp17_;
	gboolean _tmp18_;
	gboolean _tmp19_;
	gboolean _tmp20_;
	RygelHTTPByteSeek* _tmp21_;
	...
	GError* _tmp28_;
	GError* _tmp29_;
	RygelHTTPGetHandler* _tmp30_;
	SoupMessage* _tmp31_;
	SoupMessageHeaders* _tmp32_;
	const gchar* _tmp33_;
	SoupMessage* _tmp34_;
	SoupMessage* _tmp35_;
	RygelHTTPGetHandler* _tmp36_;
	gboolean _tmp37_;
	SoupMessage* _tmp38_;
	...
	RygelHTTPGetHandler* _tmp56_;
	RygelHTTPResponse* _tmp57_;
	RygelHTTPResponse* _tmp58_;
	GError * _inner_error_;
};
...
static void __lambda17_ (RygelHTTPGet* self, const gchar* name, const gchar* value);
static void ___lambda17__soup_message_headers_foreach_func (const gchar* name, const gchar* value, gpointer self);
...
static gboolean rygel_http_get_real_handle_co (RygelHttpGetHandleData* _data_) {
	...
	if (_data_->_tmp5_) {
		...
		_data_->_tmp16_ = NULL;
		_data_->_tmp16_ = _data_->header;
		if (_data_->_tmp16_ != NULL) {
			_data_->_tmp17_ = NULL;
			_data_->_tmp17_ = _data_->header;
			_data_->_tmp15_ = g_strcmp0 (_data_->_tmp17_, "1") != 0;
		} else {
			_data_->_tmp15_ = FALSE;
		}
		_data_->_tmp4_ = _data_->_tmp15_;
	}
	if (_data_->_tmp4_) {
		_data_->_tmp18_ = NULL;
		_data_->_tmp18_ = _ ("Invalid Request");
		_data_->_tmp19_ = NULL;
		_data_->_tmp19_ = g_error_new_literal (RYGEL_HTTP_REQUEST_ERROR, RYGEL_HTTP_REQUEST_ERROR_BAD_REQUEST, _data_->_tmp18_);
	...
	_data_->_tmp21_ = NULL;
	_data_->_tmp21_ = rygel_http_item_uri_get_transcode_target (_data_->_tmp20_);
	_data_->_tmp22_ = NULL;
	_data_->_tmp22_ = _data_->_tmp21_;
	if (_data_->_tmp22_ != NULL) {
		_data_->_tmp23_ = NULL;
		_data_->_tmp23_ = ((RygelHTTPRequest*) _data_->self)->http_server;
		_data_->_tmp24_ = NULL;
		_data_->_tmp24_ = ((RygelHTTPRequest*) _data_->self)->uri;
		_data_->_tmp25_ = NULL;
		_data_->_tmp25_ = rygel_http_item_uri_get_transcode_target (_data_->_tmp24_);
		_data_->_tmp26_ = NULL;
		_data_->_tmp26_ = _data_->_tmp25_;
		_data_->_tmp27_ = NULL;
		_data_->_tmp27_ = rygel_transcode_manager_get_transcoder ((RygelTranscodeManager*) _data_->_tmp23_, _data_->_tmp26_, &_data_->_inner_error_);
		_data_->transcoder = _data_->_tmp27_;
		...
		_data_->_tmp28_ = NULL;
		_data_->_tmp28_ = _data_->transcoder;
		_data_->_tmp29_ = NULL;
		_data_->_tmp29_ = rygel_state_machine_get_cancellable ((RygelStateMachine*) _data_->self);
		_data_->_tmp30_ = NULL;
		_data_->_tmp30_ = _data_->_tmp29_;
		_data_->_tmp31_ = NULL;
		_data_->_tmp31_ = rygel_http_transcode_handler_new (_data_->_tmp28_, _data_->_tmp30_);
		_g_object_unref0 (_data_->self->handler);
		_data_->self->handler = (RygelHTTPGetHandler*) _data_->_tmp31_;
		_g_object_unref0 (_data_->transcoder);
	}
	_data_->_tmp33_ = NULL;
	_data_->_tmp33_ = ((RygelHTTPRequest*) _data_->self)->uri;
	_data_->_tmp34_ = NULL;
	_data_->_tmp34_ = rygel_http_item_uri_get_playlist_format (_data_->_tmp33_);
	_data_->_tmp35_ = NULL;
	...
	if (_data_->_tmp35_ != NULL) {
		...
		_data_->_tmp39_ = rygel_http_playlist_handler_is_supported (_data_->_tmp38_);
		_data_->_tmp32_ = _data_->_tmp39_;
	} else {
		_data_->_tmp32_ = FALSE;
	}
	if (_data_->_tmp32_) {
		_data_->_tmp40_ = NULL;
		_data_->_tmp40_ = ((RygelHTTPRequest*) _data_->self)->uri;
		_data_->_tmp41_ = NULL;
		_data_->_tmp41_ = rygel_http_item_uri_get_playlist_format (_data_->_tmp40_);
		_data_->_tmp42_ = NULL;
		_data_->_tmp42_ = _data_->_tmp41_;
		_data_->_tmp43_ = NULL;
		_data_->_tmp43_ = rygel_state_machine_get_cancellable ((RygelStateMachine*) _data_->self);
		_data_->_tmp44_ = NULL;
		_data_->_tmp44_ = _data_->_tmp43_;
		_data_->_tmp45_ = NULL;
		_data_->_tmp45_ = rygel_http_playlist_handler_new (_data_->_tmp42_, _data_->_tmp44_);
		_g_object_unref0 (_data_->self->handler);
		_data_->self->handler = (RygelHTTPGetHandler*) _data_->_tmp45_;
	}
	_data_->_tmp46_ = NULL;
	_data_->_tmp46_ = _data_->self->handler;
	if (_data_->_tmp46_ == NULL) {
		...
		_data_->_tmp49_ = NULL;
		_data_->_tmp49_ = rygel_http_identity_handler_new (_data_->_tmp48_);
		_g_object_unref0 (_data_->self->handler);
...
static gboolean rygel_http_get_real_find_item_co (RygelHttpGetFindItemData* _data_) {
	...
	if (_data_->_tmp44_) {
		_data_->_tmp49_ = NULL;
		_data_->_tmp49_ = ((RygelHTTPRequest*) _data_->self)->object;
		_data_->_tmp50_ = NULL;
		_data_->_tmp50_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_data_->_tmp49_, RYGEL_TYPE_VIDEO_ITEM) ? ((RygelVideoItem*) _data_->_tmp49_) : NULL);
		_data_->video = _data_->_tmp50_;
		_data_->_tmp51_ = NULL;
		...
		_data_->_tmp54_ = NULL;
		_data_->_tmp54_ = _data_->video;
		_data_->_tmp55_ = NULL;
		_data_->_tmp55_ = _data_->_tmp54_->subtitles;
		_data_->_tmp56_ = 0;
		_data_->_tmp56_ = gee_abstract_collection_get_size ((GeeCollection*) _data_->_tmp55_);
		_data_->_tmp57_ = 0;
		_data_->_tmp57_ = _data_->_tmp56_;
		if (_data_->_tmp53_ < _data_->_tmp57_) {
			_data_->_tmp58_ = NULL;
			_data_->_tmp58_ = _data_->video;
			_data_->_tmp59_ = NULL;
			_data_->_tmp59_ = _data_->_tmp58_->subtitles;
			_data_->_tmp60_ = NULL;
			_data_->_tmp60_ = ((RygelHTTPRequest*) _data_->self)->uri;
			_data_->_tmp61_ = 0;
			_data_->_tmp61_ = rygel_http_item_uri_get_subtitle_index (_data_->_tmp60_);
			_data_->_tmp62_ = 0;
			_data_->_tmp62_ = _data_->_tmp61_;
			_data_->_tmp63_ = NULL;
			_data_->_tmp63_ = gee_abstract_list_get ((GeeAbstractList*) _data_->_tmp59_, _data_->_tmp62_);
			_rygel_subtitle_unref0 (_data_->self->subtitle);
			_data_->self->subtitle = (RygelSubtitle*) _data_->_tmp63_;
		...
		_data_->_tmp64_ = NULL;
		_data_->_tmp64_ = ((RygelHTTPRequest*) _data_->self)->object;
		_data_->_tmp65_ = NULL;
		_data_->_tmp65_ = rygel_media_object_get_id (_data_->_tmp64_);
		_data_->_tmp66_ = NULL;
		_data_->_tmp66_ = _data_->_tmp65_;
		_data_->_tmp67_ = NULL;
		_data_->_tmp67_ = g_error_new (RYGEL_HTTP_REQUEST_ERROR, RYGEL_HTTP_REQUEST_ERROR_NOT_FOUND, "No subtitles available for item '%s", _data_->_tmp66_);
...
static void __lambda17_ (RygelHTTPGet* self, const gchar* name, const gchar* value) {
	...
	_tmp0_ = name;
	_tmp1_ = value;
	g_debug ("rygel-http-get.vala:192: %s : %s", _tmp0_, _tmp1_);
}


static void ___lambda17__soup_message_headers_foreach_func (const gchar* name, const gchar* value, gpointer self) {
	__lambda17_ ((RygelHTTPGet*) self, name, value);
}
...
static gboolean rygel_http_get_handle_item_request_co (RygelHttpGetHandleItemRequestData* _data_) {
	...
	if (_data_->_tmp5_) {
		...
		_data_->_tmp9_ = FALSE;
		_data_->_tmp9_ = _data_->requested_byte_seek;
		if (_data_->_tmp9_) {
			_data_->_tmp10_ = FALSE;
			_data_->_tmp10_ = _data_->need_byte_seek;
	...
	if (_data_->_tmp4_) {
		_data_->_tmp11_ = NULL;
		_data_->_tmp11_ = g_error_new_literal (RYGEL_HTTP_REQUEST_ERROR, RYGEL_HTTP_REQUEST_ERROR_UNACCEPTABLE, "Invalid seek request");
	...
	}
	{
		...
		if (_data_->_tmp13_) {
			...
			_data_->_tmp14_ = _data_->requested_time_seek;
		...
		if (_data_->_tmp12_) {
			_data_->_tmp16_ = NULL;
			_data_->_tmp16_ = rygel_http_time_seek_new (_data_->self, &_data_->_inner_error_);
			_data_->_tmp15_ = _data_->_tmp16_;
			if (_data_->_inner_error_ != NULL) {
				if (_data_->_inner_error_->domain == RYGEL_HTTP_SEEK_ERROR) {
					goto __catch31_rygel_http_seek_error;
				}
			...
			_data_->self->seek = (RygelHTTPSeek*) _data_->_tmp17_;
			_g_object_unref0 (_data_->_tmp15_);
		} else {
			_data_->_tmp19_ = FALSE;
			_data_->_tmp19_ = _data_->need_byte_seek;
			if (_data_->_tmp19_) {
				_data_->_tmp20_ = FALSE;
				_data_->_tmp20_ = _data_->requested_byte_seek;
			...
			if (_data_->_tmp18_) {
				_data_->_tmp22_ = NULL;
				_data_->_tmp22_ = rygel_http_byte_seek_new (_data_->self, &_data_->_inner_error_);
				...
				_data_->_tmp21_ = NULL;
				_g_object_unref0 (_data_->self->seek);
				_data_->self->seek = (RygelHTTPSeek*) _data_->_tmp23_;
				_g_object_unref0 (_data_->_tmp21_);
			}
		}
	}
	goto __finally31;
	__catch31_rygel_http_seek_error:
	{
		...
		if (g_error_matches (_data_->_tmp26_, RYGEL_HTTP_SEEK_ERROR, RYGEL_HTTP_SEEK_ERROR_INVALID_RANGE)) {
			rygel_http_request_end ((RygelHTTPRequest*) _data_->self, (guint) SOUP_STATUS_BAD_REQUEST);
		} else {
			_data_->_tmp27_ = NULL;
			_data_->_tmp27_ = _data_->_error_;
			if (g_error_matches (_data_->_tmp27_, RYGEL_HTTP_SEEK_ERROR, RYGEL_HTTP_SEEK_ERROR_OUT_OF_RANGE)) {
	...
	_data_->_tmp30_ = NULL;
	_data_->_tmp30_ = _data_->self->handler;
	rygel_http_get_handler_add_response_headers (_data_->_tmp30_, _data_->self, &_data_->_inner_error_);
	if (_data_->_inner_error_ != NULL) {
		g_simple_async_result_set_from_error (_data_->_async_result, _data_->_inner_error_);
		g_error_free (_data_->_inner_error_);
		if (_data_->_state_ == 0) {
	...
	_data_->_tmp31_ = NULL;
	_data_->_tmp31_ = ((RygelHTTPRequest*) _data_->self)->msg;
	_data_->_tmp32_ = NULL;
	_data_->_tmp32_ = _data_->_tmp31_->request_headers;
	_data_->_tmp33_ = NULL;
	_data_->_tmp33_ = soup_message_headers_get_one (_data_->_tmp32_, "Range");
	if (_data_->_tmp33_ != NULL) {
		_data_->_tmp34_ = NULL;
		_data_->_tmp34_ = ((RygelHTTPRequest*) _data_->self)->msg;
		soup_message_set_status (_data_->_tmp34_, (guint) SOUP_STATUS_PARTIAL_CONTENT);
	} else {
		_data_->_tmp35_ = NULL;
		_data_->_tmp35_ = ((RygelHTTPRequest*) _data_->self)->msg;
		soup_message_set_status (_data_->_tmp35_, (guint) SOUP_STATUS_OK);
	}
	_data_->_tmp36_ = NULL;
	_data_->_tmp36_ = _data_->self->handler;
	_data_->_tmp37_ = FALSE;
	_data_->_tmp37_ = rygel_http_get_handler_knows_size (_data_->_tmp36_, _data_->self);
	if (_data_->_tmp37_) {
		_data_->_tmp38_ = NULL;
		_data_->_tmp38_ = ((RygelHTTPRequest*) _data_->self)->msg;
		_data_->_tmp39_ = NULL;
		_data_->_tmp39_ = _data_->_tmp38_->response_headers;
		soup_message_headers_set_encoding (_data_->_tmp39_, SOUP_ENCODING_CONTENT_LENGTH);
	} else {
		_data_->_tmp40_ = NULL;
		_data_->_tmp40_ = ((RygelHTTPRequest*) _data_->self)->msg;
		_data_->_tmp41_ = NULL;
		_data_->_tmp41_ = _data_->_tmp40_->response_headers;
		soup_message_headers_set_encoding (_data_->_tmp41_, SOUP_ENCODING_EOF);
	}
	_data_->_tmp42_ = NULL;
	_data_->_tmp42_ = ((RygelHTTPRequest*) _data_->self)->msg;
	_data_->_tmp43_ = 0;
	_data_->_tmp43_ = soup_message_get_http_version (_data_->_tmp42_);
	if (_data_->_tmp43_ == SOUP_HTTP_1_0) {
		_data_->_tmp44_ = NULL;
		_data_->_tmp44_ = ((RygelHTTPRequest*) _data_->self)->msg;
		soup_message_set_http_version (_data_->_tmp44_, SOUP_HTTP_1_1);
		_data_->_tmp45_ = NULL;
		_data_->_tmp45_ = ((RygelHTTPRequest*) _data_->self)->msg;
		_data_->_tmp46_ = NULL;
		_data_->_tmp46_ = _data_->_tmp45_->response_headers;
		soup_message_headers_append (_data_->_tmp46_, "Connection", "close");
	}
	g_debug ("rygel-http-get.vala:190: Following HTTP headers appended to response:");
	_data_->_tmp47_ = NULL;
	_data_->_tmp47_ = ((RygelHTTPRequest*) _data_->self)->msg;
	_data_->_tmp48_ = NULL;
	_data_->_tmp48_ = _data_->_tmp47_->response_headers;
	soup_message_headers_foreach (_data_->_tmp48_, ___lambda17__soup_message_headers_foreach_func, _data_->self);
	_data_->_tmp49_ = NULL;
	_data_->_tmp49_ = ((RygelHTTPRequest*) _data_->self)->msg;
	_data_->_tmp50_ = NULL;
	g_object_get (_data_->_tmp49_, "method", &_data_->_tmp50_, NULL);
	_data_->_tmp51_ = NULL;
	_data_->_tmp51_ = _data_->_tmp50_;
	_data_->_tmp52_ = NULL;
	_data_->_tmp52_ = _data_->_tmp51_;
	_data_->_tmp53_ = FALSE;
	_data_->_tmp53_ = g_strcmp0 (_data_->_tmp52_, "HEAD") == 0;
	_g_free0 (_data_->_tmp52_);
	if (_data_->_tmp53_) {
		_data_->_tmp54_ = NULL;
		_data_->_tmp54_ = ((RygelHTTPRequest*) _data_->self)->server;
		_data_->_tmp55_ = NULL;
		_data_->_tmp55_ = ((RygelHTTPRequest*) _data_->self)->msg;
		soup_server_unpause_message (_data_->_tmp54_, _data_->_tmp55_);
		if (_data_->_state_ == 0) {
			g_simple_async_result_complete_in_idle (_data_->_async_result);
		} else {
			g_simple_async_result_complete (_data_->_async_result);
	...
	_data_->_tmp56_ = NULL;
	_data_->_tmp56_ = _data_->self->handler;
	_data_->_tmp57_ = NULL;
	_data_->_tmp57_ = rygel_http_get_handler_render_body (_data_->_tmp56_, _data_->self, &_data_->_inner_error_);
	_data_->response = _data_->_tmp57_;
	if (_data_->_inner_error_ != NULL) {
		g_simple_async_result_set_from_error (_data_->_async_result, _data_->_inner_error_);
		g_error_free (_data_->_inner_error_);
		if (_data_->_state_ == 0) {
	...
	_data_->_state_ = 1;
	rygel_state_machine_run ((RygelStateMachine*) _data_->_tmp58_, rygel_http_get_handle_item_request_ready, _data_);
	return FALSE;
	_state_1:
	rygel_state_machine_run_finish ((RygelStateMachine*) _data_->_tmp58_, _data_->_res_);
...
static void rygel_http_get_ensure_correct_mode (RygelHTTPGet* self, GError** error) {
	...
	if (_tmp7_ == ((0 != _tmp6_label0) ? _tmp6_label0 : (_tmp6_label0 = g_quark_from_static_string ("Streaming")))) {
			...
			default:
			{
				...
				if (!G_TYPE_CHECK_INSTANCE_TYPE (_tmp9_, RYGEL_TYPE_HTTP_PLAYLIST_HANDLER)) {
					...
					if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp11_, RYGEL_TYPE_HTTP_TRANSCODE_HANDLER)) {
						...
						if (_tmp13_) {
							RygelThumbnail* _tmp17_ = NULL;
							_tmp17_ = self->thumbnail;
		...
		switch (0) {
			default:
			{
				...
				RygelHTTPGetHandler* _tmp20_ = NULL;
				_tmp20_ = self->handler;
				if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp20_, RYGEL_TYPE_HTTP_IDENTITY_HANDLER)) {
					gboolean _tmp21_ = FALSE;
					gboolean _tmp22_ = FALSE;
					RygelMediaObject* _tmp23_ = NULL;
					gboolean _tmp24_ = FALSE;
					_tmp23_ = ((RygelHTTPRequest*) self)->object;
					...
					if (!_tmp24_) {
						...
						_tmp25_ = ((RygelHTTPRequest*) self)->object;
						_tmp26_ = rygel_media_item_streamable (G_TYPE_CHECK_INSTANCE_TYPE (_tmp25_, RYGEL_TYPE_MEDIA_ITEM) ? ((RygelMediaItem*) _tmp25_) : NULL);
						_tmp22_ = !_tmp26_;
					} else {
						_tmp22_ = FALSE;
					}
					if (_tmp22_) {
						...
						_tmp28_ = self->subtitle;
						if (_tmp28_ != NULL) {
							_tmp27_ = TRUE;
						} else {
							RygelThumbnail* _tmp29_ = NULL;
							_tmp29_ = self->thumbnail;
				...
				if (_tmp19_) {
					...
					RygelHTTPGetHandler* _tmp30_ = NULL;
					_tmp30_ = self->handler;
					_tmp18_ = G_TYPE_CHECK_INSTANCE_TYPE (_tmp30_, RYGEL_TYPE_HTTP_PLAYLIST_HANDLER);
				}
				correct = _tmp18_;
				break;
			}
	...
	if (!_tmp31_) {
		...
		GError* _tmp36_ = NULL;
		_tmp32_ = mode;
		_tmp33_ = ((RygelHTTPRequest*) self)->object;
		_tmp34_ = rygel_media_object_get_id (_tmp33_);
		_tmp35_ = _tmp34_;
		_tmp36_ = g_error_new (RYGEL_HTTP_REQUEST_ERROR, RYGEL_HTTP_REQUEST_ERROR_UNACCEPTABLE, "%s mode not supported for '%s'", _tmp32_, _tmp35_);

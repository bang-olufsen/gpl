/* rygel-samsung-tv-hacks.c generated by valac 0.24.0, the Vala compiler
...
static void rygel_samsung_tv_hacks_real_apply (RygelClientHacks* base, RygelMediaObject* object) {
	...
	if (g_strcmp0 (_tmp5_, "video/x-matroska") == 0) {
		...
		_tmp9_ = _tmp8_;
		if (g_strcmp0 (_tmp9_, "video/mp2t") == 0) {
			RygelMediaItem* _tmp10_ = NULL;
			_tmp10_ = item;
			rygel_media_item_set_mime_type (_tmp10_, "video/vnd.dlna.mpeg-tts");
		} else {
			...
			_tmp13_ = _tmp12_;
			if (g_strcmp0 (_tmp13_, "video/quicktime") == 0) {
				RygelMediaItem* _tmp14_ = NULL;
				_tmp14_ = item;
				rygel_media_item_set_mime_type (_tmp14_, "video/mp4");
			}
		}
	}

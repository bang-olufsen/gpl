/* rygel-http-get-handler.c generated by valac 0.24.0, the Vala compiler
...
static void rygel_http_get_handler_real_add_response_headers (RygelHTTPGetHandler* self, RygelHTTPGet* request, GError** error) {
	...
	_tmp32_ = soup_message_headers_get_one (_tmp31_, "getCaptionInfo.sec");
	if (_tmp32_ != NULL) {
		RygelHTTPGet* _tmp33_ = NULL;
		RygelMediaObject* _tmp34_ = NULL;
		_tmp33_ = request;
		_tmp34_ = ((RygelHTTPRequest*) _tmp33_)->object;
		_tmp28_ = G_TYPE_CHECK_INSTANCE_TYPE (_tmp34_, RYGEL_TYPE_VIDEO_ITEM);
	} else {
		_tmp28_ = FALSE;
	}
	if (_tmp28_) {
		RygelHTTPGet* _tmp35_ = NULL;
		RygelMediaObject* _tmp36_ = NULL;
		GeeArrayList* _tmp37_ = NULL;
		gint _tmp38_ = 0;
		gint _tmp39_ = 0;
		_tmp35_ = request;
		_tmp36_ = ((RygelHTTPRequest*) _tmp35_)->object;
	...
	if (_tmp27_) {
		...
		RygelHTTPServer* _tmp41_ = NULL;
		RygelHTTPGet* _tmp42_ = NULL;
		RygelMediaObject* _tmp43_ = NULL;
		gchar* _tmp44_ = NULL;
		RygelHTTPGet* _tmp45_ = NULL;
		SoupMessage* _tmp46_ = NULL;
		SoupMessageHeaders* _tmp47_ = NULL;
		const gchar* _tmp48_ = NULL;
		_tmp40_ = request;
		_tmp41_ = ((RygelHTTPRequest*) _tmp40_)->http_server;
		_tmp42_ = request;
		_tmp43_ = ((RygelHTTPRequest*) _tmp42_)->object;
		_tmp44_ = rygel_transcode_manager_create_uri_for_item ((RygelTranscodeManager*) _tmp41_, G_TYPE_CHECK_INSTANCE_TYPE (_tmp43_, RYGEL_TYPE_MEDIA_ITEM) ? ((RygelMediaItem*) _tmp43_) : NULL, -1, 0, NULL, NULL);
		caption_uri = _tmp44_;
		_tmp45_ = request;
		_tmp46_ = ((RygelHTTPRequest*) _tmp45_)->msg;
		_tmp47_ = _tmp46_->response_headers;
		_tmp48_ = caption_uri;
		soup_message_headers_append (_tmp47_, "CaptionInfo.sec", _tmp48_);
		_g_free0 (caption_uri);
	}
	_tmp49_ = request;
	_tmp50_ = ((RygelHTTPRequest*) _tmp49_)->msg;
	_tmp51_ = _tmp50_->response_headers;
	soup_message_headers_append (_tmp51_, "Connection", "close");
	_g_object_unref0 (didl_item);
	_g_object_unref0 (didl_writer);
	_g_free0 (mode);
}

/* rygel-item-updater.c generated by valac 0.24.0, the Vala compiler
				...
				if (_tmp12_) {
					...
					switch (_tmp13_) {
						...
						case ',':
						{
							...
							_tmp18_ = list;
							_tmp19_ = value;
							_tmp20_ = rygel_item_updater_unescape (_tmp19_);
							_tmp21_ = _tmp20_;
							gee_abstract_collection_add ((GeeAbstractCollection*) _tmp18_, _tmp21_);
							_g_free0 (_tmp21_);
							_tmp22_ = token_start;
							_tmp23_ = token_length;
							token_start = _tmp22_ + (_tmp23_ + 1);
							token_length = 0;
							increase = FALSE;
							_g_free0 (value);
							break;

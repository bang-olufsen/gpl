/* rygel-lg-tv-hacks.c generated by valac 0.24.0, the Vala compiler
...
enum  {
	RYGEL_LGTV_HACKS_DUMMY_PROPERTY
};
...
static void rygel_lgtv_hacks_real_apply (RygelClientHacks* base, RygelMediaObject* object);
...
RygelLGTVHacks* rygel_lgtv_hacks_construct (GType object_type, SoupMessage* message, GError** error) {
	...
	_tmp0_ = message;
	self = (RygelLGTVHacks*) rygel_client_hacks_construct (object_type, RYGEL_LGTV_HACKS_AGENT, _tmp0_, &_inner_error_);
...
static void rygel_lgtv_hacks_real_apply (RygelClientHacks* base, RygelMediaObject* object) {
	...
	_tmp6_ = _tmp5_;
	if (g_strcmp0 (_tmp6_, "audio/x-vorbis+ogg") == 0) {
		_tmp3_ = TRUE;
	} else {
		...
		_tmp9_ = _tmp8_;
		_tmp3_ = g_strcmp0 (_tmp9_, "audio/x-flac+ogg") == 0;
	}
	if (_tmp3_) {
		RygelMediaItem* _tmp10_ = NULL;
		_tmp10_ = item;
		rygel_media_item_set_mime_type (_tmp10_, "application/ogg");
	}
	_g_object_unref0 (item);
}


static void rygel_lgtv_hacks_class_init (RygelLGTVHacksClass * klass) {
	rygel_lgtv_hacks_parent_class = g_type_class_peek_parent (klass);
	RYGEL_CLIENT_HACKS_CLASS (klass)->apply = rygel_lgtv_hacks_real_apply;
}


static void rygel_lgtv_hacks_instance_init (RygelLGTVHacks * self) {
}


GType rygel_lgtv_hacks_get_type (void) {
	static volatile gsize rygel_lgtv_hacks_type_id__volatile = 0;
	if (g_once_init_enter (&rygel_lgtv_hacks_type_id__volatile)) {
		...
		g_once_init_leave (&rygel_lgtv_hacks_type_id__volatile, rygel_lgtv_hacks_type_id);
	}
	return rygel_lgtv_hacks_type_id__volatile;
}

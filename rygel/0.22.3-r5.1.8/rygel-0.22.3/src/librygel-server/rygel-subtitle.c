/* rygel-subtitle.c generated by valac 0.24.0, the Vala compiler
...
void rygel_subtitle_add_didl_node (RygelSubtitle* self, GUPnPDIDLLiteItem* didl_item) {
	...
	root_node = _tmp5_;
	_tmp6_ = root_node;
	_tmp7_ = xmlNewNs (_tmp6_, (xmlChar*) "http://www.sec.co.kr/", (xmlChar*) "sec");
	sec_ns = _tmp7_;
	_tmp8_ = sec_ns;
	if (_tmp8_ == NULL) {
		xmlNs* it = NULL;
	...
	_tmp18_ = sec_ns;
	_tmp19_ = self->uri;
	_tmp20_ = xmlNewChild (_tmp17_, _tmp18_, (xmlChar*) "CaptionInfoEx", (xmlChar*) _tmp19_);
	sec_node = _tmp20_;
	_tmp21_ = sec_ns;
	_tmp22_ = self->caption_type;
	xmlNewNsProp (sec_node, _tmp21_, (xmlChar*) "type", (xmlChar*) _tmp22_);
}

/* rygel-media-container.c generated by valac 0.24.0, the Vala compiler
...
void rygel_media_container_updated (RygelMediaContainer* self, RygelMediaObject* object, RygelObjectEventType event_type, gboolean sub_tree_update) {
	...
	g_signal_emit_by_name (self, "container-updated", self, _tmp0_, _tmp3_, _tmp4_);
}
...
void rygel_media_container_add_resources (RygelMediaContainer* self, RygelHTTPServer* http_server, GUPnPDIDLLiteContainer* didl_container, GError** error) {
	...
	_tmp33_ = res;
	if (_tmp33_ != NULL) {
		GUPnPDIDLLiteResource* _tmp34_ = NULL;
		GUPnPProtocolInfo* _tmp35_ = NULL;
		GUPnPProtocolInfo* _tmp36_ = NULL;
		_tmp34_ = res;
		_tmp35_ = gupnp_didl_lite_resource_get_protocol_info (_tmp34_);
		_tmp36_ = _tmp35_;
		gupnp_protocol_info_set_mime_type (_tmp36_, "audio/x-mpegurl");
	}
...
void rygel_media_container_check_search_expression (RygelMediaContainer* self, RygelSearchExpression* expression) {
	...
	if (_tmp0_) {
		...
		_tmp3_ = expression;
		_tmp4_ = _rygel_search_expression_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp3_, RYGEL_TYPE_RELATIONAL_EXPRESSION) ? ((RygelRelationalExpression*) _tmp3_) : NULL);
		relational_exp = _tmp4_;
		_tmp6_ = relational_exp;
		_tmp7_ = ((RygelSearchExpression*) _tmp6_)->op;
		if (((GUPnPSearchCriteriaOp) ((gintptr) _tmp7_)) == GUPNP_SEARCH_CRITERIA_OP_DERIVED_FROM) {
			RygelRelationalExpression* _tmp8_ = NULL;
			gconstpointer _tmp9_ = NULL;
			_tmp8_ = relational_exp;
			_tmp9_ = ((RygelSearchExpression*) _tmp8_)->operand1;
			_tmp5_ = g_strcmp0 ((const gchar*) _tmp9_, "upnp:createClass") == 0;
		} else {
			_tmp5_ = FALSE;
		}
		if (_tmp5_) {
...
static GUPnPOCMFlags rygel_media_container_real_get_ocm_flags (RygelMediaObject* base) {
	...
	if (_tmp8_) {
		...
		_tmp9_ = flags;
		flags = _tmp9_ | ((GUPNP_OCM_FLAGS_UPLOAD | GUPNP_OCM_FLAGS_UPLOAD_DESTROYABLE) | GUPNP_OCM_FLAGS_CREATE_CONTAINER);
	}
	allow_deletion = TRUE;
	{
		gboolean _tmp10_ = FALSE;
		RygelMetaConfig* _tmp11_ = NULL;
	...
	_tmp13_ = allow_deletion;
	if (_tmp13_) {
		GUPnPOCMFlags _tmp14_ = 0;
		_tmp14_ = flags;
		flags = _tmp14_ | GUPNP_OCM_FLAGS_DESTROYABLE;
	}
	if (G_TYPE_CHECK_INSTANCE_TYPE (self, RYGEL_TYPE_UPDATABLE_OBJECT)) {
		GUPnPOCMFlags _tmp15_ = 0;
		_tmp15_ = flags;
		flags = _tmp15_ | GUPNP_OCM_FLAGS_CHANGE_METADATA;
	}
	_tmp16_ = flags;
	result = _tmp16_;
	_g_object_unref0 (config);

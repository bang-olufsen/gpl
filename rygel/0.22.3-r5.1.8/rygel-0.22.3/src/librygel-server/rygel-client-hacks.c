/* rygel-client-hacks.c generated by valac 0.24.0, the Vala compiler
...
GType rygel_lgtv_hacks_get_type (void) G_GNUC_CONST;
RygelLGTVHacks* rygel_lgtv_hacks_new (SoupMessage* message, GError** error);
RygelLGTVHacks* rygel_lgtv_hacks_construct (GType object_type, SoupMessage* message, GError** error);
...
RygelClientHacks* rygel_client_hacks_create (SoupMessage* message, GError** error) {
	...
	RygelXBMCHacks* _tmp24_ = NULL;
	SoupMessage* _tmp25_ = NULL;
	RygelXBMCHacks* _tmp26_ = NULL;
	RygelXBMCHacks* _tmp27_ = NULL;
	GError * _inner_error_ = NULL;
	{
		RygelPanasonicHacks* _tmp0_ = NULL;
		SoupMessage* _tmp1_ = NULL;
		RygelPanasonicHacks* _tmp2_ = NULL;
		RygelPanasonicHacks* _tmp3_ = NULL;
		_tmp1_ = message;
	...
	{
		RygelXBoxHacks* _tmp4_ = NULL;
		SoupMessage* _tmp5_ = NULL;
		RygelXBoxHacks* _tmp6_ = NULL;
		RygelXBoxHacks* _tmp7_ = NULL;
		_tmp5_ = message;
		_tmp6_ = rygel_xbox_hacks_new (_tmp5_, &_inner_error_);
		_tmp4_ = _tmp6_;
		if (_inner_error_ != NULL) {
		...
		_tmp7_ = _tmp4_;
		_tmp4_ = NULL;
		result = (RygelClientHacks*) _tmp7_;
	...
	}
	{
		...
		RygelWMPHacks* _tmp10_ = NULL;
		RygelWMPHacks* _tmp11_ = NULL;
		_tmp9_ = message;
		_tmp10_ = rygel_wmp_hacks_new (_tmp9_, &_inner_error_);
		_tmp8_ = _tmp10_;
		if (_inner_error_ != NULL) {
	...
	{
		RygelSamsungTVHacks* _tmp12_ = NULL;
		SoupMessage* _tmp13_ = NULL;
		RygelSamsungTVHacks* _tmp14_ = NULL;
		RygelSamsungTVHacks* _tmp15_ = NULL;
		_tmp13_ = message;
		_tmp14_ = rygel_samsung_tv_hacks_new (_tmp13_, &_inner_error_);
		_tmp12_ = _tmp14_;
		if (_inner_error_ != NULL) {
	...
	{
		RygelSeekHacks* _tmp16_ = NULL;
		SoupMessage* _tmp17_ = NULL;
		RygelSeekHacks* _tmp18_ = NULL;
		RygelSeekHacks* _tmp19_ = NULL;
		_tmp17_ = message;
		_tmp18_ = rygel_seek_hacks_new (_tmp17_, &_inner_error_);
		_tmp16_ = _tmp18_;
		if (_inner_error_ != NULL) {
		...
		_tmp19_ = _tmp16_;
		_tmp16_ = NULL;
		result = (RygelClientHacks*) _tmp19_;
	...
	{
		RygelLGTVHacks* _tmp20_ = NULL;
		SoupMessage* _tmp21_ = NULL;
		RygelLGTVHacks* _tmp22_ = NULL;
		RygelLGTVHacks* _tmp23_ = NULL;
		_tmp21_ = message;
		_tmp22_ = rygel_lgtv_hacks_new (_tmp21_, &_inner_error_);
		_tmp20_ = _tmp22_;
		if (_inner_error_ != NULL) {
		...
		_tmp23_ = _tmp20_;
		_tmp20_ = NULL;
		result = (RygelClientHacks*) _tmp23_;
	...
	_tmp25_ = message;
	_tmp26_ = rygel_xbmc_hacks_new (_tmp25_, &_inner_error_);
	_tmp24_ = _tmp26_;
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == RYGEL_CLIENT_HACKS_ERROR) {
			g_propagate_error (error, _inner_error_);
	...
	_tmp27_ = _tmp24_;
	_tmp24_ = NULL;
	result = (RygelClientHacks*) _tmp27_;
...
static void rygel_client_hacks_check_headers (RygelClientHacks* self, SoupMessage* message, GError** error) {
	...
	if (_tmp6_) {
		...
		SoupMessage* _tmp9_ = NULL;
		SoupAddress* _tmp10_ = NULL;
		SoupAddress* _tmp11_ = NULL;
		GeeHashMap* _tmp12_ = NULL;
		SoupAddress* _tmp13_ = NULL;
		const gchar* _tmp14_ = NULL;
		gpointer _tmp15_ = NULL;
		_tmp9_ = message;
		_tmp10_ = soup_message_get_address (_tmp9_);
		_tmp11_ = _g_object_ref0 (_tmp10_);
		address = _tmp11_;
		_tmp12_ = rygel_client_hacks_client_agent_cache;
		_tmp13_ = address;
		_tmp14_ = soup_address_get_physical (_tmp13_);
	...
	if (_tmp16_ != NULL) {
		SoupAddress* address = NULL;
		SoupMessage* _tmp17_ = NULL;
		SoupAddress* _tmp18_ = NULL;
		SoupAddress* _tmp19_ = NULL;
		GeeHashMap* _tmp20_ = NULL;
		GeeHashMap* _tmp22_ = NULL;
		SoupAddress* _tmp23_ = NULL;
		const gchar* _tmp24_ = NULL;
		const gchar* _tmp25_ = NULL;
		_tmp17_ = message;
		_tmp18_ = soup_message_get_address (_tmp17_);
		_tmp19_ = _g_object_ref0 (_tmp18_);
		address = _tmp19_;
		_tmp20_ = rygel_client_hacks_client_agent_cache;
		if (_tmp20_ == NULL) {
			GeeHashMap* _tmp21_ = NULL;
			_tmp21_ = gee_hash_map_new (G_TYPE_STRING, (GBoxedCopyFunc) g_strdup, g_free, G_TYPE_STRING, (GBoxedCopyFunc) g_strdup, g_free, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
			_g_object_unref0 (rygel_client_hacks_client_agent_cache);
			rygel_client_hacks_client_agent_cache = _tmp21_;
		}
		_tmp22_ = rygel_client_hacks_client_agent_cache;
		_tmp23_ = address;
		_tmp24_ = soup_address_get_physical (_tmp23_);
		_tmp25_ = agent;
		gee_abstract_map_set ((GeeAbstractMap*) _tmp22_, _tmp24_, _tmp25_);
		_g_object_unref0 (address);
	}
	_tmp27_ = agent;
	if (_tmp27_ == NULL) {
	...
	if (_tmp26_) {
		...
		GError* _tmp32_ = NULL;
		_tmp31_ = _ ("Not Applicable");
		_tmp32_ = g_error_new_literal (RYGEL_CLIENT_HACKS_ERROR, RYGEL_CLIENT_HACKS_ERROR_NA, _tmp31_);

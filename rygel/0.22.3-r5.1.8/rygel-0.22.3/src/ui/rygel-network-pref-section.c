/* rygel-network-pref-section.c generated by valac 0.24.0.112-bbf5, the Vala compiler
...
static void __lambda6_ (RygelNetworkPrefSection* self, const gchar* path, const gchar* new_);
static void ___lambda6__gtk_cell_renderer_text_edited (GtkCellRendererText* _sender, const gchar* path, const gchar* new_text, gpointer self);
...
static void __lambda7_ (RygelNetworkPrefSection* self);
...
static void ___lambda6__gtk_cell_renderer_text_edited (GtkCellRendererText* _sender, const gchar* path, const gchar* new_text, gpointer self) {
	__lambda6_ ((RygelNetworkPrefSection*) self, path, new_text);
}


static void _rygel_network_pref_section_on_remove_button_clicked_gtk_tool_button_clicked (GtkToolButton* _sender, gpointer self) {
	rygel_network_pref_section_on_remove_button_clicked ((RygelNetworkPrefSection*) self, _sender);
}
...
static void ___lambda7__gtk_tool_button_clicked (GtkToolButton* _sender, gpointer self) {
	__lambda7_ ((RygelNetworkPrefSection*) self);
}


static void _rygel_network_pref_section_on_context_available_gupnp_context_manager_context_available (GUPnPContextManager* _sender, GUPnPContext* context, gpointer self) {
	rygel_network_pref_section_on_context_available ((RygelNetworkPrefSection*) self, _sender, context);
}


static void _rygel_network_pref_section_on_context_unavailable_gupnp_context_manager_context_unavailable (GUPnPContextManager* _sender, GUPnPContext* context, gpointer self) {
	rygel_network_pref_section_on_context_unavailable ((RygelNetworkPrefSection*) self, _sender, context);
}


static void _rygel_network_pref_section_on_tree_selection_changed_gtk_tree_selection_changed (GtkTreeSelection* _sender, gpointer self) {
	rygel_network_pref_section_on_tree_selection_changed ((RygelNetworkPrefSection*) self);
}
...
RygelNetworkPrefSection* rygel_network_pref_section_construct (GType object_type, GtkBuilder* builder, RygelWritableUserConfig* config, GError** error) {
	...
	renderer = _tmp14_;
	g_signal_connect_object ((GtkCellRendererText*) renderer, "edited", (GCallback) ___lambda6__gtk_cell_renderer_text_edited, self, 0);
	_tmp15_ = builder;
	...
	add_button = _tmp24_;
	g_signal_connect_object (add_button, "clicked", (GCallback) ___lambda7__gtk_tool_button_clicked, self, 0);
	_tmp25_ = builder;
	...
	_tmp28_ = gupnp_context_manager_create ((guint) 0, FALSE);
...
static void rygel_network_pref_section_real_save (RygelPreferencesSection* base) {
	...
	RygelWritableUserConfig* _tmp11_ = NULL;
	...
	if (_tmp3_) {
		{
			...
			while (TRUE) {
				...
				if (!_tmp4_) {
					...
					_tmp5_ = self->priv->networks_store;
				...
				_tmp4_ = FALSE;
				_tmp7_ = self->priv->networks_store;
				_tmp8_ = iter;
				gtk_tree_model_get ((GtkTreeModel*) _tmp7_, &_tmp8_, 0, &uri, -1, -1);
				_tmp9_ = uri_list;
				_tmp10_ = uri;
	...
	_tmp11_ = ((RygelPreferencesSection*) self)->config;
	_tmp12_ = uri_list;
	rygel_writable_user_config_set_string_list (_tmp11_, "general", "interface", _tmp12_);

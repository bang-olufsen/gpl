/* rygel-media-pref-section.c generated by valac 0.24.0.112-bbf5, the Vala compiler
...
static void rygel_media_pref_section_real_save (RygelPreferencesSection* base) {
	...
	RygelWritableUserConfig* _tmp13_ = NULL;
	...
	if (_tmp3_) {
		{
			...
			while (TRUE) {
				...
				_tmp9_ = uri;
				_tmp10_ = rygel_media_pref_section_uri_to_magic_variable (self, _tmp9_);
				_g_free0 (uri);
				uri = _tmp10_;
				_tmp11_ = uri_list;
				_tmp12_ = uri;
	...
	_tmp13_ = ((RygelPreferencesSection*) self)->config;
	_tmp14_ = ((RygelPreferencesSection*) self)->name;
	_tmp15_ = uri_list;
	rygel_writable_user_config_set_string_list (_tmp13_, _tmp14_, RYGEL_MEDIA_PREF_SECTION_URIS_KEY, _tmp15_);

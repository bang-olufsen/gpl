/* rygel-writable-user-config.c generated by valac 0.24.0.112-bbf5, the Vala compiler
...
static void _____lambda4__gbus_name_appeared_callback (GDBusConnection* connection, const gchar* name, const gchar* name_owner, gpointer self);
static void ____lambda5_ (Block1Data* _data1_);
static void _____lambda5__gbus_name_vanished_callback (GDBusConnection* connection, const gchar* name, gpointer self);
...
static void rygel_writable_user_config_enable_upnp (RygelWritableUserConfig* self, gboolean enable) {
	...
	g_return_if_fail (self != NULL);
	{
		...
		if (_tmp1_) {
			...
			_data1_->loop = _tmp2_;
			g_bus_watch_name_with_closures (G_BUS_TYPE_SESSION, RYGEL_DBUS_INTERFACE_SERVICE_NAME, G_BUS_NAME_WATCHER_FLAGS_AUTO_START, (GClosure*) ((_____lambda4__gbus_name_appeared_callback == NULL) ? NULL : g_cclosure_new ((GCallback) _____lambda4__gbus_name_appeared_callback, block1_data_ref (_data1_), block1_data_unref)), (GClosure*) ((_____lambda5__gbus_name_vanished_callback == NULL) ? NULL : g_cclosure_new ((GCallback) _____lambda5__gbus_name_vanished_callback, block1_data_ref (_data1_), block1_data_unref)));
			_tmp3_ = _data1_->loop;

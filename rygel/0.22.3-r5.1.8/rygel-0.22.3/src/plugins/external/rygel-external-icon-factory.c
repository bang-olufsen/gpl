/* rygel-external-icon-factory.c generated by valac 0.24.0, the Vala compiler
...
struct _RygelExternalIconFactoryCreateData {
	...
	RygelExternalFreeDesktopProperties* _tmp9_;
	const gchar* _tmp10_;
	GHashTable* _tmp11_;
	GHashTable* _tmp12_;
...
static gboolean rygel_external_icon_factory_create_co (RygelExternalIconFactoryCreateData* _data_) {
	...
	_data_->_state_ = 1;
	g_async_initable_new_async (RYGEL_EXTERNAL_FREE_DESKTOP_TYPE_PROPERTIES_PROXY, 0, NULL, rygel_external_icon_factory_create_ready, _data_, "g-flags", G_DBUS_PROXY_FLAGS_DO_NOT_LOAD_PROPERTIES, "g-name", _data_->_tmp6_, "g-bus-type", G_BUS_TYPE_SESSION, "g-object-path", _data_->_tmp7_, "g-interface-name", "org.freedesktop.DBus.Properties", NULL);
	return FALSE;
	_state_1:
	_data_->_tmp8_ = NULL;
	_data_->_tmp8_ = g_async_initable_new_finish (_data_->_source_object_, _data_->_res_, &_data_->_inner_error_);
	_data_->props = (RygelExternalFreeDesktopProperties*) _data_->_tmp8_;
	...
	_data_->_state_ = 2;
	rygel_external_free_desktop_properties_get_all (_data_->_tmp9_, _data_->_tmp10_, rygel_external_icon_factory_create_ready, _data_);
	return FALSE;
	_state_2:
	_data_->_tmp11_ = NULL;
	_data_->_tmp11_ = rygel_external_free_desktop_properties_get_all_finish (_data_->_tmp9_, _data_->_res_, &_data_->_inner_error_);
...
static RygelIconInfo* rygel_external_icon_factory_create_from_props (RygelExternalIconFactory* self, GHashTable* props) {
	...
	RygelIconInfo* _tmp30_ = NULL;
	GHashTable* _tmp31_ = NULL;
	gint _tmp32_ = 0;
	RygelIconInfo* _tmp33_ = NULL;
	GHashTable* _tmp34_ = NULL;
	gint _tmp35_ = 0;
	RygelIconInfo* _tmp36_ = NULL;
	...
	_tmp26_ = value;
	if (_tmp26_ != NULL) {
		RygelIconInfo* _tmp27_ = NULL;
		GVariant* _tmp28_ = NULL;
		gint64 _tmp29_ = 0LL;
		_tmp27_ = icon;
		_tmp28_ = value;
		_tmp29_ = _variant_get31 (_tmp28_);
		_tmp27_->size = _tmp29_;
	}
	_tmp30_ = icon;
	_tmp31_ = props;
	_tmp32_ = rygel_external_icon_factory_get_int (self, _tmp31_, "Width");
	_tmp30_->width = _tmp32_;
	_tmp33_ = icon;
	_tmp34_ = props;
	_tmp35_ = rygel_external_icon_factory_get_int (self, _tmp34_, "Height");
	_tmp33_->height = _tmp35_;
	_tmp36_ = icon;
	_tmp37_ = props;
	_tmp38_ = rygel_external_icon_factory_get_int (self, _tmp37_, "ColorDepth");

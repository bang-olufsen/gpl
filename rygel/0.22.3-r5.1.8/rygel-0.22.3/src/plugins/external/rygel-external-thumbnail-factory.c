/* rygel-external-thumbnail-factory.c generated by valac 0.24.0, the Vala compiler
...
struct _RygelExternalThumbnailFactoryCreateData {
	...
	const gchar* _tmp0_;
	const gchar* _tmp1_;
	RygelExternalFreeDesktopProperties* _tmp2_;
...
static gboolean rygel_external_thumbnail_factory_create_co (RygelExternalThumbnailFactoryCreateData* _data_) {
	...
	_data_->_state_ = 1;
	g_async_initable_new_async (RYGEL_EXTERNAL_FREE_DESKTOP_TYPE_PROPERTIES_PROXY, 0, NULL, rygel_external_thumbnail_factory_create_ready, _data_, "g-flags", G_DBUS_PROXY_FLAGS_DO_NOT_LOAD_PROPERTIES, "g-name", _data_->_tmp0_, "g-bus-type", G_BUS_TYPE_SESSION, "g-object-path", _data_->_tmp1_, "g-interface-name", "org.freedesktop.DBus.Properties", NULL);
	return FALSE;
	_state_1:
	_data_->_tmp2_ = NULL;
	_data_->_tmp2_ = g_async_initable_new_finish (_data_->_source_object_, _data_->_res_, &_data_->_inner_error_);
	_data_->props = (RygelExternalFreeDesktopProperties*) _data_->_tmp2_;
	...
	_data_->_state_ = 2;
	rygel_external_free_desktop_properties_get_all (_data_->_tmp3_, RYGEL_EXTERNAL_MEDIA_ITEM_PROXY_IFACE, rygel_external_thumbnail_factory_create_ready, _data_);
	return FALSE;
	_state_2:
	_data_->_tmp4_ = NULL;
	_data_->_tmp4_ = rygel_external_free_desktop_properties_get_all_finish (_data_->_tmp3_, _data_->_res_, &_data_->_inner_error_);
...
static RygelThumbnail* rygel_external_thumbnail_factory_create_from_props (RygelExternalThumbnailFactory* self, GHashTable* props) {
	...
	if (_tmp24_) {
		...
		_g_free0 (((RygelIconInfo*) _tmp28_)->uri);
		((RygelIconInfo*) _tmp28_)->uri = _tmp31_;
	}
	_tmp32_ = props;
	_tmp33_ = g_hash_table_lookup (_tmp32_, "Size");
	...
	if (_tmp35_ != NULL) {
		...
		_tmp36_ = thumbnail;
		_tmp37_ = value;
		_tmp38_ = _variant_get22 (_tmp37_);
		((RygelIconInfo*) _tmp36_)->size = _tmp38_;
	}
	result = thumbnail;

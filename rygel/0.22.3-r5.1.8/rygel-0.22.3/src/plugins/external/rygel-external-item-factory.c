/* rygel-external-item-factory.c generated by valac 0.24.0, the Vala compiler
...
static gboolean rygel_external_item_factory_create_co (RygelExternalItemFactoryCreateData* _data_) {
	...
	if (_data_->_tmp0_) {
		...
		_data_->_tmp8_ = NULL;
		_data_->_tmp8_ = rygel_music_item_new (_data_->_tmp5_, _data_->_tmp6_, _data_->_tmp7_, RYGEL_MUSIC_ITEM_UPNP_CLASS);
		_g_object_unref0 (_data_->item);
		_data_->item = (RygelMediaItem*) _data_->_tmp8_;
		_data_->_tmp9_ = NULL;
		...
		_data_->_state_ = 1;
		rygel_external_item_factory_set_music_metadata (_data_->self, G_TYPE_CHECK_INSTANCE_TYPE (_data_->_tmp9_, RYGEL_TYPE_MUSIC_ITEM) ? ((RygelMusicItem*) _data_->_tmp9_) : NULL, _data_->_tmp10_, _data_->_tmp11_, rygel_external_item_factory_create_ready, _data_);
		return FALSE;
		_state_1:
		...
		_data_->_tmp12_ = NULL;
		_data_->_tmp12_ = _data_->type;
		_data_->_tmp13_ = FALSE;
		_data_->_tmp13_ = g_str_has_prefix (_data_->_tmp12_, "audio");
		if (_data_->_tmp13_) {
			_data_->_tmp14_ = NULL;
			...
			_data_->_tmp17_ = NULL;
			_data_->_tmp17_ = rygel_audio_item_new (_data_->_tmp14_, _data_->_tmp15_, _data_->_tmp16_, RYGEL_AUDIO_ITEM_UPNP_CLASS);
			_g_object_unref0 (_data_->item);
			_data_->item = (RygelMediaItem*) _data_->_tmp17_;
			_data_->_tmp18_ = NULL;
			_data_->_tmp18_ = _data_->item;
			_data_->_tmp19_ = NULL;
			_data_->_tmp19_ = _data_->props;
			_data_->_tmp20_ = NULL;
			_data_->_tmp20_ = _data_->service_name;
			rygel_external_item_factory_set_audio_metadata (_data_->self, G_TYPE_CHECK_INSTANCE_TYPE (_data_->_tmp18_, RYGEL_TYPE_AUDIO_ITEM) ? ((RygelAudioItem*) _data_->_tmp18_) : NULL, _data_->_tmp19_, _data_->_tmp20_, &_data_->_inner_error_);
			if (_data_->_inner_error_ != NULL) {
				if ((_data_->_inner_error_->domain == G_IO_ERROR) || (_data_->_inner_error_->domain == G_DBUS_ERROR)) {
					g_simple_async_result_set_from_error (_data_->_async_result, _data_->_inner_error_);
					g_error_free (_data_->_inner_error_);
			...
			_data_->_tmp21_ = NULL;
			_data_->_tmp21_ = _data_->type;
			_data_->_tmp22_ = FALSE;
			_data_->_tmp22_ = g_str_has_prefix (_data_->_tmp21_, "video");
			if (_data_->_tmp22_) {
				_data_->_tmp23_ = NULL;
				...
				_data_->_tmp25_ = NULL;
				_data_->_tmp25_ = _data_->title;
				_data_->_tmp26_ = NULL;
				_data_->_tmp26_ = rygel_video_item_new (_data_->_tmp23_, _data_->_tmp24_, _data_->_tmp25_, RYGEL_VIDEO_ITEM_UPNP_CLASS);
				_g_object_unref0 (_data_->item);
				_data_->item = (RygelMediaItem*) _data_->_tmp26_;
				_data_->_tmp27_ = NULL;
				_data_->_tmp27_ = _data_->item;
				_data_->_tmp28_ = NULL;
				_data_->_tmp28_ = _data_->props;
				_data_->_tmp29_ = NULL;
				_data_->_tmp29_ = _data_->service_name;
				_data_->_state_ = 2;
				rygel_external_item_factory_set_video_metadata (_data_->self, G_TYPE_CHECK_INSTANCE_TYPE (_data_->_tmp27_, RYGEL_TYPE_VIDEO_ITEM) ? ((RygelVideoItem*) _data_->_tmp27_) : NULL, _data_->_tmp28_, _data_->_tmp29_, rygel_external_item_factory_create_ready, _data_);
				return FALSE;
				_state_2:
				...
				_data_->_tmp31_ = NULL;
				_data_->_tmp31_ = _data_->parent;
				_data_->_tmp32_ = NULL;
				_data_->_tmp32_ = _data_->title;
				_data_->_tmp33_ = NULL;
				_data_->_tmp33_ = rygel_image_item_new (_data_->_tmp30_, _data_->_tmp31_, _data_->_tmp32_, RYGEL_IMAGE_ITEM_UPNP_CLASS);
				_g_object_unref0 (_data_->item);
				_data_->item = (RygelMediaItem*) _data_->_tmp33_;
				_data_->_tmp34_ = NULL;
				_data_->_tmp34_ = _data_->item;
				_data_->_tmp35_ = NULL;
				_data_->_tmp35_ = _data_->props;
				_data_->_tmp36_ = NULL;
				_data_->_tmp36_ = _data_->service_name;
				_data_->_state_ = 3;
				rygel_external_item_factory_set_visual_metadata (_data_->self, G_TYPE_CHECK_INSTANCE_TYPE (_data_->_tmp34_, RYGEL_TYPE_VISUAL_ITEM) ? ((RygelVisualItem*) _data_->_tmp34_) : NULL, _data_->_tmp35_, _data_->_tmp36_, rygel_external_item_factory_create_ready, _data_);
				return FALSE;
				_state_3:
	...
	rygel_external_item_factory_set_generic_metadata (_data_->self, _data_->_tmp37_, _data_->_tmp38_, _data_->_tmp39_);
	_data_->_tmp40_ = NULL;
	_data_->_tmp40_ = _data_->parent;
	if (G_TYPE_CHECK_INSTANCE_TYPE (_data_->_tmp40_, RYGEL_EXTERNAL_TYPE_DUMMY_CONTAINER)) {
		_data_->_tmp41_ = NULL;
		_data_->_tmp41_ = _data_->item;
		_data_->_tmp42_ = NULL;
		_data_->_tmp42_ = _data_->parent;
		rygel_media_object_set_parent_ref ((RygelMediaObject*) _data_->_tmp41_, _data_->_tmp42_);
	}
...
static gboolean rygel_external_item_factory_set_music_metadata_co (RygelExternalItemFactorySetMusicMetadataData* _data_) {
	...
	if (_data_->_tmp18_ != NULL) {
		...
		_data_->_tmp22_ = NULL;
		_data_->_tmp22_ = _data_->service_name;
		_data_->_tmp23_ = NULL;
		_data_->_tmp23_ = _data_->value;
		_data_->_tmp24_ = NULL;
		_data_->_tmp24_ = _variant_get13 (_data_->_tmp23_);
		_data_->_tmp25_ = NULL;
		_data_->_tmp25_ = _data_->_tmp24_;
		_data_->_state_ = 1;
		rygel_external_album_art_factory_create (_data_->_tmp21_, _data_->_tmp22_, _data_->_tmp25_, rygel_external_item_factory_set_music_metadata_ready, _data_);
		return FALSE;
		_state_1:
		_data_->_tmp26_ = NULL;
		...
		rygel_music_item_set_album_art (_data_->_tmp28_, _data_->_tmp20_);
		_rygel_icon_info_unref0 (_data_->_tmp20_);
		_rygel_external_album_art_factory_unref0 (_data_->cover_factory);
	}
	_data_->_tmp29_ = NULL;
	_data_->_tmp29_ = _data_->music;
	_data_->_tmp30_ = NULL;
	_data_->_tmp30_ = _data_->props;
	_data_->_tmp31_ = NULL;
	_data_->_tmp31_ = _data_->service_name;
	rygel_external_item_factory_set_audio_metadata (_data_->self, (RygelAudioItem*) _data_->_tmp29_, _data_->_tmp30_, _data_->_tmp31_, &_data_->_inner_error_);
	if (_data_->_inner_error_ != NULL) {
		if ((_data_->_inner_error_->domain == G_IO_ERROR) || (_data_->_inner_error_->domain == G_DBUS_ERROR)) {
			g_simple_async_result_set_from_error (_data_->_async_result, _data_->_inner_error_);
			g_error_free (_data_->_inner_error_);
...
static void rygel_external_item_factory_set_generic_metadata (RygelExternalItemFactory* self, RygelMediaItem* item, GHashTable* props, const gchar* service_name) {
	...
	_tmp22_ = _tmp21_;
	rygel_media_item_set_dlna_profile (_tmp19_, _tmp22_);
	_g_free0 (_tmp22_);
	_tmp23_ = props;
	_tmp24_ = g_hash_table_lookup (_tmp23_, "Size");
	...
	if (_tmp26_ != NULL) {
		...
		_tmp27_ = item;
		_tmp28_ = value;
		_tmp29_ = _variant_get15 (_tmp28_);
		rygel_media_item_set_size (_tmp27_, _tmp29_);
	}
	_tmp30_ = item;
	_tmp31_ = props;
	_tmp32_ = rygel_external_item_factory_get_string (self, _tmp31_, "Date");
	_tmp33_ = _tmp32_;
	rygel_media_item_set_date (_tmp30_, _tmp33_);
	_g_free0 (_tmp33_);

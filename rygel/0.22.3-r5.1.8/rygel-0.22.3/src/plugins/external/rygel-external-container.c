/* rygel-external-container.c generated by valac 0.24.0, the Vala compiler
...
struct _RygelExternalContainerFindObjectData {
	...
	const gchar* _tmp29_;
	const gchar* _tmp30_;
	RygelExternalFreeDesktopProperties* _tmp31_;
	GHashTable* props;
	...
	gboolean _tmp39_;
	GHashTable* _tmp40_;
	RygelExternalFreeDesktopProperties* _tmp41_;
	GHashTable* _tmp42_;
	GHashTable* _tmp43_;
	gchar* path;
	GHashTable* _tmp44_;
	...
	const gchar* _tmp49_;
	gchar* _tmp50_;
	RygelExternalContainer* _tmp51_;
	const gchar* _tmp52_;
	const gchar* _tmp53_;
	guint _tmp54_;
	gboolean _tmp55_;
	...
	RygelExternalContainer* _tmp59_;
	RygelExternalDummyContainer* parent_container;
	RygelExternalMediaObjectProxy* _tmp60_;
	char* _tmp61_;
	char* _tmp62_;
	gchar* _tmp63_;
	RygelExternalDummyContainer* _tmp64_;
	RygelExternalDummyContainer* _tmp65_;
	RygelExternalFreeDesktopProperties* _vala1_props_iface;
	const gchar* _tmp66_;
	const gchar* _tmp67_;
	RygelExternalFreeDesktopProperties* _tmp68_;
	GHashTable* _vala1_props;
	RygelExternalFreeDesktopProperties* _tmp69_;
	GHashTable* _tmp70_;
	RygelMediaItem* _tmp71_;
	RygelExternalItemFactory* _tmp72_;
	const gchar* _tmp73_;
	RygelExternalMediaObjectProxy* _tmp74_;
	gchar* _tmp75_;
	gchar* _tmp76_;
	gchar* _tmp77_;
	RygelExternalMediaObjectProxy* _tmp78_;
	gchar* _tmp79_;
	gchar* _tmp80_;
	gchar* _tmp81_;
	GHashTable* _tmp82_;
	const gchar* _tmp83_;
	RygelExternalDummyContainer* _tmp84_;
...
struct _RygelExternalContainerCreateMediaObjectsData {
	...
	RygelExternalItemFactory* _tmp35_;
	const gchar* _tmp36_;
	const gchar* _tmp37_;
	const gchar* _tmp38_;
	GHashTable* _tmp39_;
...
struct _RygelExternalContainerUpdateContainerData {
	...
	guint _tmp9_;
	GHashTable* _tmp10_;
	RygelExternalFreeDesktopProperties* _tmp11_;
	GHashTable* _tmp12_;
	GHashTable* _tmp13_;
	GHashTable* _tmp14_;
	const gchar* _tmp15_;
	...
	RygelExternalMediaContainerProxy* _tmp20_;
	const gchar* _tmp21_;
	GError* _tmp22_;
	const gchar* _tmp23_;
	gint _tmp24_;
	...
	gint _tmp26_;
	GError* err;
	RygelExternalMediaContainerProxy* _tmp27_;
	const gchar* _tmp28_;
	GError* _tmp29_;
	const gchar* _tmp30_;
	gboolean _tmp31_;
	RygelExternalMediaContainerProxy* _tmp32_;
	GError * _inner_error_;
};
...
RygelExternalContainer* rygel_external_container_construct (GType object_type, const gchar* id, const gchar* title, guint child_count, gboolean searchable, const gchar* service_name, const gchar* path, RygelExternalContainer* parent, GError** error) {
	...
	RygelExternalMediaContainerProxy* _tmp16_ = NULL;
	...
	self->actual_container = _tmp16_;
	rygel_external_container_update_container (self, TRUE, NULL, NULL);
	_tmp17_ = parent;
	if (_tmp17_ != NULL) {
		RygelExternalContainer* _tmp18_ = NULL;
		_tmp18_ = parent;
		g_object_add_weak_pointer ((GObject*) _tmp18_, &((RygelMediaObject*) self)->parent_ptr);
	}
...
static gboolean rygel_external_container_real_find_object_co (RygelExternalContainerFindObjectData* _data_) {
	...
	if (_data_->_tmp7_) {
		...
		if (_data_->_tmp10_ == NULL) {
			{
				...
				while (TRUE) {
					...
					_data_->_tmp22_ = NULL;
					_g_object_unref0 (_data_->media_object);
					_data_->media_object = _data_->_tmp27_;
					_data_->_tmp28_ = NULL;
			...
			_data_->_tmp29_ = NULL;
			_data_->_tmp29_ = _data_->self->service_name;
			_data_->_tmp30_ = NULL;
			_data_->_tmp30_ = _data_->id;
			_data_->_state_ = 3;
			g_async_initable_new_async (RYGEL_EXTERNAL_FREE_DESKTOP_TYPE_PROPERTIES_PROXY, 0, NULL, rygel_external_container_find_object_ready, _data_, "g-flags", G_DBUS_PROXY_FLAGS_DO_NOT_LOAD_PROPERTIES, "g-name", _data_->_tmp29_, "g-bus-type", G_BUS_TYPE_SESSION, "g-object-path", _data_->_tmp30_, "g-interface-name", "org.freedesktop.DBus.Properties", NULL);
			return FALSE;
			_state_3:
			_data_->_tmp31_ = NULL;
			_data_->_tmp31_ = g_async_initable_new_finish (_data_->_source_object_, _data_->_res_, &_data_->_inner_error_);
			_data_->props_iface = (RygelExternalFreeDesktopProperties*) _data_->_tmp31_;
			if (_data_->_inner_error_ != NULL) {
				g_simple_async_result_set_from_error (_data_->_async_result, _data_->_inner_error_);
				g_error_free (_data_->_inner_error_);
				_g_object_unref0 (_data_->actual_object);
			...
			_data_->_state_ = 4;
			rygel_external_free_desktop_properties_get_all (_data_->_tmp32_, RYGEL_EXTERNAL_MEDIA_CONTAINER_PROXY_IFACE, rygel_external_container_find_object_ready, _data_);
			return FALSE;
			_state_4:
			_data_->_tmp33_ = NULL;
			_data_->_tmp33_ = rygel_external_free_desktop_properties_get_all_finish (_data_->_tmp32_, _data_->_res_, &_data_->_inner_error_);
			_data_->props = _data_->_tmp33_;
			if (_data_->_inner_error_ != NULL) {
				g_simple_async_result_set_from_error (_data_->_async_result, _data_->_inner_error_);
				g_error_free (_data_->_inner_error_);
			...
			_data_->_tmp34_ = NULL;
			_data_->_tmp34_ = _data_->props;
			_data_->_tmp35_ = NULL;
			_data_->_tmp35_ = g_hash_table_lookup (_data_->_tmp34_, "ChildCount");
			_data_->_tmp36_ = 0U;
			_data_->_tmp36_ = _variant_get1 ((GVariant*) _data_->_tmp35_);
			_data_->child_count = _data_->_tmp36_;
			_data_->_tmp37_ = NULL;
			_data_->_tmp37_ = _data_->props;
			_data_->_tmp38_ = NULL;
			_data_->_tmp38_ = g_hash_table_lookup (_data_->_tmp37_, "Searchable");
			_data_->_tmp39_ = FALSE;
			_data_->_tmp39_ = _variant_get2 ((GVariant*) _data_->_tmp38_);
			_data_->searchable = _data_->_tmp39_;
			_data_->_tmp41_ = NULL;
			_data_->_tmp41_ = _data_->props_iface;
			_data_->_state_ = 5;
			rygel_external_free_desktop_properties_get_all (_data_->_tmp41_, RYGEL_EXTERNAL_MEDIA_OBJECT_PROXY_IFACE, rygel_external_container_find_object_ready, _data_);
			return FALSE;
			_state_5:
			_data_->_tmp42_ = NULL;
			_data_->_tmp42_ = rygel_external_free_desktop_properties_get_all_finish (_data_->_tmp41_, _data_->_res_, &_data_->_inner_error_);
			_data_->_tmp40_ = _data_->_tmp42_;
			if (_data_->_inner_error_ != NULL) {
				g_simple_async_result_set_from_error (_data_->_async_result, _data_->_inner_error_);
				g_error_free (_data_->_inner_error_);
			...
			_data_->_tmp40_ = NULL;
			_g_hash_table_unref0 (_data_->props);
			_data_->props = _data_->_tmp43_;
			_data_->_tmp44_ = NULL;
			_data_->_tmp44_ = _data_->props;
			_data_->_tmp45_ = NULL;
			_data_->_tmp45_ = g_hash_table_lookup (_data_->_tmp44_, "Path");
			_data_->_tmp46_ = NULL;
			_data_->_tmp46_ = _variant_get3 ((GVariant*) _data_->_tmp45_);
			_data_->path = _data_->_tmp46_;
			_data_->_tmp47_ = NULL;
			_data_->_tmp47_ = _data_->props;
			_data_->_tmp48_ = NULL;
			_data_->_tmp48_ = _data_->path;
			_data_->_tmp49_ = NULL;
			_data_->_tmp49_ = _data_->self->service_name;
			_data_->_tmp50_ = NULL;
			_data_->_tmp50_ = rygel_external_get_mandatory_string_value (_data_->_tmp47_, "DisplayName", _data_->_tmp48_, _data_->_tmp49_);
			_data_->title = _data_->_tmp50_;
			_data_->_tmp52_ = NULL;
			_data_->_tmp52_ = _data_->path;
			_data_->_tmp53_ = NULL;
			...
			_data_->_tmp58_ = NULL;
			_data_->_tmp58_ = rygel_external_container_new (_data_->_tmp52_, _data_->_tmp53_, _data_->_tmp54_, _data_->_tmp55_, _data_->_tmp56_, _data_->_tmp57_, _data_->self, &_data_->_inner_error_);
			_data_->_tmp51_ = _data_->_tmp58_;
			if (_data_->_inner_error_ != NULL) {
				g_simple_async_result_set_from_error (_data_->_async_result, _data_->_inner_error_);
				g_error_free (_data_->_inner_error_);
				_g_free0 (_data_->title);
				_g_free0 (_data_->path);
				_g_hash_table_unref0 (_data_->_tmp40_);
				_g_hash_table_unref0 (_data_->props);
				_g_object_unref0 (_data_->props_iface);
				_g_object_unref0 (_data_->actual_object);
				_g_object_unref0 (_data_->media_object);
			...
			_data_->_tmp59_ = NULL;
			_data_->_tmp59_ = _data_->_tmp51_;
			_data_->_tmp51_ = NULL;
			_g_object_unref0 (_data_->media_object);
			_data_->media_object = (RygelMediaObject*) _data_->_tmp59_;
		...
		_data_->_tmp60_ = NULL;
		_data_->_tmp60_ = _data_->actual_object;
		_data_->_tmp61_ = NULL;
		_data_->_tmp61_ = rygel_external_media_object_proxy_get_parent (_data_->_tmp60_);
		_data_->_tmp62_ = NULL;
		_data_->_tmp62_ = _data_->_tmp61_;
		_data_->_tmp63_ = NULL;
		_data_->_tmp63_ = (gchar*) _data_->_tmp62_;
		_data_->_tmp64_ = NULL;
		_data_->_tmp64_ = rygel_external_dummy_container_new (_data_->_tmp63_, "LaLaLa", (guint) 0, NULL);
		_data_->_tmp65_ = NULL;
		_data_->_tmp65_ = _data_->_tmp64_;
		_g_free0 (_data_->_tmp63_);
		_data_->parent_container = _data_->_tmp65_;
		_data_->_tmp66_ = NULL;
		_data_->_tmp66_ = _data_->self->service_name;
		_data_->_tmp67_ = NULL;
		_data_->_tmp67_ = _data_->id;
		_data_->_state_ = 6;
		g_async_initable_new_async (RYGEL_EXTERNAL_FREE_DESKTOP_TYPE_PROPERTIES_PROXY, 0, NULL, rygel_external_container_find_object_ready, _data_, "g-flags", G_DBUS_PROXY_FLAGS_DO_NOT_LOAD_PROPERTIES, "g-name", _data_->_tmp66_, "g-bus-type", G_BUS_TYPE_SESSION, "g-object-path", _data_->_tmp67_, "g-interface-name", "org.freedesktop.DBus.Properties", NULL);
		return FALSE;
		_state_6:
		_data_->_tmp68_ = NULL;
		_data_->_tmp68_ = g_async_initable_new_finish (_data_->_source_object_, _data_->_res_, &_data_->_inner_error_);
		_data_->_vala1_props_iface = (RygelExternalFreeDesktopProperties*) _data_->_tmp68_;
		if (_data_->_inner_error_ != NULL) {
			g_simple_async_result_set_from_error (_data_->_async_result, _data_->_inner_error_);
			g_error_free (_data_->_inner_error_);
		...
		_data_->_tmp69_ = NULL;
		_data_->_tmp69_ = _data_->_vala1_props_iface;
		_data_->_state_ = 7;
		rygel_external_free_desktop_properties_get_all (_data_->_tmp69_, RYGEL_EXTERNAL_MEDIA_ITEM_PROXY_IFACE, rygel_external_container_find_object_ready, _data_);
		return FALSE;
		_state_7:
		_data_->_tmp70_ = NULL;
		_data_->_tmp70_ = rygel_external_free_desktop_properties_get_all_finish (_data_->_tmp69_, _data_->_res_, &_data_->_inner_error_);
		_data_->_vala1_props = _data_->_tmp70_;
		if (_data_->_inner_error_ != NULL) {
			g_simple_async_result_set_from_error (_data_->_async_result, _data_->_inner_error_);
			g_error_free (_data_->_inner_error_);
		...
		_data_->_tmp72_ = NULL;
		_data_->_tmp72_ = _data_->self->priv->item_factory;
		_data_->_tmp73_ = NULL;
		_data_->_tmp73_ = _data_->id;
		_data_->_tmp74_ = NULL;
		_data_->_tmp74_ = _data_->actual_object;
		_data_->_tmp75_ = NULL;
		_data_->_tmp75_ = rygel_external_media_object_proxy_get_object_type (_data_->_tmp74_);
		_data_->_tmp76_ = NULL;
		_data_->_tmp76_ = _data_->_tmp75_;
		_data_->_tmp77_ = NULL;
		_data_->_tmp77_ = _data_->_tmp76_;
		_data_->_tmp78_ = NULL;
		_data_->_tmp78_ = _data_->actual_object;
		_data_->_tmp79_ = NULL;
		_data_->_tmp79_ = rygel_external_media_object_proxy_get_display_name (_data_->_tmp78_);
		_data_->_tmp80_ = NULL;
		_data_->_tmp80_ = _data_->_tmp79_;
		_data_->_tmp81_ = NULL;
		_data_->_tmp81_ = _data_->_tmp80_;
		_data_->_tmp82_ = NULL;
		_data_->_tmp82_ = _data_->_vala1_props;
		_data_->_tmp83_ = NULL;
		_data_->_tmp83_ = _data_->self->service_name;
		_data_->_tmp84_ = NULL;
		_data_->_tmp84_ = _data_->parent_container;
		_data_->_state_ = 8;
		rygel_external_item_factory_create (_data_->_tmp72_, _data_->_tmp73_, _data_->_tmp77_, _data_->_tmp81_, _data_->_tmp82_, _data_->_tmp83_, (RygelMediaContainer*) _data_->_tmp84_, rygel_external_container_find_object_ready, _data_);
		return FALSE;
		_state_8:
		_data_->_tmp85_ = NULL;
		_data_->_tmp85_ = rygel_external_item_factory_create_finish (_data_->_tmp72_, _data_->_res_, &_data_->_inner_error_);
		_data_->_tmp86_ = NULL;
		_data_->_tmp86_ = _data_->_tmp85_;
		_g_free0 (_data_->_tmp81_);
		_g_free0 (_data_->_tmp77_);
		_data_->_tmp71_ = _data_->_tmp86_;
		if (_data_->_inner_error_ != NULL) {
			g_simple_async_result_set_from_error (_data_->_async_result, _data_->_inner_error_);
			g_error_free (_data_->_inner_error_);
		...
		_data_->_tmp87_ = NULL;
		_data_->_tmp87_ = _data_->_tmp71_;
		_data_->_tmp71_ = NULL;
		_g_object_unref0 (_data_->media_object);
		_data_->media_object = (RygelMediaObject*) _data_->_tmp87_;
		...
		for (_data_->props_it = 0; _data_->props_it < _data_->_tmp1__length1; _data_->props_it = _data_->props_it + 1) {
			...
			_data_->props = _data_->_tmp2_;
			{
				...
				if (_data_->_tmp20_ == NULL) {
					...
					_data_->_tmp25_ = NULL;
					_data_->_tmp25_ = _data_->type;
					if (g_strcmp0 (_data_->_tmp25_, "container") == 0) {
						_data_->_tmp26_ = NULL;
						_data_->_tmp26_ = _data_->props;
						_data_->_tmp27_ = NULL;
						_data_->_tmp27_ = g_hash_table_lookup (_data_->_tmp26_, "ChildCount");
						_data_->_tmp28_ = 0U;
						_data_->_tmp28_ = _variant_get7 ((GVariant*) _data_->_tmp27_);
						_data_->child_count = _data_->_tmp28_;
						_data_->_tmp29_ = NULL;
						_data_->_tmp29_ = _data_->id;
						_data_->_tmp30_ = NULL;
						_data_->_tmp30_ = _data_->title;
						_data_->_tmp31_ = 0U;
						_data_->_tmp31_ = _data_->child_count;
						_data_->_tmp32_ = NULL;
						_data_->_tmp32_ = _data_->parent_container;
						_data_->_tmp33_ = NULL;
						_data_->_tmp33_ = rygel_external_dummy_container_new (_data_->_tmp29_, _data_->_tmp30_, _data_->_tmp31_, _data_->_tmp32_);
						_g_object_unref0 (_data_->media_object);
						_data_->media_object = (RygelMediaObject*) _data_->_tmp33_;
					} else {
						_data_->_tmp35_ = NULL;
						_data_->_tmp35_ = _data_->self->priv->item_factory;
						_data_->_tmp36_ = NULL;
						_data_->_tmp36_ = _data_->id;
						_data_->_tmp37_ = NULL;
						_data_->_tmp37_ = _data_->type;
						_data_->_tmp38_ = NULL;
						_data_->_tmp38_ = _data_->title;
						_data_->_tmp39_ = NULL;
						_data_->_tmp39_ = _data_->props;
						_data_->_tmp40_ = NULL;
						_data_->_tmp40_ = _data_->self->service_name;
						_data_->_tmp41_ = NULL;
						_data_->_tmp41_ = _data_->parent_container;
						_data_->_state_ = 1;
						rygel_external_item_factory_create (_data_->_tmp35_, _data_->_tmp36_, _data_->_tmp37_, _data_->_tmp38_, _data_->_tmp39_, _data_->_tmp40_, _data_->_tmp41_, rygel_external_container_create_media_objects_ready, _data_);
						return FALSE;
						_state_1:
						_data_->_tmp42_ = NULL;
						_data_->_tmp42_ = rygel_external_item_factory_create_finish (_data_->_tmp35_, _data_->_res_, &_data_->_inner_error_);
						_data_->_tmp34_ = _data_->_tmp42_;
						if (_data_->_inner_error_ != NULL) {
							g_simple_async_result_set_from_error (_data_->_async_result, _data_->_inner_error_);
							g_error_free (_data_->_inner_error_);
							_g_free0 (_data_->title);
						...
						_data_->_tmp34_ = NULL;
						_g_object_unref0 (_data_->media_object);
						_data_->media_object = (RygelMediaObject*) _data_->_tmp43_;
						_g_object_unref0 (_data_->_tmp34_);
					}
					_g_free0 (_data_->title);
				}
				_data_->_tmp44_ = NULL;
				_data_->_tmp44_ = _data_->media_objects;
				_data_->_tmp45_ = NULL;
				_data_->_tmp45_ = _data_->media_object;
...
static gboolean rygel_external_container_update_container_co (RygelExternalContainerUpdateContainerData* _data_) {
	...
	_state_0:
	{
		...
		_state_2:
		_data_->_tmp5_ = NULL;
		_data_->_tmp5_ = rygel_external_free_desktop_properties_get_all_finish (_data_->_tmp4_, _data_->_res_, &_data_->_inner_error_);
		...
		_data_->_state_ = 3;
		rygel_external_free_desktop_properties_get_all (_data_->_tmp11_, RYGEL_EXTERNAL_MEDIA_OBJECT_PROXY_IFACE, rygel_external_container_update_container_ready, _data_);
		return FALSE;
		_state_3:
		_data_->_tmp12_ = NULL;
		_data_->_tmp12_ = rygel_external_free_desktop_properties_get_all_finish (_data_->_tmp11_, _data_->_res_, &_data_->_inner_error_);
		...
		_data_->_tmp14_ = _data_->props;
		_data_->_tmp15_ = NULL;
		_data_->_tmp15_ = rygel_media_object_get_id ((RygelMediaObject*) _data_->self);
		_data_->_tmp16_ = NULL;
		_data_->_tmp16_ = _data_->_tmp15_;
		_data_->_tmp17_ = NULL;
		_data_->_tmp17_ = _data_->self->service_name;
		_data_->_tmp18_ = NULL;
		_data_->_tmp18_ = rygel_external_get_mandatory_string_value (_data_->_tmp14_, "DisplayName", _data_->_tmp16_, _data_->_tmp17_);
		_data_->_tmp19_ = NULL;
		_data_->_tmp19_ = _data_->_tmp18_;
		rygel_media_object_set_title ((RygelMediaObject*) _data_->self, _data_->_tmp19_);
		_g_free0 (_data_->_tmp19_);
		_g_hash_table_unref0 (_data_->_tmp10_);
		_g_hash_table_unref0 (_data_->props);
		_g_object_unref0 (_data_->props_iface);
	}
	goto __finally0;
	__catch0_g_error:
	{
		...
		_data_->_tmp20_ = NULL;
		_data_->_tmp20_ = _data_->self->actual_container;
		_data_->_tmp21_ = NULL;
		_data_->_tmp21_ = g_dbus_proxy_get_object_path ((GDBusProxy*) _data_->_tmp20_);
		_data_->_tmp22_ = NULL;
		_data_->_tmp22_ = _data_->property_error;
		_data_->_tmp23_ = NULL;
		_data_->_tmp23_ = _data_->_tmp22_->message;
		g_warning ("rygel-external-container.vala:338: Failed to update information about " \
"container '%s': %s", _data_->_tmp21_, _data_->_tmp23_);
	...
	{
		_data_->_tmp24_ = 0;
		_data_->_tmp24_ = rygel_media_container_get_child_count ((RygelMediaContainer*) _data_->self);
		_data_->_tmp25_ = 0;
		_data_->_tmp25_ = _data_->_tmp24_;
		_data_->_tmp26_ = 0;
		_data_->_tmp26_ = G_MAXINT;
	...
	__catch1_g_error:
	{
		...
		_data_->_inner_error_ = NULL;
		_data_->_tmp27_ = NULL;
		_data_->_tmp27_ = _data_->self->actual_container;
		_data_->_tmp28_ = NULL;
		_data_->_tmp28_ = g_dbus_proxy_get_object_path ((GDBusProxy*) _data_->_tmp27_);
		_data_->_tmp29_ = NULL;
...
"container '%s': %s", _data_->_tmp28_, _data_->_tmp30_);
	...
	_data_->_tmp31_ = _data_->connect_signal;
	if (_data_->_tmp31_) {
		_data_->_tmp32_ = NULL;
		_data_->_tmp32_ = _data_->self->actual_container;
		g_signal_connect_object (_data_->_tmp32_, "updated", (GCallback) _rygel_external_container_on_updated_rygel_external_media_container_proxy_updated, _data_->self, 0);
	}
	if (_data_->_state_ == 0) {
		g_simple_async_result_complete_in_idle (_data_->_async_result);
	} else {

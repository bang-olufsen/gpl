/* rygel-external-plugin-factory.c generated by valac 0.24.0, the Vala compiler
...
struct _RygelExternalPluginFactoryLoadActivatablePluginsData {
	...
	RygelPlugin* _tmp10_;
	const gchar* _tmp11_;
	RygelExternalFreeDesktopDBusObject* _tmp12_;
	GError * _inner_error_;
};
...
struct _RygelExternalPluginFactoryLoadPluginData {
	...
	const gchar* _tmp11_;
	const gchar* _tmp12_;
	RygelExternalFreeDesktopProperties* _tmp13_;
	GHashTable* object_props;
	GHashTable* container_props;
	GHashTable* _tmp14_;
	RygelExternalFreeDesktopProperties* _tmp15_;
	GHashTable* _tmp16_;
	GHashTable* _tmp17_;
	GHashTable* _tmp18_;
	RygelExternalFreeDesktopProperties* _tmp19_;
	GHashTable* _tmp20_;
	GHashTable* _tmp21_;
	RygelIconInfo* icon;
	RygelExternalIconFactory* _tmp22_;
	const gchar* _tmp23_;
	GHashTable* _tmp24_;
	...
	RygelPluginLoader* _tmp47_;
	RygelExternalPlugin* _tmp48_;
	GError* err;
	const gchar* _tmp49_;
	GError* _tmp50_;
	const gchar* _tmp51_;
...
static void rygel_external_plugin_factory_name_owner_changed (RygelExternalPluginFactory* self, RygelExternalFreeDesktopDBusObject* dbus_obj, const gchar* name, const gchar* old_owner, const gchar* new_owner);
static void _rygel_external_plugin_factory_name_owner_changed_rygel_external_free_desktop_dbus_object_name_owner_changed (RygelExternalFreeDesktopDBusObject* _sender, const gchar* name, const gchar* old_owner, const gchar* new_owner, gpointer self);
...
void module_init (RygelPluginLoader* loader) {
	...
	g_return_if_fail (loader != NULL);
	{
		...
		RygelExternalPluginFactory* _tmp3_ = NULL;
		_tmp1_ = loader;
	...
	__catch2_g_error:
	{
		...
		_inner_error_ = NULL;
		_tmp4_ = _ ("Module '%s' could not connect to D-Bus session bus. " "Ignoring…");
		g_message (_tmp4_, RYGEL_EXTERNAL_PLUGIN_MODULE_NAME);
...
RygelExternalPluginFactory* rygel_external_plugin_factory_construct (GType object_type, RygelPluginLoader* loader, GError** error) {
	...
	RygelExternalFreeDesktopDBusObject* _tmp2_ = NULL;
	RygelExternalFreeDesktopDBusObject* _tmp3_ = NULL;
	RygelPluginLoader* _tmp4_ = NULL;
	RygelPluginLoader* _tmp5_ = NULL;
	GError * _inner_error_ = NULL;
	...
	_tmp2_ = g_initable_new (RYGEL_EXTERNAL_FREE_DESKTOP_TYPE_DBUS_OBJECT_PROXY, NULL, &_inner_error_, "g-flags", G_DBUS_PROXY_FLAGS_DO_NOT_LOAD_PROPERTIES, "g-name", RYGEL_EXTERNAL_FREE_DESKTOP_DBUS_SERVICE, "g-bus-type", G_BUS_TYPE_SESSION, "g-object-path", RYGEL_EXTERNAL_FREE_DESKTOP_DBUS_OBJECT_PATH, "g-interface-name", "org.freedesktop.DBus", NULL);
...
static gboolean rygel_external_plugin_factory_load_plugins_co (RygelExternalPluginFactoryLoadPluginsData* _data_) {
	...
	_state_1:
	_data_->_tmp2_ = NULL;
	_data_->_tmp2_ = rygel_external_free_desktop_dbus_object_list_names_finish (_data_->_tmp0_, _data_->_res_, &_data_->_tmp1_, &_data_->_inner_error_);
		...
		for (_data_->service_it = 0; _data_->service_it < _data_->_tmp3__length1; _data_->service_it = _data_->service_it + 1) {
			...
			_data_->service = _data_->_tmp4_;
			{
				...
				if (_data_->_tmp5_) {
					...
					_data_->_state_ = 2;
					rygel_external_plugin_factory_load_plugin_n_handle_error (_data_->self, _data_->_tmp12_, rygel_external_plugin_factory_load_plugins_ready, _data_);
					return FALSE;
					_state_2:
...
static gboolean rygel_external_plugin_factory_load_activatable_plugins_co (RygelExternalPluginFactoryLoadActivatablePluginsData* _data_) {
	...
	_state_1:
	_data_->_tmp2_ = NULL;
	_data_->_tmp2_ = rygel_external_free_desktop_dbus_object_list_activatable_names_finish (_data_->_tmp0_, _data_->_res_, &_data_->_tmp1_, &_data_->_inner_error_);
	_data_->services_length1 = 0;
	_data_->_services_size_ = 0;
	_data_->services = _data_->_tmp2_;
	_data_->services_length1 = _data_->_tmp1_;
		...
		for (_data_->service_it = 0; _data_->service_it < _data_->services_length1; _data_->service_it = _data_->service_it + 1) {
			...
			_data_->service = _data_->_tmp3_;
			{
				...
				if (_data_->_tmp4_) {
					...
					_data_->_state_ = 2;
					rygel_external_plugin_factory_load_plugin_n_handle_error (_data_->self, _data_->_tmp11_, rygel_external_plugin_factory_load_activatable_plugins_ready, _data_);
					return FALSE;
					_state_2:
					rygel_external_plugin_factory_load_plugin_n_handle_error_finish (_data_->self, _data_->_res_);
				}
	...
	_data_->_tmp12_ = NULL;
	_data_->_tmp12_ = _data_->self->priv->dbus_obj;
	g_signal_connect (_data_->_tmp12_, "name-owner-changed", (GCallback) _rygel_external_plugin_factory_name_owner_changed_rygel_external_free_desktop_dbus_object_name_owner_changed, _data_->self);
	_data_->services = (_vala_array_free (_data_->services, _data_->services_length1, (GDestroyNotify) g_free), NULL);
	if (_data_->_state_ == 0) {
		g_simple_async_result_complete_in_idle (_data_->_async_result);
	} else {
...
"vating it", _tmp7_);
			_tmp8_ = plugin;
			rygel_plugin_set_active (_tmp8_, FALSE);
		} else {
...
"ng it", _tmp12_);
				_tmp13_ = plugin;
				rygel_plugin_set_active (_tmp13_, TRUE);
			}
		}
	} else {
		...
		_tmp14_ = name;
		_tmp15_ = g_str_has_prefix (_tmp14_, RYGEL_EXTERNAL_PLUGIN_FACTORY_SERVICE_PREFIX);
		if (_tmp15_) {
			const gchar* _tmp16_ = NULL;
			_tmp16_ = name;
			rygel_external_plugin_factory_load_plugin_n_handle_error (self, _tmp16_, NULL, NULL);
		}
	}
...
"ignoring..", _data_->_tmp3_);
	...
	_data_->props = (RygelExternalFreeDesktopProperties*) _data_->_tmp13_;
	if (_data_->_inner_error_ != NULL) {
	...
	_data_->_state_ = 2;
	rygel_external_free_desktop_properties_get_all (_data_->_tmp15_, RYGEL_EXTERNAL_MEDIA_OBJECT_PROXY_IFACE, rygel_external_plugin_factory_load_plugin_ready, _data_);
	return FALSE;
	_state_2:
	_data_->_tmp16_ = NULL;
	_data_->_tmp16_ = rygel_external_free_desktop_properties_get_all_finish (_data_->_tmp15_, _data_->_res_, &_data_->_inner_error_);
	...
	_data_->_tmp14_ = NULL;
	_g_hash_table_unref0 (_data_->object_props);
	_data_->object_props = _data_->_tmp17_;
	_data_->_tmp19_ = NULL;
	_data_->_tmp19_ = _data_->props;
	_data_->_state_ = 3;
	rygel_external_free_desktop_properties_get_all (_data_->_tmp19_, RYGEL_EXTERNAL_MEDIA_CONTAINER_PROXY_IFACE, rygel_external_plugin_factory_load_plugin_ready, _data_);
	return FALSE;
	_state_3:
	_data_->_tmp20_ = NULL;
	_data_->_tmp20_ = rygel_external_free_desktop_properties_get_all_finish (_data_->_tmp19_, _data_->_res_, &_data_->_inner_error_);
	_data_->_tmp18_ = _data_->_tmp20_;
	if (_data_->_inner_error_ != NULL) {
		if ((_data_->_inner_error_->domain == G_IO_ERROR) || (_data_->_inner_error_->domain == G_DBUS_ERROR)) {
			g_simple_async_result_set_from_error (_data_->_async_result, _data_->_inner_error_);
			g_error_free (_data_->_inner_error_);
			_g_hash_table_unref0 (_data_->_tmp14_);
			_g_hash_table_unref0 (_data_->container_props);
			_g_hash_table_unref0 (_data_->object_props);
			_g_object_unref0 (_data_->props);
			_g_free0 (_data_->root_object);
	...
	_data_->_tmp18_ = NULL;
	_g_hash_table_unref0 (_data_->container_props);
	_data_->container_props = _data_->_tmp21_;
	_data_->_tmp22_ = NULL;
	_data_->_tmp22_ = _data_->self->priv->icon_factory;
	_data_->_tmp23_ = NULL;
	_data_->_tmp23_ = _data_->service_name;
	_data_->_tmp24_ = NULL;
	_data_->_tmp24_ = _data_->container_props;
	_data_->_state_ = 4;
	rygel_external_icon_factory_create (_data_->_tmp22_, _data_->_tmp23_, _data_->_tmp24_, rygel_external_plugin_factory_load_plugin_ready, _data_);
	return FALSE;
	_state_4:
	_data_->_tmp25_ = NULL;
	_data_->_tmp25_ = rygel_external_icon_factory_create_finish (_data_->_tmp22_, _data_->_res_, &_data_->_inner_error_);
	_data_->icon = _data_->_tmp25_;
	if (_data_->_inner_error_ != NULL) {
		if ((_data_->_inner_error_->domain == G_IO_ERROR) || (_data_->_inner_error_->domain == G_DBUS_ERROR)) {
			g_simple_async_result_set_from_error (_data_->_async_result, _data_->_inner_error_);
			g_error_free (_data_->_inner_error_);
			_g_hash_table_unref0 (_data_->_tmp18_);
			_g_hash_table_unref0 (_data_->_tmp14_);
			_g_hash_table_unref0 (_data_->container_props);
			_g_hash_table_unref0 (_data_->object_props);
			_g_object_unref0 (_data_->props);
	...
	_data_->_tmp26_ = NULL;
	_data_->_tmp26_ = _data_->object_props;
	_data_->_tmp27_ = NULL;
	_data_->_tmp27_ = g_hash_table_lookup (_data_->_tmp26_, "DisplayName");
	_data_->_tmp28_ = NULL;
	_data_->_tmp28_ = _g_variant_ref0 ((GVariant*) _data_->_tmp27_);
	_data_->value = _data_->_tmp28_;
	_data_->_tmp29_ = NULL;
	_data_->_tmp29_ = _data_->value;
	if (_data_->_tmp29_ != NULL) {
		_data_->_tmp30_ = NULL;
		_data_->_tmp30_ = _data_->value;
		_data_->_tmp31_ = NULL;
		_data_->_tmp31_ = _variant_get25 (_data_->_tmp30_);
	...
	_data_->_tmp34_ = NULL;
	_data_->_tmp34_ = _data_->container_props;
	_data_->_tmp35_ = NULL;
	_data_->_tmp35_ = g_hash_table_lookup (_data_->_tmp34_, "ChildCount");
	_data_->_tmp36_ = 0U;
	_data_->_tmp36_ = _variant_get26 ((GVariant*) _data_->_tmp35_);
	_data_->child_count = _data_->_tmp36_;
	_data_->_tmp37_ = NULL;
	_data_->_tmp37_ = _data_->container_props;
	_data_->_tmp38_ = NULL;
	_data_->_tmp38_ = g_hash_table_lookup (_data_->_tmp37_, "Searchable");
	_data_->_tmp39_ = FALSE;
	_data_->_tmp39_ = _variant_get27 ((GVariant*) _data_->_tmp38_);
	_data_->searchable = _data_->_tmp39_;
	{
		...
		_data_->_tmp42_ = 0U;
		_data_->_tmp42_ = _data_->child_count;
		_data_->_tmp43_ = FALSE;
		_data_->_tmp43_ = _data_->searchable;
		_data_->_tmp44_ = NULL;
		_data_->_tmp44_ = _data_->root_object;
		_data_->_tmp45_ = NULL;
		_data_->_tmp45_ = _data_->icon;
		_data_->_tmp46_ = NULL;
		_data_->_tmp46_ = rygel_external_plugin_new (_data_->_tmp40_, _data_->_tmp41_, _data_->_tmp42_, _data_->_tmp43_, _data_->_tmp44_, _data_->_tmp45_, &_data_->_inner_error_);
		_data_->plugin = _data_->_tmp46_;
		if (_data_->_inner_error_ != NULL) {
			goto __catch5_g_error;
		}
		_data_->_tmp47_ = NULL;
		_data_->_tmp47_ = _data_->self->priv->loader;
		_data_->_tmp48_ = NULL;
		_data_->_tmp48_ = _data_->plugin;
		rygel_plugin_loader_add_plugin (_data_->_tmp47_, (RygelPlugin*) _data_->_tmp48_);
	...
	__catch5_g_error:
	{
		...
		_data_->_inner_error_ = NULL;
		_data_->_tmp49_ = NULL;
		_data_->_tmp49_ = _data_->service_name;
		_data_->_tmp50_ = NULL;
		_data_->_tmp50_ = _data_->err;
		_data_->_tmp51_ = NULL;
		_data_->_tmp51_ = _data_->_tmp50_->message;
		g_critical ("Failed to create root container for '%s': %s. " "Ignoring", _data_->_tmp49_, _data_->_tmp51_);

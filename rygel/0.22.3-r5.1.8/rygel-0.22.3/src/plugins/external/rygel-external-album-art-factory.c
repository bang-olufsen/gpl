/* rygel-external-album-art-factory.c generated by valac 0.24.0, the Vala compiler
...
static gboolean rygel_external_album_art_factory_create_co (RygelExternalAlbumArtFactoryCreateData* _data_) {
	...
	_data_->_state_ = 2;
	rygel_external_free_desktop_properties_get_all (_data_->_tmp3_, RYGEL_EXTERNAL_MEDIA_ITEM_PROXY_IFACE, rygel_external_album_art_factory_create_ready, _data_);
	return FALSE;
	_state_2:
	_data_->_tmp4_ = NULL;
...
static RygelThumbnail* rygel_external_album_art_factory_create_from_props (RygelExternalAlbumArtFactory* self, GHashTable* props) {
	...
	if (_tmp15_) {
		...
		_g_free0 (((RygelIconInfo*) _tmp19_)->uri);
		((RygelIconInfo*) _tmp19_)->uri = _tmp22_;
	}
	_tmp23_ = props;
	...
	if (_tmp26_ != NULL) {
		...
		_tmp27_ = thumbnail;
		_tmp28_ = value;
		_tmp29_ = _variant_get20 (_tmp28_);
		((RygelIconInfo*) _tmp27_)->size = _tmp29_;
	}
	result = thumbnail;

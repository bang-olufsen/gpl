/* rygel-mpris-plugin.c generated by valac 0.24.0, the Vala compiler
	...
	_protocols_size_ = protocols_length1;
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				_tmp6_ = i;
				_tmp7_ = schemes;
				_tmp7__length1 = schemes_length1;
				...
				_tmp9_ = i;
				_tmp10_ = schemes;
				_tmp10__length1 = schemes_length1;
				_tmp11_ = i;
				_tmp12_ = _tmp10_[_tmp11_];
				_tmp13_ = rygel_mpris_plugin_scheme_to_protocol (self, _tmp12_);

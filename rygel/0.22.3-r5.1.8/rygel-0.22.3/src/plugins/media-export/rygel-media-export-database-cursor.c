/* rygel-media-export-database-cursor.c generated by valac 0.24.0, the Vala compiler
	...
	}
	{
		...
		i = 1;
		{
			...
			while (TRUE) {
				...
				_tmp8_ = i;
				_tmp9_ = arguments;
				_tmp9__length1 = arguments_length1;
				...
				current_value = _tmp12_;
				_tmp13_ = G_VALUE_HOLDS (&current_value, G_TYPE_INT);
				if (_tmp13_) {
					...
					_tmp15_ = i;
					_tmp16_ = g_value_get_int (&current_value);
					sqlite3_bind_int (_tmp14_, _tmp15_, _tmp16_);
				} else {
					gboolean _tmp17_ = FALSE;
					_tmp17_ = G_VALUE_HOLDS (&current_value, G_TYPE_INT64);
					if (_tmp17_) {
						sqlite3_stmt* _tmp18_ = NULL;
						gint _tmp19_ = 0;
						gint64 _tmp20_ = 0LL;
						_tmp18_ = self->priv->statement;
						_tmp19_ = i;
						_tmp20_ = g_value_get_int64 (&current_value);
						sqlite3_bind_int64 (_tmp18_, _tmp19_, _tmp20_);
					} else {
						gboolean _tmp21_ = FALSE;
						_tmp21_ = G_VALUE_HOLDS (&current_value, G_TYPE_UINT64);
						if (_tmp21_) {
							sqlite3_stmt* _tmp22_ = NULL;
							gint _tmp23_ = 0;
							guint64 _tmp24_ = 0ULL;
							_tmp22_ = self->priv->statement;
							_tmp23_ = i;
							_tmp24_ = g_value_get_uint64 (&current_value);
							sqlite3_bind_int64 (_tmp22_, _tmp23_, (gint64) _tmp24_);
						} else {
							gboolean _tmp25_ = FALSE;
							_tmp25_ = G_VALUE_HOLDS (&current_value, G_TYPE_LONG);
							if (_tmp25_) {
								sqlite3_stmt* _tmp26_ = NULL;
								gint _tmp27_ = 0;
								glong _tmp28_ = 0L;
								_tmp26_ = self->priv->statement;
								_tmp27_ = i;
								_tmp28_ = g_value_get_long (&current_value);
								sqlite3_bind_int64 (_tmp26_, _tmp27_, (gint64) _tmp28_);
							} else {
								gboolean _tmp29_ = FALSE;
								_tmp29_ = G_VALUE_HOLDS (&current_value, G_TYPE_UINT);
								if (_tmp29_) {
									sqlite3_stmt* _tmp30_ = NULL;
									gint _tmp31_ = 0;
									guint _tmp32_ = 0U;
									_tmp30_ = self->priv->statement;
									_tmp31_ = i;
									_tmp32_ = g_value_get_uint (&current_value);
									sqlite3_bind_int64 (_tmp30_, _tmp31_, (gint64) _tmp32_);
								} else {
									gboolean _tmp33_ = FALSE;
									_tmp33_ = G_VALUE_HOLDS (&current_value, G_TYPE_STRING);
									if (_tmp33_) {
										...
										_tmp34_ = self->priv->statement;
										_tmp35_ = i;
										_tmp36_ = g_value_get_string (&current_value);
										_tmp37_ = g_strdup (_tmp36_);
										_tmp38_ = g_free;
										sqlite3_bind_text (_tmp34_, _tmp35_, _tmp37_, -1, _tmp38_);
									} else {
										gboolean _tmp39_ = FALSE;
										_tmp39_ = G_VALUE_HOLDS (&current_value, G_TYPE_POINTER);
										if (_tmp39_) {
											void* _tmp40_ = NULL;
											_tmp40_ = g_value_peek_pointer (&current_value);
											if (_tmp40_ == NULL) {
												sqlite3_stmt* _tmp41_ = NULL;
												gint _tmp42_ = 0;
												_tmp41_ = self->priv->statement;
												_tmp42_ = i;
												sqlite3_bind_null (_tmp41_, _tmp42_);
											} else {
											...
											_tmp43_ = G_VALUE_TYPE (&current_value);
											type = _tmp43_;
											_tmp44_ = _ ("Unsupported type %s");
											_tmp45_ = g_type_name (type);
											g_warning (_tmp44_, _tmp45_);
											g_assert_not_reached ();
										}
									}
								}

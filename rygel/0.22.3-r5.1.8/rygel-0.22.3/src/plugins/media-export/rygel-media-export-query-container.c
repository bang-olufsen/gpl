/* rygel-media-export-query-container.c generated by valac 0.24.0, the Vala compiler
...
" container %s", _data_->_tmp0_, _data_->_tmp6_);
	_data_->_tmp8_ = NULL;
	...
	_data_->_tmp11_ = NULL;
	_data_->_tmp11_ = _data_->sort_criteria;
	_data_->_tmp12_ = NULL;
	_data_->_tmp12_ = _data_->cancellable;
	_data_->_tmp13_ = 0U;
	_data_->_state_ = 1;
	rygel_searchable_container_simple_search ((RygelSearchableContainer*) _data_->self, _data_->_tmp8_, _data_->_tmp9_, _data_->_tmp10_, _data_->_tmp11_, _data_->_tmp12_, rygel_media_export_query_container_search_ready, _data_);
	return FALSE;
	_state_1:
	_data_->_tmp14_ = NULL;

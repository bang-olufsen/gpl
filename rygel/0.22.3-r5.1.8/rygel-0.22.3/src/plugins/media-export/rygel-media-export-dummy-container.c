/* rygel-media-export-dummy-container.c generated by valac 0.24.0, the Vala compiler
...
RygelMediaExportDummyContainer* rygel_media_export_dummy_container_construct (GType object_type, GFile* file, RygelMediaContainer* parent) {
	...
	_g_free0 (_tmp19_);
	{
		...
		_tmp27_ = _tmp26_;
		rygel_media_container_set_child_count ((RygelMediaContainer*) self, _tmp27_);

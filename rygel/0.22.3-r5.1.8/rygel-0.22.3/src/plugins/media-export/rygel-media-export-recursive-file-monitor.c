/* rygel-media-export-recursive-file-monitor.c generated by valac 0.24.0, the Vala compiler
...
static gboolean rygel_media_export_recursive_file_monitor_add_co (RygelMediaExportRecursiveFileMonitorAddData* _data_) {
	...
	__catch57_g_error:
	{
		...
		if (!g_error_matches (_data_->_tmp14_, G_IO_ERROR, G_IO_ERROR_NOT_FOUND)) {
			_data_->_tmp15_ = NULL;
			_data_->_tmp15_ = _ ("Failed to get file info for %s: %s");
			_data_->_tmp16_ = NULL;
			...
			g_debug ("rygel-media-export-recursive-file-monitor.vala:102: File %s disappeare" \
"d while trying to get information", _data_->_tmp23_);
...
static void rygel_media_export_recursive_file_monitor_on_config_changed (RygelMediaExportRecursiveFileMonitor* self, RygelConfiguration* config, const gchar* section, const gchar* key) {
	...
	}
	{
		...
		self->priv->monitor_changes = _tmp3_;
	}
	goto __finally58;
	__catch58_g_error:
	{

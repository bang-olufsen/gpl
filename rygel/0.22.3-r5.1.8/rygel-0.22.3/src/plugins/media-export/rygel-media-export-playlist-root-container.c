/* rygel-media-export-playlist-root-container.c generated by valac 0.24.0, the Vala compiler
...
static gboolean rygel_media_export_playlist_root_container_real_add_container_co (RygelMediaExportPlaylistRootContainerAddContainerData* _data_) {
	...
	if (_data_->_tmp0_) {
		_data_->_tmp7_ = NULL;
		_data_->_tmp7_ = _ ("upnp:class not supported in %s");
		_data_->_tmp8_ = NULL;
		_data_->_tmp8_ = rygel_media_object_get_id ((RygelMediaObject*) _data_->self);
		_data_->_tmp9_ = NULL;
		_data_->_tmp9_ = _data_->_tmp8_;
		_data_->_tmp10_ = NULL;
		_data_->_tmp10_ = g_error_new (RYGEL_WRITABLE_CONTAINER_ERROR, RYGEL_WRITABLE_CONTAINER_ERROR_NOT_IMPLEMENTED, _data_->_tmp7_, _data_->_tmp9_);
	...
	_data_->_tmp12_ = NULL;
	_data_->_tmp12_ = uuid_get ();
	_data_->_tmp13_ = NULL;
	_data_->_tmp13_ = _data_->_tmp12_;
	_data_->_tmp14_ = NULL;
	_data_->_tmp14_ = g_strconcat ("playlist:", _data_->_tmp13_, NULL);
	_data_->_tmp15_ = NULL;
	_data_->_tmp15_ = _data_->_tmp14_;
	rygel_media_object_set_id ((RygelMediaObject*) _data_->_tmp11_, _data_->_tmp15_);
	_g_free0 (_data_->_tmp15_);
	_g_free0 (_data_->_tmp13_);
	_data_->_tmp16_ = NULL;
	_data_->_tmp16_ = _data_->container;
	rygel_media_object_set_upnp_class ((RygelMediaObject*) _data_->_tmp16_, RYGEL_MEDIA_CONTAINER_PLAYLIST);
	_data_->_tmp17_ = NULL;
	_data_->_tmp17_ = ((RygelMediaExportDBContainer*) _data_->self)->media_db;
	_data_->_tmp18_ = NULL;
	_data_->_tmp18_ = _data_->container;
	rygel_media_export_media_cache_save_container (_data_->_tmp17_, _data_->_tmp18_, &_data_->_inner_error_);
	...
	_data_->_tmp19_ = NULL;
	_data_->_tmp19_ = ((RygelMediaExportDBContainer*) _data_->self)->media_db;
	_data_->_tmp20_ = NULL;
	_data_->_tmp20_ = _data_->container;
	rygel_media_export_media_cache_make_object_guarded (_data_->_tmp19_, (RygelMediaObject*) _data_->_tmp20_, TRUE);

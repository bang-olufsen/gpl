/* rygel-media-export-harvesting-task.c generated by valac 0.24.0, the Vala compiler
...
static void _rygel_media_export_harvesting_task_on_extracted_cb_rygel_media_export_metadata_extractor_extraction_done (RygelMediaExportMetadataExtractor* _sender, GFile* file, GstDiscovererInfo* info, GUPnPDLNAProfile* profile, GFileInfo* file_info, gpointer self) {
	rygel_media_export_harvesting_task_on_extracted_cb ((RygelMediaExportHarvestingTask*) self, file, info, profile, file_info);
}
...
static gboolean rygel_media_export_harvesting_task_process_file (RygelMediaExportHarvestingTask* self, GFile* file, GFileInfo* info, RygelMediaContainer* parent) {
	...
	if (_tmp3_ == G_FILE_TYPE_DIRECTORY) {
		...
		if (_tmp14_) {
			...
			RygelMediaExportDummyContainer* _tmp23_ = NULL;
			_tmp22_ = parent;
			_tmp23_ = container;
			rygel_trackable_container_add_child_tracked (G_TYPE_CHECK_INSTANCE_TYPE (_tmp22_, RYGEL_TYPE_TRACKABLE_CONTAINER) ? ((RygelTrackableContainer*) _tmp22_) : NULL, (RygelMediaObject*) _tmp23_, NULL, NULL);
		}
		result = TRUE;
		...
		_tmp24_ = info;
		_tmp25_ = rygel_media_export_harvester_is_eligible (_tmp24_);
		if (_tmp25_) {
			GFile* _tmp26_ = NULL;
...
static gboolean rygel_media_export_harvesting_task_on_idle (RygelMediaExportHarvestingTask* self) {
	...
	if (!_tmp5_) {
		...
		_tmp11_ = _tmp10_;
		g_debug ("rygel-media-export-harvesting-task.vala:271: Scheduling file %s for me" \
...
static void rygel_media_export_harvesting_task_on_extractor_error_cb (RygelMediaExportHarvestingTask* self, GFile* file, GError* _error_) {
	...
	g_debug ("rygel-media-export-harvesting-task.vala:327: Skipping %s; extraction c" \

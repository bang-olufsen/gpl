/* rygel-media-export-media-cache.c generated by valac 0.24.0, the Vala compiler
	...
	}
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				_tmp26_ = i;
				g_debug ("rygel-media-export-media-cache.vala:314: Arg %d: %s", _tmp26_, _tmp18_);
				_g_free0 (_tmp18_);
	...
	g_debug ("rygel-media-export-media-cache.vala:361: Parameters to bind: %u", _tmp10_);
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				_tmp28_ = i;
				g_debug ("rygel-media-export-media-cache.vala:364: Arg %d: %s", _tmp28_, _tmp20_);
				_g_free0 (_tmp20_);
				__vala_GValue_free0 (arg);
			}
		}
...
" proceed");
		...
		__catch18_rygel_media_export_database_error:
		{
			...
			g_warning ("rygel-media-export-media-cache.vala:661: Something weird going on: %s", _tmp26_);
			_g_object_unref0 (self->priv->db);
			self->priv->db = NULL;
...
static void rygel_media_export_media_cache_update_guarded_object (RygelMediaExportMediaCache* self, RygelMediaObject* object, GError** error) {
	...
	_values_size_ = values_length1;
	_tmp39_ = object;
	if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp39_, RYGEL_TYPE_MEDIA_CONTAINER)) {
		...
		RygelMediaContainer* _tmp48_ = NULL;
		guint32 _tmp49_ = 0U;
		GValue _tmp50_ = {0};
		GValue _tmp51_ = {0};
		_tmp40_ = object;
		...
		_tmp43_ = container;
		_tmp44_ = _tmp43_->total_deleted_child_count;
		g_value_init (&_tmp45_, G_TYPE_INT64);
		g_value_set_int64 (&_tmp45_, _tmp44_);
		G_IS_VALUE (&_tmp42_[6]) ? (g_value_unset (&_tmp42_[6]), NULL) : NULL;
		_tmp42_[6] = _tmp45_;
		_tmp46_ = _tmp42_[6];
		_tmp47_ = values;
		_tmp47__length1 = values_length1;
		_tmp48_ = container;
		_tmp49_ = _tmp48_->update_id;
		g_value_init (&_tmp50_, G_TYPE_UINT);
		g_value_set_uint (&_tmp50_, _tmp49_);
		G_IS_VALUE (&_tmp47_[7]) ? (g_value_unset (&_tmp47_[7]), NULL) : NULL;
		_tmp47_[7] = _tmp50_;
		_tmp51_ = _tmp47_[7];
	...
	_tmp54_ = rygel_media_export_sql_factory_make (_tmp53_, RYGEL_MEDIA_EXPORT_SQL_STRING_UPDATE_GUARDED_OBJECT);
	_tmp55_ = values;
	_tmp55__length1 = values_length1;
	rygel_media_export_database_exec (_tmp52_, _tmp54_, _tmp55_, _tmp55__length1, &_inner_error_);
	if (_inner_error_ != NULL) {
		g_propagate_error (error, _inner_error_);
		values = (_vala_GValue_array_free (values, values_length1), NULL);
		_g_free0 (_tmp11_);
...
static void rygel_media_export_media_cache_create_normal_object (RygelMediaExportMediaCache* self, RygelMediaObject* object, gboolean is_guarded, GError** error) {
	...
	RygelMediaExportSQLFactory* _tmp65_ = NULL;
	...
	_tmp25_ = object;
	_tmp26_ = rygel_media_object_get_id (_tmp25_);
	_tmp27_ = _tmp26_;
	g_value_init (&_tmp28_, G_TYPE_STRING);
	g_value_set_string (&_tmp28_, _tmp27_);
	_tmp29_ = object;
	_tmp30_ = rygel_media_object_get_title (_tmp29_);
	_tmp31_ = _tmp30_;
	g_value_init (&_tmp32_, G_TYPE_STRING);
	g_value_set_string (&_tmp32_, _tmp31_);
	_tmp33_ = type;
	g_value_init (&_tmp34_, G_TYPE_INT);
	g_value_set_int (&_tmp34_, _tmp33_);
	_tmp35_ = parent;
	if (G_IS_VALUE (&_tmp35_)) {
		g_value_init (&_tmp36_, G_VALUE_TYPE (&_tmp35_));
		g_value_copy (&_tmp35_, &_tmp36_);
	} else {
		_tmp36_ = _tmp35_;
	}
	_tmp37_ = object;
	...
	_tmp39_ = _tmp38_;
	g_value_init (&_tmp40_, G_TYPE_UINT64);
	g_value_set_uint64 (&_tmp40_, _tmp39_);
	g_value_init (&_tmp41_, G_TYPE_STRING);
	g_value_set_string (&_tmp41_, _tmp11_);
	_tmp42_ = object;
	_tmp43_ = rygel_media_object_get_object_update_id (_tmp42_);
	_tmp44_ = _tmp43_;
	g_value_init (&_tmp45_, G_TYPE_UINT);
	g_value_set_uint (&_tmp45_, _tmp44_);
	g_value_init (&_tmp46_, G_TYPE_INT);
	g_value_set_int (&_tmp46_, -1);
	g_value_init (&_tmp47_, G_TYPE_INT);
	g_value_set_int (&_tmp47_, -1);
	g_value_init (&_tmp48_, G_TYPE_INT);
	g_value_set_int (&_tmp48_, _tmp19_);
	g_value_init (&_tmp49_, G_TYPE_STRING);
	g_value_set_string (&_tmp49_, _tmp21_);
	_tmp50_ = g_new0 (GValue, 11);
	_tmp50_[0] = _tmp28_;
	_tmp50_[1] = _tmp32_;
	_tmp50_[2] = _tmp34_;
	_tmp50_[3] = _tmp36_;
	...
	_values_size_ = values_length1;
	_tmp51_ = object;
	if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp51_, RYGEL_TYPE_MEDIA_CONTAINER)) {
		RygelMediaContainer* container = NULL;
		RygelMediaObject* _tmp52_ = NULL;
		RygelMediaContainer* _tmp53_ = NULL;
		GValue* _tmp54_ = NULL;
		...
		GValue _tmp63_ = {0};
		_tmp52_ = object;
		_tmp53_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp52_, RYGEL_TYPE_MEDIA_CONTAINER) ? ((RygelMediaContainer*) _tmp52_) : NULL);
		container = _tmp53_;
		_tmp54_ = values;
		_tmp54__length1 = values_length1;
		_tmp55_ = container;
		_tmp56_ = _tmp55_->total_deleted_child_count;
		g_value_init (&_tmp57_, G_TYPE_INT64);
		g_value_set_int64 (&_tmp57_, _tmp56_);
		G_IS_VALUE (&_tmp54_[7]) ? (g_value_unset (&_tmp54_[7]), NULL) : NULL;
		_tmp54_[7] = _tmp57_;
		_tmp58_ = _tmp54_[7];
		_tmp59_ = values;
		_tmp59__length1 = values_length1;
		_tmp60_ = container;
		_tmp61_ = _tmp60_->update_id;
		g_value_init (&_tmp62_, G_TYPE_UINT);
		g_value_set_uint (&_tmp62_, _tmp61_);
		G_IS_VALUE (&_tmp59_[8]) ? (g_value_unset (&_tmp59_[8]), NULL) : NULL;
		_tmp59_[8] = _tmp62_;
		_tmp63_ = _tmp59_[8];
		_g_object_unref0 (container);
	}
	_tmp64_ = self->priv->db;
	_tmp65_ = self->priv->sql;
	_tmp66_ = rygel_media_export_sql_factory_make (_tmp65_, RYGEL_MEDIA_EXPORT_SQL_STRING_INSERT);
	_tmp67_ = values;
	_tmp67__length1 = values_length1;
	rygel_media_export_database_exec (_tmp64_, _tmp66_, _tmp67_, _tmp67__length1, &_inner_error_);
	if (_inner_error_ != NULL) {
		g_propagate_error (error, _inner_error_);
		values = (_vala_GValue_array_free (values, values_length1), NULL);
		_g_free0 (_tmp11_);
...
static RygelMediaObject* rygel_media_export_media_cache_get_object_from_statement (RygelMediaExportMediaCache* self, RygelMediaContainer* parent, sqlite3_stmt* statement) {
	...
	if (_tmp38_ != NULL) {
		...
		if (_tmp42_) {
			...
			_tmp48_ = object;
			rygel_media_object_set_modified (_tmp48_, (guint64) 0);
			_tmp49_ = object;
			rygel_media_item_set_place_holder (G_TYPE_CHECK_INSTANCE_TYPE (_tmp49_, RYGEL_TYPE_MEDIA_ITEM) ? ((RygelMediaItem*) _tmp49_) : NULL, TRUE);
		}
		_tmp50_ = object;
		_tmp51_ = statement;
		_tmp52_ = sqlite3_column_int64 (_tmp51_, (gint) RYGEL_MEDIA_EXPORT_DETAIL_COLUMN_OBJECT_UPDATE_ID);
		rygel_media_object_set_object_update_id (_tmp50_, (guint) _tmp52_);
		_tmp53_ = object;
		_tmp54_ = statement;
		_tmp55_ = sqlite3_column_text (_tmp54_, (gint) RYGEL_MEDIA_EXPORT_DETAIL_COLUMN_REFERENCE_ID);
		rygel_media_object_set_ref_id (_tmp53_, _tmp55_);
	}
	result = object;
	return result;
}

/* rygel-gst-launch-root-container.c generated by valac 0.24.0.112-bbf5, the Vala compiler
...
static void rygel_gst_launch_root_container_add_launch_item (RygelGstLaunchRootContainer* self, const gchar* name) {
	...
	g_return_if_fail (name != NULL);
	{
		...
		_tmp26_ = mime_type;
		_tmp27_ = g_str_has_prefix (_tmp26_, "audio");
		if (_tmp27_) {
			const gchar* _tmp28_ = NULL;
			const gchar* _tmp29_ = NULL;
			const gchar* _tmp30_ = NULL;
			const gchar* _tmp31_ = NULL;
			RygelGstLaunchAudioItem* _tmp32_ = NULL;
			_tmp28_ = name;
			_tmp29_ = title;
			_tmp30_ = mime_type;
			_tmp31_ = launch_line;
			_tmp32_ = rygel_gst_launch_audio_item_new (_tmp28_, (RygelMediaContainer*) self, _tmp29_, _tmp30_, _tmp31_);
			_g_object_unref0 (item);
			...
			RygelGstLaunchVideoItem* _tmp37_ = NULL;
			_tmp33_ = name;
			_tmp34_ = title;
			_tmp35_ = mime_type;
			_tmp36_ = launch_line;
			_tmp37_ = rygel_gst_launch_video_item_new (_tmp33_, (RygelMediaContainer*) self, _tmp34_, _tmp35_, _tmp36_);
			_g_object_unref0 (item);
			item = (RygelMediaItem*) _tmp37_;
		}
		_tmp38_ = item;
		if (_tmp38_ != NULL) {
			const gchar* _tmp39_ = NULL;
			RygelMediaItem* _tmp42_ = NULL;
			_tmp39_ = dlna_profile;
			if (_tmp39_ != NULL) {
				RygelMediaItem* _tmp40_ = NULL;
				const gchar* _tmp41_ = NULL;
				_tmp40_ = item;
				_tmp41_ = dlna_profile;
				rygel_media_item_set_dlna_profile (_tmp40_, _tmp41_);
			}
			_tmp42_ = item;

/* rygel-mediathek-root-container.c generated by valac 0.24.0.112-bbf5, the Vala compiler
...
static gboolean __lambda6_ (RygelMediathekRootContainer* self);
...
static gboolean ___lambda6__gsource_func (gpointer self) {
	gboolean result;
	result = __lambda6_ ((RygelMediathekRootContainer*) self);
	return result;
}
...
static gboolean rygel_mediathek_root_container_init_co (RygelMediathekRootContainerInitData* _data_) {
	...
	__catch3_g_error:
	{
		...
		_data_->_tmp5_ = NULL;
		_data_->_tmp5_ = gee_array_list_new (G_TYPE_INT, NULL, NULL, NULL, NULL, NULL);
		_g_object_unref0 (_data_->feeds);
		_data_->feeds = _data_->_tmp5_;
...
"ration, using defaults");
		_data_->_tmp9_ = NULL;
		_data_->_tmp9_ = _data_->feeds;
		gee_abstract_collection_add ((GeeAbstractCollection*) _data_->_tmp9_, (gpointer) ((gintptr) 508));
	}
	{
		_data_->_tmp11_ = 0;
		_data_->_tmp11_ = rygel_configuration_get_int ((RygelConfiguration*) _data_->config, "ZDFMediathek", "update-interval", 600, G_MAXINT, &_data_->_inner_error_);
		_data_->_tmp10_ = _data_->_tmp11_;
		if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
			goto __catch4_g_error;
		}
		_data_->update_interval = _data_->_tmp10_;
	}
	goto __finally4;
	__catch4_g_error:
	{
	...
	g_timeout_add_seconds_full (G_PRIORITY_DEFAULT, (guint) _data_->_tmp27_, ___lambda6__gsource_func, g_object_ref (_data_->self), g_object_unref);
	_g_object_unref0 (_data_->config);
	_g_object_unref0 (_data_->feeds);
	if (_data_->_state_ == 0) {

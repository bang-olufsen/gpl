/* rygel-mediathek-video-item-factory.c generated by valac 0.24.0.112-bbf5, the Vala compiler
...
struct _RygelMediathekVideoItemFactoryCreateData {
	...
	const gchar* _tmp17_;
	RygelMediathekVideoItem* _tmp18_;
	RygelMediathekVideoItem* _tmp19_;
	RygelMediathekPlaylistParser* _tmp20_;
	const gchar* _tmp21_;
	const gchar* _tmp22_;
	RygelMediathekVideoItem* _tmp23_;
	...
	gint _tmp39_;
	gpointer _tmp40_;
	RygelMediathekVideoItem* _tmp41_;
	const gchar* _tmp42_;
...
static gboolean rygel_mediathek_video_item_factory_create_co (RygelMediathekVideoItemFactoryCreateData* _data_) {
	...
	_data_->_tmp13_ = NULL;
	_data_->_tmp13_ = _data_->title;
	_data_->_tmp14_ = NULL;
	_data_->_tmp14_ = g_compute_checksum_for_string (G_CHECKSUM_MD5, _data_->_tmp13_, (gsize) (-1));
	_data_->id = _data_->_tmp14_;
	_data_->_tmp15_ = NULL;
	...
	_data_->_tmp18_ = NULL;
	_data_->_tmp18_ = rygel_mediathek_video_item_new (_data_->_tmp15_, _data_->_tmp16_, _data_->_tmp17_);
	_data_->item = _data_->_tmp18_;
	_data_->_tmp19_ = NULL;
	_data_->_tmp19_ = _data_->item;
	_data_->_tmp20_ = NULL;
	_data_->_tmp20_ = _data_->self->priv->playlist_parser;
	_data_->_tmp21_ = NULL;
	_data_->_tmp21_ = rygel_mediathek_playlist_parser_get_mime_type (_data_->_tmp20_);
	_data_->_tmp22_ = NULL;
	_data_->_tmp22_ = _data_->_tmp21_;
	rygel_media_item_set_mime_type ((RygelMediaItem*) _data_->_tmp19_, _data_->_tmp22_);
	_data_->_tmp23_ = NULL;
	_data_->_tmp23_ = _data_->item;
	rygel_video_item_set_author ((RygelVideoItem*) _data_->_tmp23_, "ZDF - Second German TV Channel Streams");
	_data_->_tmp24_ = NULL;
	_data_->_tmp24_ = _data_->item;
	_data_->_tmp25_ = NULL;
	_data_->_tmp25_ = _data_->date;
	rygel_media_item_set_date ((RygelMediaItem*) _data_->_tmp24_, _data_->_tmp25_);
	_data_->_tmp26_ = NULL;
	_data_->_tmp26_ = _data_->item;
	_data_->_tmp27_ = NULL;
	_data_->_tmp27_ = _data_->description;
	rygel_media_item_set_description ((RygelMediaItem*) _data_->_tmp26_, _data_->_tmp27_);
	_data_->_tmp28_ = NULL;
	_data_->_tmp28_ = _data_->self->priv->video_format;
	if (g_strcmp0 (_data_->_tmp28_, RYGEL_MEDIATHEK_VIDEO_ITEM_FACTORY_VIDEO_FORMAT_WMV) == 0) {
		_data_->_tmp29_ = NULL;
		_data_->_tmp29_ = _data_->item;
		rygel_media_item_set_dlna_profile ((RygelMediaItem*) _data_->_tmp29_, "WMVMED_FULL");
	}
	{
		_data_->_tmp30_ = NULL;
		_data_->_tmp30_ = _data_->resolved_uris;
		_data_->_tmp31_ = NULL;
		_data_->_tmp31_ = _g_object_ref0 (_data_->_tmp30_);
		_data_->_uri_list = _data_->_tmp31_;
		_data_->_tmp32_ = NULL;
		_data_->_tmp32_ = _data_->_uri_list;
		_data_->_tmp33_ = 0;
		_data_->_tmp33_ = gee_collection_get_size ((GeeCollection*) _data_->_tmp32_);
		_data_->_tmp34_ = 0;
		_data_->_tmp34_ = _data_->_tmp33_;
		_data_->_uri_size = _data_->_tmp34_;
		_data_->_uri_index = -1;
		while (TRUE) {
			_data_->_tmp35_ = 0;
			_data_->_tmp35_ = _data_->_uri_index;
			_data_->_uri_index = _data_->_tmp35_ + 1;
			_data_->_tmp36_ = 0;
			_data_->_tmp36_ = _data_->_uri_index;
			_data_->_tmp37_ = 0;
			_data_->_tmp37_ = _data_->_uri_size;
			if (!(_data_->_tmp36_ < _data_->_tmp37_)) {
				break;
			}
			_data_->_tmp38_ = NULL;
			_data_->_tmp38_ = _data_->_uri_list;
			_data_->_tmp39_ = 0;
			_data_->_tmp39_ = _data_->_uri_index;
			_data_->_tmp40_ = NULL;
			_data_->_tmp40_ = gee_list_get (_data_->_tmp38_, _data_->_tmp39_);
			_data_->uri = (gchar*) _data_->_tmp40_;
			_data_->_tmp41_ = NULL;
			_data_->_tmp41_ = _data_->item;
			_data_->_tmp42_ = NULL;
			_data_->_tmp42_ = _data_->uri;
			rygel_media_item_add_uri ((RygelMediaItem*) _data_->_tmp41_, _data_->_tmp42_);
			_g_free0 (_data_->uri);
		}
...
static RygelMediathekVideoItemFactory* rygel_mediathek_video_item_factory_construct (GType object_type) {
	...
	self->priv->video_format = _tmp1_;
	{
		...
		_tmp2_ = NULL;
		_g_free0 (self->priv->video_format);
		self->priv->video_format = _tmp4_;
		_tmp5_ = self->priv->video_format;
		_tmp6_ = g_utf8_casefold (_tmp5_, (gssize) (-1));
		_g_free0 (self->priv->video_format);
		self->priv->video_format = _tmp6_;
		_tmp8_ = self->priv->video_format;
		if (g_strcmp0 (_tmp8_, RYGEL_MEDIATHEK_VIDEO_ITEM_FACTORY_VIDEO_FORMAT_WMV) != 0) {
			const gchar* _tmp9_ = NULL;
			_tmp9_ = self->priv->video_format;
			_tmp7_ = g_strcmp0 (_tmp9_, RYGEL_MEDIATHEK_VIDEO_ITEM_FACTORY_VIDEO_FORMAT_MP4) != 0;
		} else {
			_tmp7_ = FALSE;
		}
		if (_tmp7_) {
...
static void rygel_mediathek_video_item_factory_extract_data_from_xml (RygelMediathekVideoItemFactory* self, xmlNode* item, gchar** title, gchar** playlist_url, gchar** date, gchar** description, GError** error) {
	...
	while (TRUE) {
		...
		_tmp16_ = content;
		_tmp17_ = xmlHasProp (_tmp16_, (xmlChar*) "url");
		...
		if (_tmp18_) {
			...
			RygelMediathekPlaylistParser* _tmp26_ = NULL;
			const gchar* _tmp27_ = NULL;
			const gchar* _tmp28_ = NULL;
			gboolean _tmp29_ = FALSE;
			_tmp22_ = url_attribute;
			_tmp23_ = _tmp22_->children;
			_tmp24_ = _tmp23_->content;
			url = _tmp24_;
			_tmp25_ = url;
			_tmp26_ = self->priv->playlist_parser;
			_tmp27_ = rygel_mediathek_playlist_parser_get_playlist_suffix (_tmp26_);
			_tmp28_ = _tmp27_;
			_tmp29_ = g_str_has_suffix (_tmp25_, _tmp28_);
			if (_tmp29_) {
	...
	_tmp34_ = _vala_playlist_url;
	if (_tmp34_ == NULL) {
		GError* _tmp35_ = NULL;
		_tmp35_ = g_error_new_literal (RYGEL_MEDIATHEK_VIDEO_ITEM_ERROR, RYGEL_MEDIATHEK_VIDEO_ITEM_ERROR_XML_PARSE_ERROR, "No URL found");
	...
	_vala_title = _tmp37_;
	_tmp38_ = item;
	_tmp39_ = rygel_xml_utils_get_element (_tmp38_, "date", NULL);
	date_node = _tmp39_;
	_tmp41_ = date_node;
	if (_tmp41_ != NULL) {
		...
		_tmp42_ = date_node;
		_tmp43_ = rygel_mediathek_video_item_factory_namespace_ok (self, _tmp42_, "dc");
		_tmp40_ = _tmp43_;
	} else {
		_tmp40_ = FALSE;
	}
	...
	_tmp46_ = item;
	_tmp47_ = rygel_xml_utils_get_element (_tmp46_, "description", NULL);
	desc_node = _tmp47_;
	_tmp48_ = desc_node;
	if (_tmp48_ != NULL) {

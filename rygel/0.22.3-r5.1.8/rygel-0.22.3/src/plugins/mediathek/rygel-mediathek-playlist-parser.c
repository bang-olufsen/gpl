/* rygel-mediathek-playlist-parser.c generated by valac 0.24.0.112-bbf5, the Vala compiler
...
static gboolean rygel_mediathek_playlist_parser_parse_co (RygelMediathekPlaylistParserParseData* _data_) {
	...
	soup_session_queue_message (_data_->_tmp2_, _data_->_tmp4_, ___lambda4__soup_session_callback, block1_data_ref (_data_->_data1_));
	_data_->_state_ = 1;
	return FALSE;
	_state_1:
	;

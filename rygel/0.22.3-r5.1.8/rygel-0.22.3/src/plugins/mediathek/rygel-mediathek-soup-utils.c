/* rygel-mediathek-soup-utils.c generated by valac 0.24.0.112-bbf5, the Vala compiler
...
static gboolean rygel_mediathek_soup_utils_queue_message_co (RygelMediathekSoupUtilsQueueMessageData* _data_) {
	...
	soup_session_queue_message (_data_->_tmp0_, _data_->_tmp2_, ___lambda7__soup_session_callback, block3_data_ref (_data_->_data3_));
	_data_->_state_ = 1;
	return FALSE;
	_state_1:
	;

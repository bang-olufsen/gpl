/* rygel-tracker-metadata-multivalues.c generated by valac 0.24.0, the Vala compiler
...
static RygelTrackerSelectionQuery* rygel_tracker_metadata_multi_values_real_create_query (RygelTrackerMetadataContainer* base) {
	...
	RygelTrackerSelectionQuery* _tmp46_ = NULL;
	...
	_variables_size_ = variables_length1;
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				_tmp14_ = i;
				_tmp15_ = self->key_chain;
				_tmp15__length1 = self->key_chain_length1;
				_tmp16_ = i;
				...
				_tmp13_[_tmp14_] = _tmp20_;
				_tmp21_ = _tmp13_[_tmp14_];
				_g_free0 (_tmp19_);
				_tmp22_ = i;
				if (_tmp22_ == 0) {
					gchar* _tmp23_ = NULL;
					_tmp23_ = g_strdup (RYGEL_TRACKER_SELECTION_QUERY_ITEM_VARIABLE);
					_g_free0 (subject);
					subject = _tmp23_;
				} else {
					gchar** _tmp24_ = NULL;
				...
				_tmp28_ = ((RygelTrackerMetadataContainer*) self)->triplets;
				_tmp29_ = subject;
				_tmp30_ = self->key_chain;
				_tmp30__length1 = self->key_chain_length1;
				_tmp31_ = i;
				_tmp32_ = _tmp30_[_tmp31_];
				_tmp33_ = variables;
				_tmp33__length1 = variables_length1;
				_tmp34_ = i;
				_tmp35_ = _tmp33_[_tmp34_];
				_tmp36_ = rygel_tracker_query_triplet_new (_tmp29_, _tmp32_, _tmp35_);
				_tmp37_ = _tmp36_;
	...
	selected = _tmp38_;
	_tmp39_ = variables;
	_tmp39__length1 = variables_length1;
	_tmp40_ = num_keys;
	_tmp41_ = _tmp39_[_tmp40_ - 1];
	_tmp42_ = g_strdup (_tmp41_);
	last_variable = _tmp42_;
	_tmp43_ = g_strconcat ("DISTINCT ", last_variable, NULL);
	_tmp44_ = _tmp43_;
	gee_abstract_collection_add ((GeeAbstractCollection*) selected, _tmp44_);
	_g_free0 (_tmp44_);
	_tmp45_ = ((RygelTrackerMetadataContainer*) self)->triplets;
	_tmp46_ = rygel_tracker_selection_query_new (selected, _tmp45_, NULL, last_variable, 0, -1);
	result = _tmp46_;

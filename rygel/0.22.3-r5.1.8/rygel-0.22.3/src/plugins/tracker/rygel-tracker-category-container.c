/* rygel-tracker-category-container.c generated by valac 0.24.0, the Vala compiler
...
static void _rygel_tracker_category_container_on_all_container_updated_rygel_media_container_container_updated (RygelMediaContainer* _sender, RygelMediaContainer* container, RygelMediaObject* object, RygelObjectEventType event_type, gboolean sub_tree_update, gpointer self) {
	rygel_tracker_category_container_on_all_container_updated ((RygelTrackerCategoryContainer*) self, container);
}
...
RygelTrackerCategoryContainer* rygel_tracker_category_container_construct (GType object_type, const gchar* id, RygelMediaContainer* parent, const gchar* title, RygelTrackerItemFactory* item_factory) {
	...
	_tmp17_ = g_signal_connect_data ((RygelMediaContainer*) _tmp16_, "container-updated", (GCallback) ___lambda4__rygel_media_container_container_updated, block1_data_ref (_data1_), (GClosureNotify) block1_data_unref, 0);
...
static void rygel_tracker_category_container_trigger_child_update (RygelTrackerCategoryContainer* self, RygelMediaObjects* children) {
	...
	g_return_if_fail (children != NULL);
	{
		...
		while (TRUE) {
			...
			_tmp15_ = container;
			if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp15_, RYGEL_TRACKER_TYPE_METADATA_VALUES)) {
				RygelMediaObject* _tmp16_ = NULL;
				_tmp16_ = container;
				rygel_tracker_metadata_container_fetch_metadata_values ((RygelTrackerMetadataContainer*) (G_TYPE_CHECK_INSTANCE_TYPE (_tmp16_, RYGEL_TRACKER_TYPE_METADATA_VALUES) ? ((RygelTrackerMetadataValues*) _tmp16_) : NULL), NULL, NULL);
			} else {
				RygelMediaObject* _tmp17_ = NULL;
				_tmp17_ = container;
				if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp17_, RYGEL_TRACKER_TYPE_SEARCH_CONTAINER)) {
					RygelMediaObject* _tmp18_ = NULL;
					_tmp18_ = container;
					rygel_tracker_search_container_get_children_count (G_TYPE_CHECK_INSTANCE_TYPE (_tmp18_, RYGEL_TRACKER_TYPE_SEARCH_CONTAINER) ? ((RygelTrackerSearchContainer*) _tmp18_) : NULL, NULL, NULL);
				}
			}
			_g_object_unref0 (container);
		}

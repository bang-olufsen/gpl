/* rygel-tracker-artists.c generated by valac 0.24.0, the Vala compiler
...
RygelTrackerArtists* rygel_tracker_artists_construct (GType object_type, RygelTrackerMusic* parent) {
	...
	_tmp2_ = _tmp1_;
	_tmp3_ = g_strconcat (_tmp2_, "Artists", NULL);
	_tmp4_ = _tmp3_;
	_tmp5_ = parent;
	_tmp6_ = _ ("Artists");
	_tmp7_ = parent;
	_tmp8_ = ((RygelTrackerCategoryContainer*) _tmp7_)->item_factory;
	self = (RygelTrackerArtists*) rygel_tracker_metadata_values_construct (object_type, _tmp4_, (RygelMediaContainer*) _tmp5_, _tmp6_, _tmp8_, "upnp:artist", RYGEL_MEDIA_CONTAINER_MUSIC_ARTIST);
	_g_free0 (_tmp4_);
	return self;
}

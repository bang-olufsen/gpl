/* rygel-tracker-interfaces.c generated by valac 0.24.0, the Vala compiler
...
static void _dbus_rygel_tracker_stats_iface_get (RygelTrackerStatsIface* self, GVariant* _parameters_, GDBusMethodInvocation* invocation);
...
static void _dbus_rygel_tracker_resources_iface_sparql_query (RygelTrackerResourcesIface* self, GVariant* _parameters_, GDBusMethodInvocation* invocation);
...
static void _dbus_rygel_tracker_resources_iface_sparql_update (RygelTrackerResourcesIface* self, GVariant* _parameters_, GDBusMethodInvocation* invocation);
...
static void _dbus_rygel_tracker_resources_iface_sparql_update_blank (RygelTrackerResourcesIface* self, GVariant* _parameters_, GDBusMethodInvocation* invocation);
...
static void _dbus_rygel_tracker_miner_files_index_iface_index_file (RygelTrackerMinerFilesIndexIface* self, GVariant* _parameters_, GDBusMethodInvocation* invocation);

/* rygel-tracker-cleanup-query.c generated by valac 0.24.0, the Vala compiler
...
static void rygel_tracker_cleanup_query_real_execute (RygelTrackerQuery* base, TrackerSparqlConnection* resources, GAsyncReadyCallback _callback_, gpointer _user_data_) {
	RygelTrackerCleanupQuery * self;
	RygelTrackerCleanupQueryExecuteData* _data_;
	RygelTrackerCleanupQuery* _tmp0_ = NULL;
...
static gchar* rygel_tracker_cleanup_query_real_to_string (RygelTrackerQuery* base) {
	...
	_tmp1_ = RYGEL_TRACKER_QUERY_CLASS (rygel_tracker_cleanup_query_parent_class)->to_string (G_TYPE_CHECK_INSTANCE_CAST (self, RYGEL_TRACKER_TYPE_QUERY, RygelTrackerQuery));
	_tmp2_ = _tmp1_;
...
static void rygel_tracker_cleanup_query_finalize (RygelTrackerQuery* obj) {
	RygelTrackerCleanupQuery * self;
	self = G_TYPE_CHECK_INSTANCE_CAST (obj, RYGEL_TRACKER_TYPE_CLEANUP_QUERY, RygelTrackerCleanupQuery);
	_g_free0 (self->priv->category);

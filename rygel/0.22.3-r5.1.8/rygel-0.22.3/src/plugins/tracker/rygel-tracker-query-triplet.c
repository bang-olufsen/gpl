/* rygel-tracker-query-triplet.c generated by valac 0.24.0, the Vala compiler
...
gboolean rygel_tracker_query_triplet_equal_func (RygelTrackerQueryTriplet* a, RygelTrackerQueryTriplet* b) {
	...
	if (_tmp0_) {
		...
		_tmp7_ = b;
		_tmp8_ = _tmp7_->next;
		_tmp9_ = rygel_tracker_query_triplet_equal_func (_tmp6_, _tmp8_);
		chain_equal = _tmp9_;
	} else {
		RygelTrackerQueryTriplet* _tmp10_ = NULL;
		RygelTrackerQueryTriplet* _tmp11_ = NULL;
	...
	if (g_strcmp0 (_tmp19_, _tmp21_) == 0) {
		RygelTrackerQueryTriplet* _tmp22_ = NULL;
		const gchar* _tmp23_ = NULL;
		RygelTrackerQueryTriplet* _tmp24_ = NULL;
		const gchar* _tmp25_ = NULL;
		_tmp22_ = a;
		_tmp23_ = _tmp22_->subject;
		_tmp24_ = b;
		_tmp25_ = _tmp24_->subject;
		_tmp17_ = g_strcmp0 (_tmp23_, _tmp25_) == 0;
	} else {
		_tmp17_ = FALSE;
	}
	if (_tmp17_) {
		...
		_tmp28_ = b;
		_tmp29_ = _tmp28_->obj;
		_tmp16_ = g_strcmp0 (_tmp27_, _tmp29_) == 0;
	} else {
		_tmp16_ = FALSE;
	}
	if (_tmp16_) {
		...
		RygelTrackerQueryTriplet* _tmp32_ = NULL;
		const gchar* _tmp33_ = NULL;
		_tmp30_ = a;
		_tmp31_ = _tmp30_->predicate;
		_tmp32_ = b;
		_tmp33_ = _tmp32_->predicate;
		_tmp15_ = g_strcmp0 (_tmp31_, _tmp33_) == 0;
	} else {
		_tmp15_ = FALSE;
	}
	if (_tmp15_) {

/* rygel-tracker-picture-item-factory.c generated by valac 0.24.0, the Vala compiler
...
RygelTrackerPictureItemFactory* rygel_tracker_picture_item_factory_construct (GType object_type) {
	...
	self = (RygelTrackerPictureItemFactory*) rygel_tracker_item_factory_construct (object_type, RYGEL_TRACKER_PICTURE_ITEM_FACTORY_CATEGORY, RYGEL_TRACKER_PICTURE_ITEM_FACTORY_CATEGORY_IRI, RYGEL_PHOTO_ITEM_UPNP_CLASS, _tmp6_);

/* rygel-tracker-plugin-factory.c generated by valac 0.24.0, the Vala compiler
...
"noring..", RYGEL_TRACKER_PLUGIN_NAME);
	...
	}
	{
		...
		RygelTrackerPluginFactory* _tmp5_ = NULL;
		_tmp3_ = loader;
		...
		plugin_factory = _tmp5_;
		_rygel_tracker_plugin_factory_unref0 (_tmp2_);
	}
	goto __finally14;
	__catch14_g_error:
	{
		...
		err = _inner_error_;
		_inner_error_ = NULL;
		_tmp6_ = _ ("Failed to start Tracker service: %s. Plugin disabled.");
		_tmp7_ = err;
...
RygelTrackerPluginFactory* rygel_tracker_plugin_factory_construct (GType object_type, RygelPluginLoader* loader, GError** error) {
	...
	RygelTrackerStatsIface* _tmp2_ = NULL;
	RygelPluginLoader* _tmp3_ = NULL;
	RygelPluginLoader* _tmp4_ = NULL;
	RygelTrackerStatsIface* _tmp5_ = NULL;
	gint _tmp6_ = 0;
	gint _tmp7_ = 0;
	gchar** _tmp8_ = NULL;
	gchar** _tmp9_ = NULL;
	...
	RygelTrackerPlugin* _tmp12_ = NULL;
	GError * _inner_error_ = NULL;
	...
	self->priv->stats = _tmp2_;
	_tmp3_ = loader;
	_tmp4_ = _g_object_ref0 (_tmp3_);
	_g_object_unref0 (self->priv->loader);
	self->priv->loader = _tmp4_;
	_tmp5_ = self->priv->stats;
	_tmp8_ = rygel_tracker_stats_iface_get (_tmp5_, &_tmp6_, &_tmp7_, &_inner_error_);
	_tmp9_ = _tmp8_;
	_tmp9__length1 = _tmp6_;
	_tmp9__length2 = _tmp7_;
	_tmp9_ = (_vala_array_free (_tmp9_, _tmp9__length1 * _tmp9__length2, (GDestroyNotify) g_free), NULL);
	if (_inner_error_ != NULL) {
		if ((_inner_error_->domain == G_IO_ERROR) || (_inner_error_->domain == G_DBUS_ERROR)) {
			g_propagate_error (error, _inner_error_);
	...
	_tmp10_ = self->priv->loader;
	_tmp11_ = rygel_tracker_plugin_new ();
	_tmp12_ = _tmp11_;
	rygel_plugin_loader_add_plugin (_tmp10_, (RygelPlugin*) _tmp12_);

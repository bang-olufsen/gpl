/* rygel-tracker-item-factory.c generated by valac 0.24.0, the Vala compiler
...
"s", _tmp8_, _tmp11_);
	...
	self->properties = _tmp12_;
	_tmp13_ = self->properties;
	gee_abstract_collection_add ((GeeAbstractCollection*) _tmp13_, "res");
	_tmp14_ = self->properties;
	gee_abstract_collection_add ((GeeAbstractCollection*) _tmp14_, "place_holder");
	_tmp15_ = self->properties;
	gee_abstract_collection_add ((GeeAbstractCollection*) _tmp15_, "fileName");
	_tmp16_ = self->properties;
	gee_abstract_collection_add ((GeeAbstractCollection*) _tmp16_, "dc:title");
	_tmp17_ = self->properties;
	gee_abstract_collection_add ((GeeAbstractCollection*) _tmp17_, "dlnaProfile");
	_tmp18_ = self->properties;
	gee_abstract_collection_add ((GeeAbstractCollection*) _tmp18_, "mimeType");
	_tmp19_ = self->properties;
	gee_abstract_collection_add ((GeeAbstractCollection*) _tmp19_, "res@size");
	_tmp20_ = self->properties;
	gee_abstract_collection_add ((GeeAbstractCollection*) _tmp20_, "date");
	return self;
}

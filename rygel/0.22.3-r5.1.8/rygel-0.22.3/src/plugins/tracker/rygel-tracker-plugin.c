/* rygel-tracker-plugin.c generated by valac 0.24.0, the Vala compiler
...
RygelTrackerPlugin* rygel_tracker_plugin_construct (GType object_type) {
	...
	RygelTrackerRootContainer* _tmp0_ = NULL;
	RygelTrackerRootContainer* _tmp3_ = NULL;
	_tmp0_ = rygel_tracker_plugin_root;
	if (_tmp0_ == NULL) {
		const gchar* _tmp1_ = NULL;
		RygelTrackerRootContainer* _tmp2_ = NULL;
	...
	self = (RygelTrackerPlugin*) rygel_media_server_plugin_construct (object_type, (RygelMediaContainer*) _tmp3_, RYGEL_TRACKER_PLUGIN_NAME, NULL, RYGEL_PLUGIN_CAPABILITIES_UPLOAD);
	return self;
}
...
static void rygel_tracker_plugin_finalize (GObject* obj) {
	...
	self = G_TYPE_CHECK_INSTANCE_CAST (obj, RYGEL_TRACKER_TYPE_PLUGIN, RygelTrackerPlugin);

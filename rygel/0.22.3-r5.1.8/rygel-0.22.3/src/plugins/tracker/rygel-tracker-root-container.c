/* rygel-tracker-root-container.c generated by valac 0.24.0, the Vala compiler
...
RygelTrackerRootContainer* rygel_tracker_root_container_construct (GType object_type, const gchar* title) {
	...
	if (_tmp1_) {
		RygelTrackerMusic* _tmp2_ = NULL;
		RygelTrackerMusic* _tmp3_ = NULL;
	...
	if (_tmp4_) {
		RygelTrackerVideos* _tmp5_ = NULL;
		RygelTrackerVideos* _tmp6_ = NULL;
	...
	if (_tmp7_) {
		RygelTrackerPictures* _tmp8_ = NULL;
		RygelTrackerPictures* _tmp9_ = NULL;
...
static gboolean rygel_tracker_root_container_get_bool_config_without_error (RygelTrackerRootContainer* self, const gchar* key) {
	...
	config = _tmp0_;
	{
		...
		_tmp2_ = key;
		_tmp3_ = rygel_configuration_get_bool ((RygelConfiguration*) config, "Tracker", _tmp2_, &_inner_error_);
		_tmp1_ = _tmp3_;

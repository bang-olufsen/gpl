/* rygel-tracker-selection-query.c generated by valac 0.24.0, the Vala compiler
...
static gchar* rygel_tracker_selection_query_real_to_string (RygelTrackerQuery* base) {
		...
		query = _tmp31_;
		{
			...
			i = 0;
			{
				...
				while (TRUE) {
					...
					_tmp32_ = FALSE;
					_tmp34_ = i;
					_tmp35_ = gee_abstract_collection_get_size ((GeeCollection*) filters);
					_tmp36_ = _tmp35_;
					if (!(_tmp34_ < _tmp36_)) {
						break;
					}
					_tmp37_ = query;
					_tmp38_ = i;
					_tmp39_ = gee_abstract_list_get ((GeeAbstractList*) filters, _tmp38_);
					...
					_g_free0 (_tmp40_);
					_tmp42_ = i;
					_tmp43_ = gee_abstract_collection_get_size ((GeeCollection*) filters);
					_tmp44_ = _tmp43_;
	...
	if (_tmp51_ != NULL) {
		...
		_tmp54_ = g_strconcat (" ORDER BY ", _tmp53_, NULL);
		_tmp55_ = _tmp54_;
	...
	if (_tmp65_ > 0) {
		...
		_tmp69_ = _tmp68_;
		_tmp70_ = g_strconcat (" LIMIT ", _tmp69_, NULL);
		_tmp71_ = _tmp70_;

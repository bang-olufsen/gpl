/* rygel-tracker-category-all-container.c generated by valac 0.24.0, the Vala compiler
...
RygelTrackerCategoryAllContainer* rygel_tracker_category_all_container_construct (GType object_type, RygelTrackerCategoryContainer* parent) {
	...
	RygelTrackerItemFactory* _tmp37_ = NULL;
	const gchar* _tmp38_ = NULL;
	RygelTrackerCleanupQuery* _tmp39_ = NULL;
	...
	__catch6_g_error:
	{
		...
		_inner_error_ = NULL;
		_tmp19_ = _ ("Failed to create a Tracker connection: %s");
		_tmp20_ = io_error;
		_tmp21_ = _tmp20_->message;
		g_critical (_tmp19_, _tmp21_);
	...
	{
		gchar* uri = NULL;
		RygelTrackerItemFactory* _tmp22_ = NULL;
		const gchar* _tmp23_ = NULL;
		gchar* _tmp24_ = NULL;
		GeeArrayList* _tmp25_ = NULL;
		_tmp22_ = ((RygelTrackerSearchContainer*) self)->item_factory;
		_tmp23_ = _tmp22_->upload_dir;
		_tmp24_ = g_filename_to_uri (_tmp23_, NULL, &_inner_error_);
		uri = _tmp24_;
		if (_inner_error_ != NULL) {
		...
		_tmp25_ = ((RygelMediaObject*) self)->uris;
		gee_abstract_collection_add ((GeeAbstractCollection*) _tmp25_, uri);
		_g_free0 (uri);
	}
	goto __finally7;
	__catch7_g_convert_error:
	{
		...
		RygelTrackerItemFactory* _tmp27_ = NULL;
		const gchar* _tmp28_ = NULL;
		GError* _tmp29_ = NULL;
		const gchar* _tmp30_ = NULL;
		_error_ = _inner_error_;
		_inner_error_ = NULL;
		_tmp26_ = _ ("Failed to construct URI for folder '%s': %s");
		_tmp27_ = ((RygelTrackerSearchContainer*) self)->item_factory;
		_tmp28_ = _tmp27_->upload_dir;
		_tmp29_ = _error_;
		_tmp30_ = _tmp29_->message;
		g_warning (_tmp26_, _tmp28_, _tmp30_);
	...
	}
	{
		...
		RygelTrackerItemFactory* _tmp32_ = NULL;
	...
	__catch8_g_error:
	{
		...
		_error_ = _inner_error_;
		_inner_error_ = NULL;
		_tmp34_ = _ ("Could not subscribe to Tracker signals: %s");
		_tmp35_ = _error_;
		_tmp36_ = _tmp35_->message;
		g_critical (_tmp34_, _tmp36_);
		_g_error_free0 (_error_);
	}
	__finally8:
	if (_inner_error_ != NULL) {
	...
	_tmp37_ = ((RygelTrackerSearchContainer*) self)->item_factory;
	_tmp38_ = _tmp37_->category;
	_tmp39_ = rygel_tracker_cleanup_query_new (_tmp38_);
	cleanup_query = _tmp39_;
	_tmp40_ = self->priv->resources;
	rygel_tracker_query_execute ((RygelTrackerQuery*) cleanup_query, _tmp40_, NULL, NULL);

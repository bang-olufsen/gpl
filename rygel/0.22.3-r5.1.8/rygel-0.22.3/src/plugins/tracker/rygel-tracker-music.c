/* rygel-tracker-music.c generated by valac 0.24.0, the Vala compiler
...
RygelTrackerMusic* rygel_tracker_music_construct (GType object_type, const gchar* id, RygelMediaContainer* parent, const gchar* title) {
	...
	RygelTrackerMusicItemFactory* _tmp3_ = NULL;
	RygelTrackerMusicItemFactory* _tmp4_ = NULL;
	RygelTrackerArtists* _tmp5_ = NULL;
	RygelTrackerArtists* _tmp6_ = NULL;
	RygelTrackerAlbums* _tmp7_ = NULL;
	RygelTrackerAlbums* _tmp8_ = NULL;
	RygelTrackerGenre* _tmp9_ = NULL;
	RygelTrackerGenre* _tmp10_ = NULL;

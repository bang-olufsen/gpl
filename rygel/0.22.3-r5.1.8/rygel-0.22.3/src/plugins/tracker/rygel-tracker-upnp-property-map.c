/* rygel-tracker-upnp-property-map.c generated by valac 0.24.0, the Vala compiler
...
static RygelTrackerUPnPPropertyMap* rygel_tracker_upn_pproperty_map_construct (GType object_type) {
	...
	rygel_tracker_upn_pproperty_map_add_alternative (self, "mimeType", "nmm:dlnaMime", "nie:mimeType", NULL);

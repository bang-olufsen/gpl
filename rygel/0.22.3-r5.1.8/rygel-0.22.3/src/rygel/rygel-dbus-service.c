/* rygel-dbus-service.c generated by valac 0.24.0, the Vala compiler
...
static void _dbus_rygel_dbus_service_shutdown (RygelDBusService* self, GVariant* _parameters_, GDBusMethodInvocation* invocation);
...
static void rygel_dbus_service_on_bus_aquired (RygelDBusService* self, GDBusConnection* connection) {
	...
	g_return_if_fail (connection != NULL);
	{
		...
		guint _tmp2_ = 0U;
		_tmp1_ = connection;
		_tmp2_ = rygel_dbus_service_register_object (self, _tmp1_, RYGEL_DBUS_INTERFACE_OBJECT_PATH, &_inner_error_);
		_tmp0_ = _tmp2_;
		if (_inner_error_ != NULL) {
...
static void rygel_dbus_service_on_name_lost (RygelDBusService* self, GDBusConnection* connection) {
	...
	}
	{
		...
		RygelDBusInterface* _tmp3_ = NULL;
